...
public class AIExecution_MakeParty extends AIExecution {
    // count		- compute string
    // count_max	- compute string
    /**
     ...
     */
    public AIExecution_MakeParty(AIHandler handler, JsonObject element) {
