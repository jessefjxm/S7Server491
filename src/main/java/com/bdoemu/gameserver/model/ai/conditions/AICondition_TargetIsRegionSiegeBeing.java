 ...
 * @author H1X4
 */
public class AICondition_TargetIsRegionSiegeBeing extends AICondition {
    /**
     ...
     */
    public AICondition_TargetIsRegionSiegeBeing(AIExecution executor, JsonObject element) {
