...
public class AIExecution_FindTargetInAggro extends AIExecution {
    // state 	 - string
    // dice 	 - int8 (AI_TargetChange_Rate)
    // blendTime - float
    // findType	 - enum[nearest, normal]
    // ally      - boolean
    // target	 - enum[character...etc]
    /**
     ...
     */
    public AIExecution_FindTargetInAggro(AIHandler handler, JsonObject element) {
