 ...
 * @author H1X4
 */
public class AICondition_IsNight extends AICondition {
    /**
     ...
     */
    public AICondition_IsNight(AIExecution executor, JsonObject element) {
    ...
    @Override
    public boolean test() {
        return GameTimeService.getInstance().isNight();
    }
}
