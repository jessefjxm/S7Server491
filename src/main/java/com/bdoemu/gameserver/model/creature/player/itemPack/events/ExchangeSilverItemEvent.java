...
public class ExchangeSilverItemEvent extends AItemEvent {
    private int itemId;
    private int enchantLevel;
    private long count;
    private long receiveCount;

    public ExchangeSilverItemEvent(final Player player, final int itemId, final int enchantLevel, final long count, final long receiveCount) {
    ...
    public boolean canAct() {
        ...
        this.addItem(1, this.receiveCount, 0);
