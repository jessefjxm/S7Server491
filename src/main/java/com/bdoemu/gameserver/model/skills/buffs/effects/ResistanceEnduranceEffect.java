...
public class ResistanceEnduranceEffect extends ABuffEffect {
    @Override
    ...
    public void applyEffect(final ActiveBuff activeBuff) {
        ...
        target.getGameStats().getEnduranceReduceStat().addElement(element);
    }
    ...
    public void endEffect(final ActiveBuff activeBuff) {
        final BuffElement element = activeBuff.getElement();
        final Creature target = activeBuff.getTarget();
        target.getGameStats().getEnduranceReduceStat().removeElement(element);
    }
}
