...
public class CatchFishChanceAddEffect extends ABuffEffect {
    @Override
    ...
    //
    //	// 1 = rare fish, 2 = big fish
    //	target.getGameStats().getStat(StatEnum.CatchFishChance).addElement(element);
    //}
    //
    //@Override
    ...
    //    final BuffElement element = activeBuff.getElement();
    //
    //	target.getGameStats().getStat(StatEnum.CatchFishChance).removeElement(element);
    //}
}
