...
public class VersusMonsterStatEffect extends ABuffEffect {
    @Override
    ...
    //
    //	// 0 = reduction, 1 = resistance.
    //	target.getGameStats().getStat(StatEnum.VersusMonsterStat).addElement(element);
    //}
    //
    //@Override
    ...
    //    final BuffElement element = activeBuff.getElement();
    //
    //	target.getGameStats().getStat(StatEnum.VersusMonsterStat).removeElement(element);
    //}
}