...
public class PcCommandHandler extends AbstractCommandHandler {
    ...
    public static Object[] announce(final Player player, final String... params) {
        ...
        final SMChat announcePacket = new SMChat(player.getName(), player.getFamily(), player.getGameObjectId(), EChatType.Notice, EChatNoticeType.None, announceText.toString());
    ...
    public static Object[] addknowledge(final Player player, final String... params) {
        ...
        if (cardGradeType == null) {
            return AbstractCommandHandler.getRejectResult("ECardGradeType doesn't exist for " + cardLevel + " card level!");
        }
    ...
    public static Object[] info(final Player player, final String... params) {
        ...
        player.sendMessage("KnockBack: " + (player.getGameStats().getResistKnockBack().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("KnockDown: " + (player.getGameStats().getResistKnockDown().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("Capture: " + (player.getGameStats().getResistCapture().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("Stun: " + (player.getGameStats().getResistStun().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("Rigid: " + (player.getGameStats().getResistRigid().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("Bound " + (player.getGameStats().getResistBound().getIntMaxValue() / 10_000.0) + "%", true);
        player.sendMessage("Horror: " + (player.getGameStats().getResistHorror().getIntMaxValue() / 10_000.0) + "%", true);
