...
@IAIName("npc_blackratmerchant_bazhar")
public class Ai_npc_blackratmerchant_bazhar extends CreatureAI {
	public Ai_npc_blackratmerchant_bazhar(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void GoToHomePosition(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_45204_15", ENaviType.ground, () -> {
	...
	protected void GoBackPosition(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_45204_01", ENaviType.ground, () -> {
