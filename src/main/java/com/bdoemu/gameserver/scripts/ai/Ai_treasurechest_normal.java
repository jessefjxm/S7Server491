...
@IAIName("treasurechest_normal")
public class Ai_treasurechest_normal extends CreatureAI {
	public Ai_treasurechest_normal(Creature actor, Map<Long, Integer> aiVariables) {
