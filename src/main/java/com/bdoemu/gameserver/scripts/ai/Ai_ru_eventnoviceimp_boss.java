...
@IAIName("ru_eventnoviceimp_boss")
public class Ai_ru_eventnoviceimp_boss extends CreatureAI {
	public Ai_ru_eventnoviceimp_boss(Creature actor, Map<Long, Integer> aiVariables) {
