...
@IAIName("alter_monsters_main")
public class Ai_alter_monsters_main extends CreatureAI {
	public Ai_alter_monsters_main(Creature actor, Map<Long, Integer> aiVariables) {
