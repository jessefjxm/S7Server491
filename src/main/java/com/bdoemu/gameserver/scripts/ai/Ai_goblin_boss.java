...
@IAIName("goblin_boss")
public class Ai_goblin_boss extends CreatureAI {
	public Ai_goblin_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xE8587A5L /*_Special_Stun_EndTime*/) >= 15000) {
