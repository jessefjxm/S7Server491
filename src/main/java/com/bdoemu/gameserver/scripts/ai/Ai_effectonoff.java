...
@IAIName("effectonoff")
public class Ai_effectonoff extends CreatureAI {
	public Ai_effectonoff(Creature actor, Map<Long, Integer> aiVariables) {
	...
	public EAiHandlerResult HandlerTalkToDie(Creature sender, Integer[] eventData) {
		...
		if (changeState(state -> Suicide_Die_Wait(0.1)))
