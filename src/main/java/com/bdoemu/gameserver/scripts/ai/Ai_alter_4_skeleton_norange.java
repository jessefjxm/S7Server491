...
@IAIName("alter_4_skeleton_norange")
public class Ai_alter_4_skeleton_norange extends CreatureAI {
	public Ai_alter_4_skeleton_norange(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait_Target_Logic(double blendTime) {
		...
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 4000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138))) {
