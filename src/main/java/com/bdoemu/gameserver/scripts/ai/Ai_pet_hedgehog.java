...
@IAIName("pet_hedgehog")
public class Ai_pet_hedgehog extends CreatureAI {
	public Ai_pet_hedgehog(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_Summon(double blendTime) {
		...
		if (false && getVariable(0xCC1D827CL /*_Skill1_Type*/) == 9 && getVariable(0xC3671716L /*_isFindThatMode*/) == 1) {
