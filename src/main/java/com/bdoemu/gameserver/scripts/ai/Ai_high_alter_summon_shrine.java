...
@IAIName("high_alter_summon_shrine")
public class Ai_high_alter_summon_shrine extends CreatureAI {
	public Ai_high_alter_summon_shrine(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Spawn_Area_Select1(blendTime), 1000));
	}
	...
	protected void Monster_Teleport_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo() && getVariable(0x1C1B5E4EL /*_SummonArea1*/) == 1) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27226).forEach(consumer -> consumer.getAi().Teleport_Position_A1(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1C1B5E4EL /*_SummonArea1*/) == 2) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27226).forEach(consumer -> consumer.getAi().Teleport_Position_A2(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1C1B5E4EL /*_SummonArea1*/) == 3) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27226).forEach(consumer -> consumer.getAi().Teleport_Position_A3(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1C1B5E4EL /*_SummonArea1*/) == 4) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27226).forEach(consumer -> consumer.getAi().Teleport_Position_A4(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x4085EAC8L /*_SummonArea2*/) == 1) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27227).forEach(consumer -> consumer.getAi().Teleport_Position_B1(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x4085EAC8L /*_SummonArea2*/) == 2) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27227).forEach(consumer -> consumer.getAi().Teleport_Position_B2(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x4085EAC8L /*_SummonArea2*/) == 3) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27227).forEach(consumer -> consumer.getAi().Teleport_Position_B3(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x4085EAC8L /*_SummonArea2*/) == 4) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27227).forEach(consumer -> consumer.getAi().Teleport_Position_B4(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0xCA2A0728L /*_SummonArea3*/) == 1) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27228).forEach(consumer -> consumer.getAi().Teleport_Position_C1(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0xCA2A0728L /*_SummonArea3*/) == 2) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27228).forEach(consumer -> consumer.getAi().Teleport_Position_C2(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0xCA2A0728L /*_SummonArea3*/) == 3) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27228).forEach(consumer -> consumer.getAi().Teleport_Position_C3(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0xCA2A0728L /*_SummonArea3*/) == 4) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27228).forEach(consumer -> consumer.getAi().Teleport_Position_C4(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1950FCA4L /*_SummonArea4*/) == 1) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27229).forEach(consumer -> consumer.getAi().Teleport_Position_D1(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1950FCA4L /*_SummonArea4*/) == 2) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27229).forEach(consumer -> consumer.getAi().Teleport_Position_D2(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1950FCA4L /*_SummonArea4*/) == 3) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27229).forEach(consumer -> consumer.getAi().Teleport_Position_D3(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0x1950FCA4L /*_SummonArea4*/) == 4) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27229).forEach(consumer -> consumer.getAi().Teleport_Position_D4(getActor(), null));
		}
		if (checkInstanceTeamNo() && getVariable(0xEAB74A0CL /*_SummonArea5*/) == 5) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && getTargetCharacterKey(object) == 27230).forEach(consumer -> consumer.getAi().Teleport_Position_E5(getActor(), null));
		}
	...
	protected void Summon_Wave1_A_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave1_A(getActor(), null));
		}
							if (checkInstanceTeamNo()) {
	...
	protected void Summon_Wave1_B(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave1_B(getActor(), null));
		}
	...
	protected void Summon_Wave1_C(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave1_C(getActor(), null));
		}
	...
	protected void Summon_Wave2_A_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave2_A(getActor(), null));
		}
							if (checkInstanceTeamNo()) {
				getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138)).forEach(consumer -> consumer.getAi().Fake(getActor(), null));
			}
	...
	protected void Summon_Wave2_B(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave2_B(getActor(), null));
		}
	...
	protected void Summon_Wave2_C(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave2_C(getActor(), null));
		}
	...
	protected void Summon_Wave3_A_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave3_A(getActor(), null));
		}
							if (checkInstanceTeamNo()) {
				getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138)).forEach(consumer -> consumer.getAi().Fake(getActor(), null));
			}
	...
	protected void Summon_Wave3_B(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave3_B(getActor(), null));
		}
	...
	protected void Summon_Wave3_C(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave3_C(getActor(), null));
		}
	...
	protected void Summon_Wave4_A_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_A(getActor(), null));
		}
							if (checkInstanceTeamNo()) {
				getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138)).forEach(consumer -> consumer.getAi().Fake(getActor(), null));
			}
	...
	protected void Summon_Wave4_B(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_B(getActor(), null));
		}
	...
	protected void Summon_Wait4_B(double blendTime) {
		...
		if(getCallCount() == 50) {
			if (changeState(state -> Summon_Wave4_C(blendTime)))
				return;
		}
	...
	protected void Summon_Wave4_C(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_C(getActor(), null));
		}
		changeState(state -> Summon_Wait4_C1(blendTime));
	}

	protected void Summon_Wait4_C1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xB430624CL /*Summon_Wait4_C1*/);
		if(getCallCount() == 5) {
			if (changeState(state -> Summon_Wait4_C_Logic(blendTime)))
				return;
		}
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Wait4_C1(blendTime), 1000));
	}
	...
	protected void Summon_Wait4_C_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo() && target != null && (getTargetCharacterKey(target) == 27256 || getTargetCharacterKey(target) == 27257 || getTargetCharacterKey(target) == 27258 || getTargetCharacterKey(target) == 27259 || getTargetCharacterKey(target) == 27260 || getTargetCharacterKey(target) == 27261 || getTargetCharacterKey(target) == 27262)) {
	...
	protected void Summon_Wait4_C_Logic1(double blendTime) {
		...
		if (getVariable(0x9F2A066FL /*_DeathCount*/) >= 20 && checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_C3(getActor(), null));
		}
		if (getVariable(0x9F2A066FL /*_DeathCount*/) < 20 && getVariable(0x9F2A066FL /*_DeathCount*/) >= 10 && checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_C2(getActor(), null));
		}
		if (getVariable(0x9F2A066FL /*_DeathCount*/) < 10 && checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave4_C1(getActor(), null));
		}
	...
	protected void Summon_Wave5_A_Logic(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave5_A(getActor(), null));
		}
							if (checkInstanceTeamNo()) {
				getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138)).forEach(consumer -> consumer.getAi().Fake(getActor(), null));
			}
	...
	protected void Summon_Wave5_B(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave5_B(getActor(), null));
		}
	...
	protected void Summon_Wave5_C(double blendTime) {
		...
		if (checkInstanceTeamNo()) {
			getObjects(EAIFindTargetType.Monster, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 1000 && (getTargetCharacterKey(object) == 27226 || getTargetCharacterKey(object) == 27227 || getTargetCharacterKey(object) == 27228 || getTargetCharacterKey(object) == 27229 || getTargetCharacterKey(object) == 27230)).forEach(consumer -> consumer.getAi().Wave5_C(getActor(), null));
		}
