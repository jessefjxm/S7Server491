...
@IAIName("campingtent")
public class Ai_campingtent extends CreatureAI {
	public Ai_campingtent(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Close(double blendTime) {
		...
		doAction(1340753835L /*UNSUMMON*/, blendTime, onDoActionEnd -> scheduleState(state -> Die(blendTime), 399));
	}
	...
	@Override
	public EAiHandlerResult HandleCampingTentClose(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
