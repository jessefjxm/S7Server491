...
@IAIName("beginner_protection_summon_boss")
public class Ai_beginner_protection_summon_boss extends CreatureAI {
	public Ai_beginner_protection_summon_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Stage1_Start_10SEC_Ago_Message(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_TIME10SEC");
	...
	protected void Stage1_Start_Message(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_1STAGE");
		setVariable(0x2C934EF0L /*_Stage_MessageCount*/, 1);
	...
	protected void Stage1_Wait(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage1(blendTime), 1000));
	}
	...
	protected void Summon_Stage1(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_SUMMON_MONSTER");
		doAction(633711333L /*BATTLE_SUMMON_STAGE1*/, blendTime, onDoActionEnd -> changeState(state -> Summon_Stage1_Ing(blendTime)));
	}

	protected void Summon_Stage1_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x4BEAD34AL /*Summon_Stage1_Ing*/);
		if (getPartyMembersCount()<= 0) {
			if (changeState(state -> Stage1_End(0.3)))
				return;
		}
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage1_Ing(blendTime), 1000));
	}
	...
	protected void Stage1_End(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage1_1(blendTime), 500));
	}

	protected void Summon_Stage1_1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x3DDD3CFBL /*Summon_Stage1_1*/);
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_SUMMON_MONSTER");
		doAction(1601210773L /*BATTLE_SUMMON_STAGE1_1*/, blendTime, onDoActionEnd -> changeState(state -> Summon_Stage1_1_Ing(blendTime)));
	}

	protected void Summon_Stage1_1_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x5523F1A0L /*Summon_Stage1_1_Ing*/);
		if (getPartyMembersCount()<= 0) {
			if (changeState(state -> Stage1_1_End(0.3)))
				return;
		}
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage1_1_Ing(blendTime), 1000));
	}

	protected void Stage1_1_End(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x10834344L /*Stage1_1_End*/);
	...
	protected void Stage2_Start_5SEC_Ago_Message(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_TIME5SEC");
	...
	protected void Stage2_Start_Message(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_2STAGE");
		setVariable(0x2C934EF0L /*_Stage_MessageCount*/, 2);
	...
	protected void Stage2_Wait(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage2(blendTime), 1000));
	}
	...
	protected void Summon_Stage2(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_SUMMON_MONSTER");
		doAction(696130823L /*BATTLE_SUMMON_STAGE2*/, blendTime, onDoActionEnd -> changeState(state -> Summon_Stage2_Ing(blendTime)));
	}

	protected void Summon_Stage2_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x3E306ACL /*Summon_Stage2_Ing*/);
		if (getPartyMembersCount()<= 0) {
			if (changeState(state -> Stage2_End(0.3)))
				return;
		}
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage2_Ing(blendTime), 1000));
	}
	...
	protected void Stage2_End(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage2_1(blendTime), 500));
	}

	protected void Summon_Stage2_1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xC0729A45L /*Summon_Stage2_1*/);
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_SUMMON_MONSTER");
		doAction(123721801L /*BATTLE_SUMMON_STAGE2_1*/, blendTime, onDoActionEnd -> changeState(state -> Summon_Stage2_1_Ing(blendTime)));
	}

	protected void Summon_Stage2_1_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x4CB1091AL /*Summon_Stage2_1_Ing*/);
		if (getPartyMembersCount()<= 0) {
			if (changeState(state -> Stage2_1_End(0.3)))
				return;
		}
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage2_1_Ing(blendTime), 1000));
	}

	protected void Stage2_1_End(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x81F0DF6L /*Stage2_1_End*/);
	...
	protected void Stage3_Start_Message(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_BEGINNER_DEFENCE_BOSS_MESSAGE_3STAGE");
		setVariable(0x2C934EF0L /*_Stage_MessageCount*/, 3);
	...
	protected void Stage3_Wait(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage3_Ing(blendTime), 5000));
	}

	protected void Summon_Stage3_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x90164999L /*Summon_Stage3_Ing*/);
		if (getPartyMembersCount()<= 0) {
			if (changeState(state -> Stage3_End(0.3)))
				return;
		}
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Stage3_Ing(blendTime), 1000));
	}
