...
@IAIName("summon_recoverybuilding")
public class Ai_summon_recoverybuilding extends CreatureAI {
	public Ai_summon_recoverybuilding(Creature actor, Map<Long, Integer> aiVariables) {
