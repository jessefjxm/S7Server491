...
@IAIName("summon_hunnishcatapultbuilding")
public class Ai_summon_hunnishcatapultbuilding extends CreatureAI {
	public Ai_summon_hunnishcatapultbuilding(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Working_Str(double blendTime) {
		...
		useSkill(41095, 1, false, EAIFindTargetType.Self, object -> true);
	...
	protected void Die(double blendTime) {
		...
		getObjects(EAIFindTargetType.Character, object -> getDistanceToTarget(object) < 100 && getTargetCharacterKey(object) == 31008).forEach(consumer -> consumer.getAi()._DestroyedBase(getActor(), null));
