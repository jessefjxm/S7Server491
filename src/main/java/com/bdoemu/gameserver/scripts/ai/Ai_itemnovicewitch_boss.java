...
@IAIName("itemnovicewitch_boss")
public class Ai_itemnovicewitch_boss extends CreatureAI {
	public Ai_itemnovicewitch_boss(Creature actor, Map<Long, Integer> aiVariables) {
