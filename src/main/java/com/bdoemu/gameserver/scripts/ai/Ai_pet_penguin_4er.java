...
@IAIName("pet_penguin_4er")
public class Ai_pet_penguin_4er extends CreatureAI {
	public Ai_pet_penguin_4er(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Random_Move2_Str(double blendTime) {
		...
		doAction(1000628648L /*SLIDING_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Random_Move2_Ing(blendTime), 500));
	}
	...
	protected void Random_Move2_End(double blendTime) {
		...
		doAction(167981748L /*SLIDING_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void ChaseOwner_MoveLv3(double blendTime) {
		...
		doAction(169952953L /*SLIDING_FAST_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> ChaseOwner_MoveLv3_Ing(blendTime), 500));
	}
	...
	protected void ChaseOwner_MoveLv3_End(double blendTime) {
		...
		doAction(4215928511L /*SLIDING_FAST_END*/, blendTime, onDoActionEnd -> {
			...
			scheduleState(state -> Wait_Summon(blendTime), 500);
		});
	}
