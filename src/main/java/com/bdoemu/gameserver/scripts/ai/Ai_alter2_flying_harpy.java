...
@IAIName("alter2_flying_harpy")
public class Ai_alter2_flying_harpy extends CreatureAI {
	public Ai_alter2_flying_harpy(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0x29313B91L /*_IsSize*/, 0);
		...
		setVariable(0x6B36CE54L /*_DamageCount*/, 0);
	...
	protected void Start_Action(double blendTime) {
		...
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Target_Logic(0.3)))
					return;
			}
		}
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && isDarkSpiritMonster()) {
		...
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && isDarkSpiritMonster()) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Target_Logic(0.3)))
					return;
			}
	...
	protected void Start_Action_Swim(double blendTime) {
		...
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Target_Logic_Swim(0.3)))
					return;
			}
		}
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && isDarkSpiritMonster()) {
	...
	protected void Start_ActionMove(double blendTime) {
		...
		doAction(272740183L /*START_ACTIONMOVE*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Party_Start_Logic(double blendTime) {
		...
		if (getVariable(0xFA9DA674L /*_IsBattleMode*/) == 1) {
			if (changeState(state -> Battle_Wait_Target_Logic(blendTime)))
				return;
		}
	...
	protected void TargetChange_Logic(double blendTime) {
		...
		if (getVariable(0x3A3151A8L /*AI_TargetChange_Rate*/) > 0) {
			if(Rnd.getChance(getVariable(0x3A3151A8L /*AI_TargetChange_Rate*/))) {
				if (findTargetInAggro(EAIFindTargetType.Enemy, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && isCreatureVisible(object, false))) {
					if (changeState(state -> Battle_Wait_Target_Logic(0.3)))
						return;
				}
			}
		}
		changeState(state -> Battle_Wait_Target_Logic(blendTime));
	}
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0xA71F8225L /*AI_IsPlunder*/) == 0 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && isDarkSpiritMonster() && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && isCreatureVisible(object, false))) {
				if (changeState(state -> Search_Enemy(0.3)))
					return;
			}
	...
	protected void Alert_Start_Action_Logic(double blendTime) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 0) {
			if (changeState(state -> Alert_Battle_Wait_Target_Logic(0.3)))
				return;
		}
		changeState(state -> Alert_Battle_Wait_Target_Logic(blendTime));
	}
	...
	protected void Alert_Search_Enemy(double blendTime) {
		...
		setVariable(0x1408C89EL /*_IsAlert*/, 1);
		doAction(11967395L /*SEARCH_ENEMY*/, blendTime, onDoActionEnd -> scheduleState(state -> Alert_Battle_Wait_Target_Logic(blendTime), 2000));
	}

	protected void Alert_Battle_Wait_Target_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xF88DF8E4L /*Alert_Battle_Wait_Target_Logic*/);
		clearAggro(false);
		setVariable(0x1408C89EL /*_IsAlert*/, 1);
		setVariable(0x9C1A0E76L /*_Fear*/, 0);
		setVariable(0xFA9DA674L /*_IsBattleMode*/, 0);
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Alert_Battle_Wait_Target_Logic(blendTime), 500));
	}

	protected void Alert_Battle_Wait_Target_Logic_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x9EB349BEL /*Alert_Battle_Wait_Target_Logic_Logic*/);
	...
	protected void Alert_Recovery(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Alert_Battle_Wait_Target_Logic(blendTime), 100));
	}
	...
	protected void Alert_Turn_Left(double blendTime) {
		...
		doAction(2428216894L /*TURN_LEFT*/, blendTime, onDoActionEnd -> changeState(state -> Alert_Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Alert_Turn_Right(double blendTime) {
		...
		doAction(217859608L /*TURN_RIGHT*/, blendTime, onDoActionEnd -> changeState(state -> Alert_Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Alert_Turn_180(double blendTime) {
		...
		doAction(1676409899L /*TURN_180*/, blendTime, onDoActionEnd -> changeState(state -> Alert_Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Move_Random(double blendTime) {
		...
		if (getVariable(0xA71F8225L /*AI_IsPlunder*/) == 0 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Target_Logic(0.3)))
					return;
			}
	...
	protected void Search_Enemy_Swim(double blendTime) {
		...
		doAction(577920792L /*SEARCH_ENEMY_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic_Swim(blendTime), 2000));
	}
	...
	protected void Weapon_Out(double blendTime) {
		...
		doAction(4142397618L /*WEAPON_OUT*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 2000));
	}
	...
	protected void Weapon_Out_Swim(double blendTime) {
		...
		doAction(3689010407L /*WEAPON_OUT_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic_Swim(blendTime), 2000));
	}
	...
	protected void Move_Chaser(double blendTime) {
		...
		if (getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 1 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3_NoRotate(0.3)))
					return;
			}
		}
		if (getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 0 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3_Rotate(0.3)))
					return;
			}
		}
		if (getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 1 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/))) {
				if (changeState(state -> Battle_RangeAttack2_NoRotate(0.3)))
					return;
			}
		}
		if (getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 0 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/))) {
				if (changeState(state -> Battle_RangeAttack2_Rotate(0.3)))
					return;
			}
		}
		if (getVariable(0xDAB0B4A8L /*AI_BT_RangeAttack1*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 1 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2D200EA6L /*AI_BT_RangeAttack1_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xC928C29FL /*AI_BT_RangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9354A910L /*AI_BT_RangeAttack1_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xD947DBACL /*AI_BT_RangeAttack1_HP*/) && target != null && getAngleToTarget(target) >= getVariable(0xBACBD4B0L /*AI_BT_RangeAttack1_MinDegree*/) && target != null && getAngleToTarget(target) <= getVariable(0x424127F0L /*AI_BT_RangeAttack1_MaxDegree*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xDAB0B4A8L /*AI_BT_RangeAttack1*/))) {
				if (changeState(state -> Battle_RangeAttack1_NoRotate(0.3)))
					return;
			}
		}
		if (getVariable(0xDAB0B4A8L /*AI_BT_RangeAttack1*/) > 0 && getVariable(0xA6AE24BFL /*AI_BT_RangeAttack1_RotateOff*/) == 0 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2D200EA6L /*AI_BT_RangeAttack1_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xC928C29FL /*AI_BT_RangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9354A910L /*AI_BT_RangeAttack1_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xD947DBACL /*AI_BT_RangeAttack1_HP*/) && target != null && getAngleToTarget(target) >= getVariable(0xBACBD4B0L /*AI_BT_RangeAttack1_MinDegree*/) && target != null && getAngleToTarget(target) <= getVariable(0x424127F0L /*AI_BT_RangeAttack1_MaxDegree*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xDAB0B4A8L /*AI_BT_RangeAttack1*/))) {
				if (changeState(state -> Battle_RangeAttack1_Rotate(0.3)))
					return;
			}
		}
	...
	protected void FailFindPath_Logic(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void FailFindPathToTarget(double blendTime) {
		...
		doTeleport(EAIMoveDestType.OwnerPosition, 500, 500, 1, 1);
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 2000));
	}
	...
	protected void FailFindPath_ReturnToParent(double blendTime) {
		...
		setVariable(0x46A5E1BAL /*_HelpMe_Count*/, getVariable(0xB667AD0BL /*AI_HelpMe_Count*/));
		doTeleport(EAIMoveDestType.OwnerPosition, 500, 500, 1, 1);
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 2000));
	}
	...
	protected void Move_Escape(double blendTime) {
		...
		doAction(1405914678L /*MOVE_ESCAPE*/, blendTime, onDoActionEnd -> escape(getVariable(0x8FA1E7B6L /*AI_ES_MaxDistance*/), () -> {
			...
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 3000)));
	}
	...
	protected void Move_RunAway_Wait(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 1000));
	}
	...
	protected void Move_Return(double blendTime) {
		...
		changeState(state -> Return_Shrine(blendTime));
	}
	...
	protected void Return_Shrine(double blendTime) {
		...
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 8000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138))) {
	...
	protected void Move_Around(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveAround(getVariable(0x3AF07E15L /*AI_MA_TargetRadius*/) + Rnd.get(getVariable(0xD79E8369L /*AI_MA_MinMove*/), getVariable(0x46DE6ECFL /*AI_MA_MaxMove*/)), ENaviType.ground, () -> {
			...
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 1500)));
	}
	...
	protected void Turn_Left(double blendTime) {
		...
		doAction(2428216894L /*TURN_LEFT*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Turn_Right(double blendTime) {
		...
		doAction(217859608L /*TURN_RIGHT*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Turn_180(double blendTime) {
		...
		doAction(1676409899L /*TURN_180*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Turn_180_Swim(double blendTime) {
		...
		doAction(2364206887L /*TURN_180_SWIM*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic_Swim(blendTime)));
	}
	...
	protected void Move_Warp_c(double blendTime) {
		...
		doAction(159963012L /*MOVE_WARP_C*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 1000));
	}
	...
	protected void Move_WarpAttack_d(double blendTime) {
		...
		doAction(1458648773L /*ATTACK_WARP*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}

	protected void Party_Battle_Wait_Target_Logic_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x4F3945F8L /*Party_Battle_Wait_Target_Logic_Logic*/);
		changeState(state -> Battle_Wait_Target_Logic(blendTime));
	}
	...
	protected void Battle_Wait(double blendTime) {
		...
		setVariable(0x1408C89EL /*_IsAlert*/, 0);
		if (getVariable(0x29313B91L /*_IsSize*/) == 0) {
			if (changeState(state -> Return_Shrine(blendTime)))
				return;
		}
		if (target == null) {
		...
		if (getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/) > 0 && getVariable(0x4EA7E3D1L /*AI_BT_RangeAttack3_RotateOff*/) == 1 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3_NoRotate(0.3)))
					return;
			}
		}
		if (getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/) > 0 && getVariable(0x4EA7E3D1L /*AI_BT_RangeAttack3_RotateOff*/) == 0 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3_Rotate(0.3)))
					return;
			}
		}
		if (getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/) > 0 && getVariable(0x4F80D5A8L /*AI_BT_RangeAttack2_RotateOff*/) == 1 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/))) {
				if (changeState(state -> Battle_RangeAttack2_NoRotate(0.3)))
					return;
			}
		}
		if (getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/) > 0 && getVariable(0x4F80D5A8L /*AI_BT_RangeAttack2_RotateOff*/) == 0 && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/))) {
				if (changeState(state -> Battle_RangeAttack2_Rotate(0.3)))
					return;
			}
	...
	protected void Battle_Wait_Target_Logic_Swim(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xB2D557E3L /*Battle_Wait_Target_Logic_Swim*/);
		setVariable(0x1408C89EL /*_IsAlert*/, 0);
		setVariable(0x3F487035L /*_HP*/, getHpRate());
		if (isPartyMember()) {
			setVariable(0xCBEEF8C7L /*_OwnerDistance*/, getDistanceToOwner());
		...
		doAction(902766309L /*BATTLE_WAIT_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic_Swim(blendTime), 500));
	}
	...
	protected void Lost_Target_Ground(double blendTime) {
		...
		if (getVariable(0xA71F8225L /*AI_IsPlunder*/) == 0 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTargetInAggro(EAIFindTargetType.Enemy, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Target_Logic(0.3)))
					return;
			}
	...
	protected void Special_Action(double blendTime) {
		...
		doAction(1259299072L /*SPECIAL_ACTION*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Battle_ChargeAttack1(double blendTime) {
		...
		doAction(3904990386L /*BATTLE_CHARGEATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Battle_ChargeAttack2(double blendTime) {
		...
		doAction(435020623L /*BATTLE_CHARGEATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Battle_TargetPositionAttack1_End(double blendTime) {
		...
		doAction(898509181L /*BATTLE_POSITIONATTACK1_END*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Battle_RangeAttack1_Rotate_Swim(double blendTime) {
		...
		doAction(2329299101L /*BATTLE_RANGEATTACK1_SWIM*/, blendTime, onDoActionEnd -> {
			...
			changeState(state -> Battle_Wait_Target_Logic_Swim(blendTime));
		});
	}
	...
	protected void Chase_Attack1(double blendTime) {
		...
		doAction(4010467008L /*CHASE_ATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Chase_Attack2(double blendTime) {
		...
		doAction(1351458155L /*CHASE_ATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Chase_Attack3(double blendTime) {
		...
		doAction(1648968437L /*CHASE_ATTACK3*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Damage_Attack1(double blendTime) {
		...
		doAction(1112546316L /*DAMAGE_ATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Damage_Attack2(double blendTime) {
		...
		doAction(2181925973L /*DAMAGE_ATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Damage_RangeAttack1(double blendTime) {
		...
		doAction(827804183L /*DAMAGE_RANGEATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Damage_RangeAttack2(double blendTime) {
		...
		doAction(1058790415L /*DAMAGE_RANGEATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Around_Attack1_Rotate(double blendTime) {
		...
		doAction(434909106L /*AROUND_ATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Around_Attack2_Rotate(double blendTime) {
		...
		doAction(3173509898L /*AROUND_ATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Around_RangeAttack1_Rotate(double blendTime) {
		...
		doAction(1080499018L /*AROUND_RANGEATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Around_RangeAttack2_Rotate(double blendTime) {
		...
		doAction(460537979L /*AROUND_RANGEATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> TargetChange_Logic(blendTime)));
	}
	...
	protected void Combi_MoveSpeedDown(double blendTime) {
		...
		doAction(3601242505L /*COMBI_MOVESPEED_DOWN*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Combi_AttackSpeedDown(double blendTime) {
		...
		doAction(3824927449L /*COMBI_ATTACKSPEED_DOWN*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Combi_PVDown(double blendTime) {
		...
		doAction(1532694810L /*COMBI_PV_DOWN*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Combi_BuffCancel(double blendTime) {
		...
		doAction(3741917618L /*COMBI_BUFF_CANCEL*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_Target_Logic(blendTime)));
	}
	...
	protected void Combi_Stun(double blendTime) {
		...
		doAction(1092723167L /*DAMAGE_STUN*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Target_Logic(blendTime), 5000));
	}
	...
	protected void Damage_Normal(double blendTime) {
		...
		doAction(2420816374L /*DAMAGE_NORMAL*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Damage_KnockBack(double blendTime) {
		...
		doAction(3633065904L /*DAMAGE_KNOCKBACK*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Counter_KnockBack(double blendTime) {
		...
		doAction(1451681896L /*COUNTER_KNOCKBACK*/, blendTime, onDoActionEnd -> changeState(state -> Return_Shrine(blendTime)));
	}
	...
	protected void Damage_Stun_End(double blendTime) {
		...
		doAction(3912128442L /*DAMAGE_STUN_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 1000));
	}
	...
	protected void Counter_Stun(double blendTime) {
		...
		doAction(3836323897L /*COUNTER_STUN*/, blendTime, onDoActionEnd -> changeState(state -> Return_Shrine(blendTime)));
	}
	...
	protected void Damage_Stop(double blendTime) {
		...
		doAction(1199011494L /*DAMAGE_STOP*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), getVariable(0xE1F002D2L /*AI_Stop_CallCycleTime*/)));
	}
	...
	protected void Damage_KnockDown(double blendTime) {
		...
		doAction(840787941L /*DAMAGE_KNOCKDOWN*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 4000));
	}
	...
	protected void Counter_KnockDown(double blendTime) {
		...
		doAction(3570834151L /*COUNTER_KNOCKDOWN*/, blendTime, onDoActionEnd -> changeState(state -> Return_Shrine(blendTime)));
	}
	...
	protected void Damage_Bound(double blendTime) {
		...
		doAction(1109738762L /*DAMAGE_BOUND*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 4000));
	}
	...
	protected void Counter_Bound(double blendTime) {
		...
		doAction(1264349027L /*COUNTER_BOUND*/, blendTime, onDoActionEnd -> changeState(state -> Return_Shrine(blendTime)));
	}
	...
	protected void Damage_Capture(double blendTime) {
		...
		doAction(3486436380L /*DAMAGE_CAPTURE*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 5000));
	}
	...
	protected void Damage_AirFloat(double blendTime) {
		...
		doAction(834965090L /*DAMAGE_AIRFLOAT*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Damage_AirSmash(double blendTime) {
		...
		doAction(3455519139L /*DAMAGE_AIRSMASH*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Damage_DownSmash(double blendTime) {
		...
		doAction(460682976L /*DAMAGE_DOWNSMASH*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Damage_Rigid(double blendTime) {
		...
		doAction(4101779004L /*DAMAGE_RIGID*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Counter_Rigid(double blendTime) {
		...
		doAction(2893154600L /*COUNTER_RIGID*/, blendTime, onDoActionEnd -> changeState(state -> Return_Shrine(blendTime)));
	}
	...
	protected void Damage_Freeze_End(double blendTime) {
		...
		doAction(1366805764L /*DAMAGE_FREEZE_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 4000));
	}
	...
	protected void Damage_Release(double blendTime) {
		...
		doAction(1109738762L /*DAMAGE_BOUND*/, blendTime, onDoActionEnd -> scheduleState(state -> Return_Shrine(blendTime), 3000));
	}
	...
	protected void Rotate_Logic(double blendTime) {
		...
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 6000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138))) {
	...
	protected void Target_Change(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x611C0543L /*Target_Change*/);
		if (findTarget(EAIFindTargetType.Player, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 4000)) {
			if (changeState(state -> HighSpeed_Chaser(blendTime)))
				return;
		}
		changeState(state -> Target_Change(blendTime));
	}

	protected void Battle_Wait_Target_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x25115234L /*Battle_Wait_Target_Logic*/);
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 6000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138))) {
	...
	protected void DamageLogic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x5AF3245L /*DamageLogic*/);
		setVariable(0x1E2360D6L /*_StunDelay_StartTime*/, getTime());
		setVariable(0x6B36CE54L /*_DamageCount*/, getVariable(0x6B36CE54L /*_DamageCount*/) + 1);
	...
	protected void Battle_Wait2(double blendTime) {
		...
		doAction(1142352784L /*BATTLE_WAIT2*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait2(blendTime), 500));
	}
	...
	protected void Attack_Range(double blendTime) {
		...
		doAction(376694480L /*BATTLE_RANGEATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait2(blendTime)));
	}
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		...
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/)) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/)) {
		...
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/)) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/)) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		...
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/)) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/)) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x838FBB02L /*Move_ParentPath*/ || getState() == 0xBCCBD2E0L /*Move_ChaseToParent*/ || getState() == 0x455AE195L /*Move_Random_End*/ || getState() == 0x8D36275BL /*Move_Random_EndAction*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x881B0A76L /*Start_Action*/ || getState() == 0xA2EDFBF7L /*CheckLevel_RunAway*/ || getState() == 0xF44A9B48L /*CheckLevel_Escape*/ || getState() == 0xA664004CL /*Wait_CheckLevel*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0x1408C89EL /*_IsAlert*/) == 0 && getVariable(0x60A05FC4L /*AI_FA_SufferAction_Set*/) >= 1 && getVariable(0x8816D447L /*_Weapon_Out*/) == 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0) {
			if (changeState(state -> Search_Enemy(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((getState() == 0xA8755B38L /*Wait_Swim*/ || getState() == 0x2AA53F1DL /*Move_Random_End_Swim*/ || getState() == 0x547252A4L /*Move_Random_EndAction_Swim*/ || getState() == 0x2C8B2FEDL /*Move_Random_Swim*/ || getState() == 0xC4DD1E79L /*Start_Action_Swim*/ || getState() == 0xAC1B136DL /*CheckLevel_RunAway_Swim*/ || getState() == 0x6E25B419L /*CheckLevel_Escape_Swim*/ || getState() == 0x75D6C08DL /*Wait_CheckLevel_Swim*/) && getVariable(0x1408C89EL /*_IsAlert*/) == 0 && getVariable(0x60A05FC4L /*AI_FA_SufferAction_Set*/) >= 1 && getVariable(0x8816D447L /*_Weapon_Out*/) == 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0) {
			if (changeState(state -> Search_Enemy_Swim(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
	...
	@Override
	public EAiHandlerResult Provocation(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (changeState(state -> Return_Shrine(0.1)))
			return EAiHandlerResult.CHANGE_STATE;
		return EAiHandlerResult.BYPASS;
	}
	...
	public EAiHandlerResult HandleBound(Creature sender, Integer[] eventData) {
		...
		if (getVariable(0x6FE070DDL /*AI_Counter_Bound*/) < 1) {
	...
	@Override
	public EAiHandlerResult AllChildDie(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
	...
	@Override
	public EAiHandlerResult WaveClear(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (changeState(state -> Damage_Die(0.5)))
			return EAiHandlerResult.CHANGE_STATE;
	...
	public EAiHandlerResult HandleTakeTeamDamage(Creature sender, Integer[] eventData) {
		...
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		...
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		...
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
	...
	public EAiHandlerResult HandlePartyReleased(Creature sender, Integer[] eventData) {
		...
		if (getVariable(0xFA9DA674L /*_IsBattleMode*/) == 1 && getVariable(0xA2E704C3L /*_Party_Vanish*/) == 0) {
			if (changeState(state -> Party_Battle_Wait_Target_Logic_Logic(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
