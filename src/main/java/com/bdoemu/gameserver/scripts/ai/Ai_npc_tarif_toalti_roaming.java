...
@IAIName("npc_tarif_toalti_roaming")
public class Ai_npc_tarif_toalti_roaming extends CreatureAI {
	public Ai_npc_tarif_toalti_roaming(Creature actor, Map<Long, Integer> aiVariables) {
