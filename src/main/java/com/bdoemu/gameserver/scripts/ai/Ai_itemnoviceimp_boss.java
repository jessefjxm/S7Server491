...
@IAIName("itemnoviceimp_boss")
public class Ai_itemnoviceimp_boss extends CreatureAI {
	public Ai_itemnoviceimp_boss(Creature actor, Map<Long, Integer> aiVariables) {
