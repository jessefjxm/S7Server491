...
@IAIName("w9000_1_0_minion")
public class Ai_w9000_1_0_minion extends CreatureAI {
	public Ai_w9000_1_0_minion(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Line3(double blendTime) {
		...
		doAction(3326922924L /*MOVE_CHASER*/, blendTime, onDoActionEnd -> moveToWaypoint("battlefield", "w10000_team1_route0_7", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait(blendTime), 1000)));
	}
