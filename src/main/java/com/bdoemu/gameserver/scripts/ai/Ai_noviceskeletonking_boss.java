...
@IAIName("noviceskeletonking_boss")
public class Ai_noviceskeletonking_boss extends CreatureAI {
	public Ai_noviceskeletonking_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0xAD9B4917L /*_isAttackCount*/, 0);
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xEBAA9AEAL /*_isRage*/) <= 0 && getVariable(0x3F487035L /*_HP*/) <= 80 && target != null && getDistanceToTarget(target) < 1000 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Roar(0.3)))
				return;
		}
		if (getVariable(0xEBAA9AEAL /*_isRage*/) == 1 && getVariable(0x3F487035L /*_HP*/) <= 50 && target != null && getDistanceToTarget(target) < 1000 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Roar(0.3)))
				return;
		}
		if (getVariable(0xEBAA9AEAL /*_isRage*/) == 2 && getVariable(0x3F487035L /*_HP*/) <= 30 && target != null && getDistanceToTarget(target) < 1000 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Roar(0.3)))
				return;
		}
		...
		if (target != null && getDistanceToTarget(target) < 600 && getVariable(0xAD9B4917L /*_isAttackCount*/) >= 4 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(Rnd.getChance(35)) {
	...
	protected void Attack_Normal1(double blendTime) {
		...
		setVariable(0xAD9B4917L /*_isAttackCount*/, getVariable(0xAD9B4917L /*_isAttackCount*/) + 1);
	...
	protected void Attack_Roar(double blendTime) {
		...
		setVariable(0xEBAA9AEAL /*_isRage*/, getVariable(0xEBAA9AEAL /*_isRage*/) + 1);
