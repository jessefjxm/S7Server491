...
@IAIName("magoria_tornado")
public class Ai_magoria_tornado extends CreatureAI {
	public Ai_magoria_tornado(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Individual_Combat(double blendTime) {
		...
		doAction(1442919285L /*INDIVIDUAL_COMBAT*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 8000, 10000, true, ENaviType.ground, () -> {
			return false;
	...
	protected void CheckSpawn_Logic(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Monster, EAIFindType.normal, true, object -> getDistanceToTarget(object) < 3000 && getTargetCharacterKey(object) == 20758)) {
	...
	protected void Move_Random(double blendTime) {
		...
		doAction(633942026L /*MOVE_WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 100, 0, 1000, true, ENaviType.ground, () -> {
			return false;
