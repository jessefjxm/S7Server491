...
@IAIName("ru_novicetreedummer_boss")
public class Ai_ru_novicetreedummer_boss extends CreatureAI {
	public Ai_ru_novicetreedummer_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x99703876L /*_SummonCount*/) >= 50 && getPartyMembersCount()< 1 && getVariable(0x3F487035L /*_HP*/) > 60) {
			if(Rnd.getChance(20)) {
	...
	protected void Move_Chaser(double blendTime) {
		...
		if (getVariable(0x99703876L /*_SummonCount*/) >= 50 && getVariable(0x3F487035L /*_HP*/) <= 35) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Summon_Creature(0.3)))
					return;
			}
