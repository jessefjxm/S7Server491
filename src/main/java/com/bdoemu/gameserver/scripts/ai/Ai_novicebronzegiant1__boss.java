...
@IAIName("novicebronzegiant1__boss")
public class Ai_novicebronzegiant1__boss extends CreatureAI {
	public Ai_novicebronzegiant1__boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Detect_Target(double blendTime) {
		...
		doAction(3206610633L /*SEARCH_ENEMY_Idx11*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait(blendTime), 2000));
	}
