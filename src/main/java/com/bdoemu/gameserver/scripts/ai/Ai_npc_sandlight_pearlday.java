...
@IAIName("npc_sandlight_pearlday")
public class Ai_npc_sandlight_pearlday extends CreatureAI {
	public Ai_npc_sandlight_pearlday(Creature actor, Map<Long, Integer> aiVariables) {
