...
@IAIName("alter_ogre_boss_desert")
public class Ai_alter_ogre_boss_desert extends CreatureAI {
	public Ai_alter_ogre_boss_desert(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> changeState(state -> Rotate_Logic(blendTime)));
	}
	...
	protected void Move_Return(double blendTime) {
		...
		clearAggro(true);
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 8000 && getTargetCharacterKey(object) == 27138)) {
