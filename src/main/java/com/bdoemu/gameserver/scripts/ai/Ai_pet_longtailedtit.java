...
@IAIName("pet_longtailedtit")
public class Ai_pet_longtailedtit extends CreatureAI {
	public Ai_pet_longtailedtit(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Summon_Start_C(double blendTime) {
		...
		doAction(135998679L /*MOVE_FLYING*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerPosition, 0, 0, 0, 0, 10, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Wait_Summon(blendTime), 1500)));
	}
	...
	protected void Owner_Landing_Ing(double blendTime) {
		...
		doAction(2267039204L /*OWNER_LANDING*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing(blendTime), 1000));
	}
	...
	protected void Owner_Landing_Ing_PBW(double blendTime) {
		...
		doAction(554937847L /*OWNER_LANDING_PBW*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing_PBW(blendTime), 1000));
	}
	...
	protected void Flying_Random(double blendTime) {
		...
		doAction(135998679L /*MOVE_FLYING*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 200, 50, 80, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Flying_Random(blendTime), 1000)));
	}
	...
	protected void GetItem(double blendTime) {
		...
		doAction(3473554812L /*FLING_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> ChaseOwner_MoveLv2(blendTime), 2000));
	}
	...
	protected void FindThatCollect(double blendTime) {
		...
		doAction(3473554812L /*FLING_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> FindThatCollect(blendTime), 2000));
	}
	...
	protected void FindThat(double blendTime) {
		...
		doAction(3473554812L /*FLING_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> FindThat_Up(blendTime), 2000));
	}
	...
	protected void FindThat_Up(double blendTime) {
		...
		doAction(3748920357L /*MOVE_FLYING_UP*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 600, 100, 200, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> FindThat2(blendTime), 1000)));
	}
