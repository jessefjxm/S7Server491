...
@IAIName("npc_fire")
public class Ai_npc_fire extends CreatureAI {
	public Ai_npc_fire(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Die(blendTime), 40000));
	}
