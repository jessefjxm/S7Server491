...
@IAIName("notmove_pickup_normal")
public class Ai_notmove_pickup_normal extends CreatureAI {
	public Ai_notmove_pickup_normal(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0x28128BADL /*_SummonType*/, getVariable(0x9A519925L /*AI_SummonType*/));
	...
	protected void Start_Wait(double blendTime) {
		...
		if (getVariable(0x28128BADL /*_SummonType*/) == 1) {
			if(getCallCount() == 40) {
