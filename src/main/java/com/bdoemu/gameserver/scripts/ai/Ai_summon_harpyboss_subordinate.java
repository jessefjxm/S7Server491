...
@IAIName("summon_harpyboss_subordinate")
public class Ai_summon_harpyboss_subordinate extends CreatureAI {
	public Ai_summon_harpyboss_subordinate(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (target != null && getTargetHp(target) > 0 && target != null && getDistanceToTarget(target) >= getVariable(0xC928C29FL /*AI_BT_RangeAttack1_MinDistance*/) && target != null && getDistanceToTarget(target) <= getVariable(0x9354A910L /*AI_BT_RangeAttack1_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xD947DBACL /*AI_BT_RangeAttack1_HP*/) && target != null && getAngleToTarget(target) >= getVariable(0xBACBD4B0L /*AI_BT_RangeAttack1_MinDegree*/) && target != null && getAngleToTarget(target) <= getVariable(0x424127F0L /*AI_BT_RangeAttack1_MaxDegree*/)) {
