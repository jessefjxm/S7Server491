...
@IAIName("npc_tarif_toabun_roaming")
public class Ai_npc_tarif_toabun_roaming extends CreatureAI {
	public Ai_npc_tarif_toabun_roaming(Creature actor, Map<Long, Integer> aiVariables) {
