...
@IAIName("novicemeddersert_boss")
public class Ai_novicemeddersert_boss extends CreatureAI {
	public Ai_novicemeddersert_boss(Creature actor, Map<Long, Integer> aiVariables) {
