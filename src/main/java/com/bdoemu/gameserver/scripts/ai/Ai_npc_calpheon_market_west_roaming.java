...
@IAIName("npc_calpheon_market_west_roaming")
public class Ai_npc_calpheon_market_west_roaming extends CreatureAI {
	public Ai_npc_calpheon_market_west_roaming(Creature actor, Map<Long, Integer> aiVariables) {
