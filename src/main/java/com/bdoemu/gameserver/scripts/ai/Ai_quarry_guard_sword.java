...
@IAIName("quarry_guard_sword")
public class Ai_quarry_guard_sword extends CreatureAI {
	public Ai_quarry_guard_sword(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Monster, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 800 && getTargetHp(object) > 0)) {
	...
	public EAiHandlerResult HandleTargetInMyArea(Creature sender, Integer[] eventData) {
		...
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x67695F37L /*Lost_Target*/) && target != null && getTargetHp(target) > 0) {
