...
@IAIName("valjailchiefguard")
public class Ai_valjailchiefguard extends CreatureAI {
	public Ai_valjailchiefguard(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Hook_Normal(double blendTime) {
		...
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 2);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, 0);
