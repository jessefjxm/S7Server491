...
@IAIName("summon_minebuilding")
public class Ai_summon_minebuilding extends CreatureAI {
	public Ai_summon_minebuilding(Creature actor, Map<Long, Integer> aiVariables) {
