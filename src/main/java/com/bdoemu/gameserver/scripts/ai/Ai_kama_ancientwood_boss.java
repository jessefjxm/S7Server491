...
@IAIName("kama_ancientwood_boss")
public class Ai_kama_ancientwood_boss extends CreatureAI {
	public Ai_kama_ancientwood_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Die_Logic(double blendTime) {
		...
		getObjects(EAIFindTargetType.Sibling, object -> getTargetCharacterKey(object) == 23754).forEach(consumer -> consumer.getAi().Die(getActor(), null));
	...
	protected void Attack_FLR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23755 || getTargetCharacterKey(object) == 23756)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(2908231930L /*ATTACK_FLR*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> (getTargetCharacterKey(object) == 23755 || getTargetCharacterKey(object) == 23756)).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
	...
	protected void Attack_FL(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> getTargetCharacterKey(object) == 23755).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(506926446L /*ATTACK_FL*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> getTargetCharacterKey(object) == 23755).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
			changeState(state -> TargetChange_Logic(blendTime));
		});
	}
	...
	protected void Attack_FR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> getTargetCharacterKey(object) == 23756).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(1288820204L /*ATTACK_FR*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> getTargetCharacterKey(object) == 23756).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
			changeState(state -> TargetChange_Logic(blendTime));
		});
	}
	...
	protected void Attack_BLR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23757 || getTargetCharacterKey(object) == 23758)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(2117244285L /*ATTACK_BLR*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> (getTargetCharacterKey(object) == 23757 || getTargetCharacterKey(object) == 23758)).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
			changeState(state -> TargetChange_Logic(blendTime));
		});
	}
	...
	protected void Attack_BL(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> getTargetCharacterKey(object) == 23758).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(2002561103L /*ATTACK_BL*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> getTargetCharacterKey(object) == 23758).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
			changeState(state -> TargetChange_Logic(blendTime));
		});
	}
	...
	protected void Attack_BR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> getTargetCharacterKey(object) == 23757).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
		doAction(3575252428L /*ATTACK_BR*/, blendTime, onDoActionEnd -> {
			getObjects(EAIFindTargetType.Child, object -> getTargetCharacterKey(object) == 23757).forEach(consumer -> consumer.getAi().Avoid_Off(getActor(), null));
			changeState(state -> TargetChange_Logic(blendTime));
		});
	}
	...
	protected void Destroy_Leg_FL(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23756 || getTargetCharacterKey(object) == 23757 || getTargetCharacterKey(object) == 23758)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
	...
	protected void Destroy_Leg_FR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Sibling, object -> true).forEach(consumer -> consumer.getAi().Broken_Leg(getActor(), null));
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23755 || getTargetCharacterKey(object) == 23757 || getTargetCharacterKey(object) == 23758)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
	...
	protected void Destroy_Leg_BL(double blendTime) {
		...
		getObjects(EAIFindTargetType.Sibling, object -> true).forEach(consumer -> consumer.getAi().Broken_Leg(getActor(), null));
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23755 || getTargetCharacterKey(object) == 23756 || getTargetCharacterKey(object) == 23758)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
	...
	protected void Destroy_Leg_BR(double blendTime) {
		...
		getObjects(EAIFindTargetType.Sibling, object -> true).forEach(consumer -> consumer.getAi().Broken_Leg(getActor(), null));
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 23755 || getTargetCharacterKey(object) == 23756 || getTargetCharacterKey(object) == 23757)).forEach(consumer -> consumer.getAi().Avoid_On(getActor(), null));
