...
@IAIName("w9000_1_2_minion")
public class Ai_w9000_1_2_minion extends CreatureAI {
	public Ai_w9000_1_2_minion(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Line5(double blendTime) {
		...
		doAction(3326922924L /*MOVE_CHASER*/, blendTime, onDoActionEnd -> moveToWaypoint("battlefield", "w10000_team1_route2_8", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait(blendTime), 1000)));
	}
