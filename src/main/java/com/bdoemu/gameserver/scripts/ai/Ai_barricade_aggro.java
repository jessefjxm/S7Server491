...
@IAIName("barricade_aggro")
public class Ai_barricade_aggro extends CreatureAI {
	public Ai_barricade_aggro(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Home_Die(double blendTime) {
		...
		doAction(2083706740L /*HOME_DIE*/, blendTime, onDoActionEnd -> scheduleState(state -> Home_Die(blendTime), 1000));
	}
