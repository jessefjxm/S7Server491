...
@IAIName("npc_babycat_m")
public class Ai_npc_babycat_m extends CreatureAI {
	public Ai_npc_babycat_m(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(3910697700L /*START_ACTION*/, blendTime, onDoActionEnd -> changeState(state -> Stop(blendTime)));
	}
