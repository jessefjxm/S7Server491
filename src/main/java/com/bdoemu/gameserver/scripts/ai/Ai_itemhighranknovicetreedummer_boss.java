...
@IAIName("itemhighranknovicetreedummer_boss")
public class Ai_itemhighranknovicetreedummer_boss extends CreatureAI {
	public Ai_itemhighranknovicetreedummer_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xC6A18D4DL /*_IsSummon*/) == 1 && getVariable(0x99703876L /*_SummonCount*/) >= 50 && getPartyMembersCount()< 1 && getVariable(0x3F487035L /*_HP*/) > 60) {
			if(Rnd.getChance(20)) {
	...
	protected void Special_Damage_Stun_End(double blendTime) {
		...
		doAction(3912128442L /*DAMAGE_STUN_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Creature(blendTime), 1000));
	}
