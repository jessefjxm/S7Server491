...
@IAIName("summerevent_scarecrow")
public class Ai_summerevent_scarecrow extends CreatureAI {
	public Ai_summerevent_scarecrow(Creature actor, Map<Long, Integer> aiVariables) {
