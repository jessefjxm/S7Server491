...
@IAIName("medlizardman_boss")
public class Ai_medlizardman_boss extends CreatureAI {
	public Ai_medlizardman_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Charge1(double blendTime) {
		...
		setVariable(0xC766911CL /*_isAirFloatCount*/, getVariable(0xC766911CL /*_isAirFloatCount*/) - 1);
		doAction(643630764L /*BATTLE_CHARGE_ATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Charge2(double blendTime) {
		...
		setVariable(0xC766911CL /*_isAirFloatCount*/, getVariable(0xC766911CL /*_isAirFloatCount*/) - 1);
		doAction(1144170621L /*BATTLE_CHARGE_ATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Chase(double blendTime) {
		...
		setVariable(0xC766911CL /*_isAirFloatCount*/, getVariable(0xC766911CL /*_isAirFloatCount*/) - 1);
		doAction(1605041147L /*BATTLE_CHASE_ATTACK*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Jump(double blendTime) {
		...
		setVariable(0xC766911CL /*_isAirFloatCount*/, getVariable(0xC766911CL /*_isAirFloatCount*/) - 1);
		doAction(2197303760L /*BATTLE_JUMP_ATTACK*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Combo(double blendTime) {
		...
		setVariable(0xC766911CL /*_isAirFloatCount*/, getVariable(0xC766911CL /*_isAirFloatCount*/) - 1);
		doAction(1703514227L /*BATTLE_ATTACK_COM*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_AirFloat_A(double blendTime) {
		...
		doAction(2998079582L /*BATTLE_ATTACK_AIRSMASH_A*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_AirFloat_B(double blendTime) {
		...
		doAction(4194802761L /*BATTLE_ATTACK_AIRSMASH_B*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
