...
@IAIName("instance_explosionbomb_sub")
public class Ai_instance_explosionbomb_sub extends CreatureAI {
	public Ai_instance_explosionbomb_sub(Creature actor, Map<Long, Integer> aiVariables) {
