...
@IAIName("instance_guard_sword")
public class Ai_instance_guard_sword extends CreatureAI {
	public Ai_instance_guard_sword(Creature actor, Map<Long, Integer> aiVariables) {
