...
@IAIName("summon_hunnishframetowerbuilding")
public class Ai_summon_hunnishframetowerbuilding extends CreatureAI {
	public Ai_summon_hunnishframetowerbuilding(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Working_Str(double blendTime) {
		...
		useSkill(41096, 1, false, EAIFindTargetType.Self, object -> true);
	...
	protected void Die(double blendTime) {
		...
		getObjects(EAIFindTargetType.Character, object -> getDistanceToTarget(object) < 100 && getTargetCharacterKey(object) == 31007).forEach(consumer -> consumer.getAi()._DestroyedBase(getActor(), null));
