...
@IAIName("noviceredgoblin_boss")
public class Ai_noviceredgoblin_boss extends CreatureAI {
	public Ai_noviceredgoblin_boss(Creature actor, Map<Long, Integer> aiVariables) {
