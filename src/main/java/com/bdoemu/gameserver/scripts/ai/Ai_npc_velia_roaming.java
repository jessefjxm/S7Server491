...
@IAIName("npc_velia_roaming")
public class Ai_npc_velia_roaming extends CreatureAI {
	public Ai_npc_velia_roaming(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Select_Position(double blendTime) {
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 16 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 17) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 15628 });
		}
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 16 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 17) {
			setVariable(0xE60F92ADL /*_MinMove*/, 0);
		}
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 17 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 18) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 15614 });
		}
