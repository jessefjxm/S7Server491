...
@IAIName("novicebronzegiant2__boss")
public class Ai_novicebronzegiant2__boss extends CreatureAI {
	public Ai_novicebronzegiant2__boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(463565147L /*START_ACTION2*/, blendTime, onDoActionEnd -> scheduleState(state -> Start_Action(blendTime), 3000));
	}
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0x5BAFAC82L /*_UnSummon_EndTime*/) >= 60000) {
		...
		doAction(3401480022L /*WAIT2*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 500 + Rnd.get(-500,500)));
	}
	...
	protected void Wait_Die(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xB4EB8358L /*Wait_Die*/);
		setVariable(0x64931736L /*_Summon_IngTime*/, getTime());
		setVariable(0x20784437L /*_Summon_EndTime*/, getVariable(0x64931736L /*_Summon_IngTime*/) - getVariable(0x96CB9F57L /*_Summon_StartTime*/));
		setVariable(0x5BAFAC82L /*_UnSummon_EndTime*/, getVariable(0x64931736L /*_Summon_IngTime*/) - getVariable(0x5B77CE65L /*_UnSummon_StartTime*/));
		if (getVariable(0x20784437L /*_Summon_EndTime*/) >= 120000) {
		...
		doAction(3291608859L /*WAIT_DIE*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Die(blendTime), 500 + Rnd.get(-500,500)));
	}
	...
	protected void Detect_Target(double blendTime) {
		...
		doAction(2531458766L /*SEARCH_ENEMY_Idx16*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait(blendTime), 2000));
	}
	...
	protected void Move_Return_End(double blendTime) {
		...
		setVariable(0xFA9DA674L /*_isBattleMode*/, 0);
		setVariable(0xFDC61BCCL /*_FailFindPathCount*/, 0);
		doAction(633942026L /*MOVE_WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 0, 0, false, ENaviType.ground, () -> {
			setVariable(0x96CB9F57L /*_Summon_StartTime*/, getTime());
			return false;
		}, onExit -> scheduleState(state -> Wait_Die(blendTime), 1000)));
	}
	...
	protected void Battle_Wait(double blendTime) {
		...
		setVariable(0x5BAFAC82L /*_UnSummon_EndTime*/, getVariable(0x64931736L /*_Summon_IngTime*/) - getVariable(0x5B77CE65L /*_UnSummon_StartTime*/));
		if (getVariable(0x5BAFAC82L /*_UnSummon_EndTime*/) >= 60000) {
			if (changeState(state -> Move_Return_End(0.3)))
				return;
		}
