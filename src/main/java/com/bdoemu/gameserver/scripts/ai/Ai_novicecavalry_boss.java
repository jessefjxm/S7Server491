...
@IAIName("novicecavalry_boss")
public class Ai_novicecavalry_boss extends CreatureAI {
	public Ai_novicecavalry_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (target != null && getDistanceToTarget(target) < 200 && target != null && getAngleToTarget(target) >= 45 && target != null && getAngleToTarget(target) <= 145 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Turn(0.3)))
				return;
		}
		if (target != null && getDistanceToTarget(target) < 200 && target != null && getAngleToTarget(target) >= -145 && target != null && getAngleToTarget(target) <= -45 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Turn(0.3)))
				return;
		}
		if (target != null && getDistanceToTarget(target) < 200 && target != null && getAngleToTarget(target) >= 145 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Back(0.3)))
				return;
		}
		if (target != null && getDistanceToTarget(target) < 100 && target != null && getAngleToTarget(target) <= -145 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Back(0.3)))
				return;
		}
		if (target != null && getDistanceToTarget(target) < 200 && target != null && getAngleToTarget(target) <= 45 && target != null && getAngleToTarget(target) >= -45 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(Rnd.getChance(30)) {
	...
	protected void Attack_Turn(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xBCCE4207L /*Attack_Turn*/);
		doAction(801764828L /*ATTACK_TURN*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Charge2(double blendTime) {
		...
		doAction(1363113815L /*BATTLE_CHARGEATTACK2_A*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
