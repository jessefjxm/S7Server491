...
@IAIName("qa_test_giantjelly_boss")
public class Ai_qa_test_giantjelly_boss extends CreatureAI {
	public Ai_qa_test_giantjelly_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Notifier_Logic(double blendTime) {
		...
		worldNotify(EChatNoticeType.Normal, "GAME", "LUA_CZAKA_SQAWN");
	...
	protected void Delete_Die_Logic(double blendTime) {
		...
		worldNotify(EChatNoticeType.Normal, "GAME", "LUA_CZAKA_TIMEOUT");
