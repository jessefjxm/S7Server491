...
@IAIName("m0079_camstonesoldier")
public class Ai_m0079_camstonesoldier extends CreatureAI {
	public Ai_m0079_camstonesoldier(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (target != null && getDistanceToTarget(target) < 1500 && target != null && getDistanceToTarget(target) >= 800) {
			if(Rnd.getChance(10)) {
