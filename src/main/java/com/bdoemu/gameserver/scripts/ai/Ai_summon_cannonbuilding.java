...
@IAIName("summon_cannonbuilding")
public class Ai_summon_cannonbuilding extends CreatureAI {
	public Ai_summon_cannonbuilding(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Working_Str(double blendTime) {
		...
		doAction(3058152320L /*WORKING_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Working_Str(blendTime), 3000));
	}
