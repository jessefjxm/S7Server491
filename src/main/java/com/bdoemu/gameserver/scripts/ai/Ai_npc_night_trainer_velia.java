...
@IAIName("npc_night_trainer_velia")
public class Ai_npc_night_trainer_velia extends CreatureAI {
	public Ai_npc_night_trainer_velia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_5(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Roaming_6(blendTime), 100000));
	}
	...
	protected void Wait_6(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Roaming_7(blendTime), 100000));
	}
	...
	protected void Wait_7(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Roaming_8(blendTime), 100000));
	}
	...
	protected void Wait_Idle5(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_5(blendTime), 100000));
	}
	...
	protected void Wait_Idle6(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_6(blendTime), 100000));
	}
	...
	protected void Wait_Idle7(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_7(blendTime), 100000));
	}
	...
	protected void Move_Roaming_1(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Roaming_004", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_2(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Stop1", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_3(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Roaming_013", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_4(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Stop2", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_5(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Roaming_020", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_6(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Stop3", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_7(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Roaming_024", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Roaming_8(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Move_Velia_Arrive_Position", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Wait_Idle8(blendTime), 10000)));
	}
	...
	protected void GoToHome(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Start", ENaviType.ground, () -> {
			return false;
	...
	protected void GoBack(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "Night_Trainer_Velia_Move_Velia_Arrive_Position", ENaviType.ground, () -> {
			return false;
