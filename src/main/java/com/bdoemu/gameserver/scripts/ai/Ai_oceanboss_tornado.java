...
@IAIName("oceanboss_tornado")
public class Ai_oceanboss_tornado extends CreatureAI {
	public Ai_oceanboss_tornado(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait2(double blendTime) {
		...
		doAction(3401480022L /*WAIT2*/, blendTime, onDoActionEnd -> changeState(state -> Start_Wait(blendTime)));
	}
	...
	@Override
	public EAiHandlerResult ByeWall(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
