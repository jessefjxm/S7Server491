...
@IAIName("m0130_camredgoblinlong")
public class Ai_m0130_camredgoblinlong extends CreatureAI {
	public Ai_m0130_camredgoblinlong(Creature actor, Map<Long, Integer> aiVariables) {
