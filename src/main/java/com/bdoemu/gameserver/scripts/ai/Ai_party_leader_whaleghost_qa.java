...
@IAIName("party_leader_whaleghost_qa")
public class Ai_party_leader_whaleghost_qa extends CreatureAI {
	public Ai_party_leader_whaleghost_qa(Creature actor, Map<Long, Integer> aiVariables) {
