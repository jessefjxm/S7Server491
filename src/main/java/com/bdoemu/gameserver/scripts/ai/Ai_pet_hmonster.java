...
@IAIName("pet_hmonster")
public class Ai_pet_hmonster extends CreatureAI {
	public Ai_pet_hmonster(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		if (getVariable(0xF4E090DL /*_Skill0_DetectDistance*/) == -1) {
			setVariable(0xF4E090DL /*_Skill0_DetectDistance*/, 1350);
		}
