...
@IAIName("event_escape_normal")
public class Ai_event_escape_normal extends CreatureAI {
	public Ai_event_escape_normal(Creature actor, Map<Long, Integer> aiVariables) {
