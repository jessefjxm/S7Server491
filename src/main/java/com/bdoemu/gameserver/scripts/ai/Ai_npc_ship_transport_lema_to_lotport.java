...
@IAIName("npc_ship_transport_lema_to_lotport")
public class Ai_npc_ship_transport_lema_to_lotport extends CreatureAI {
	public Ai_npc_ship_transport_lema_to_lotport(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void FirstGo(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveToWaypoint("carriage", "LotWay_0001 LotWay_0153", ENaviType.ground, () -> {
			return false;
	...
	protected void Go_Start(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Go(blendTime), 200000));
	}
	...
	protected void End(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Go_Start(blendTime), 200000));
	}
