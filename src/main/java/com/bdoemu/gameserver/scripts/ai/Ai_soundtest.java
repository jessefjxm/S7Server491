...
@IAIName("soundtest")
public class Ai_soundtest extends CreatureAI {
	public Ai_soundtest(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0xE4FBB1E7L /*_FindTarget*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 300 && getTargetHp(object) > 0)) {
