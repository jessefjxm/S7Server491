...
@IAIName("highrankitemnovicelizardman_boss")
public class Ai_highrankitemnovicelizardman_boss extends CreatureAI {
	public Ai_highrankitemnovicelizardman_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, 0);
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xEF7AE808L /*_RoarCount*/) == 1 && target != null && getDistanceToTarget(target) < 1300) {
			if(Rnd.getChance(10)) {
				if (changeState(state -> Attack_Jump(0.4)))
					return;
			}
		}
		if (getVariable(0xEF7AE808L /*_RoarCount*/) == 1 && getVariable(0x97043801L /*_RoarAttackCount*/) >= 10 && target != null && getDistanceToTarget(target) < 1300) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Jump(0.4)))
					return;
			}
		...
		if (target != null && getDistanceToTarget(target) < 400) {
			if(Rnd.getChance(20)) {
				if (changeState(state -> Attack_Jump2(0.4)))
					return;
			}
		}
		if (getVariable(0xEF7AE808L /*_RoarCount*/) == 0 && target != null && getDistanceToTarget(target) < 1300) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Jump(0.4)))
					return;
			}
		}
		if (getVariable(0xEF7AE808L /*_RoarCount*/) == 0 && getVariable(0x97043801L /*_RoarAttackCount*/) >= 10 && target != null && getDistanceToTarget(target) < 1300) {
			if(Rnd.getChance(60)) {
				if (changeState(state -> Attack_Jump(0.4)))
					return;
			}
		}
		if (target != null && getAngleToTarget(target) <= -45 && target != null && getDistanceToTarget(target) < 350) {
	...
	protected void Turn_Logic(double blendTime) {
		...
		if (target != null && getDistanceToTarget(target) > 500) {
			if(Rnd.getChance(10)) {
				if (changeState(state -> Attack_Rush(0.4)))
					return;
			}
		}
	...
	protected void Attack_Normal(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
	...
	protected void Attack_Stamp(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
		doAction(1219749755L /*ATTACK_STAMP*/, blendTime, onDoActionEnd -> changeState(state -> Attack_End_Logic(blendTime)));
	}
	...
	protected void Attack_Rush_End(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, 0);
		doAction(244554561L /*ATTACK_RUSH_END*/, blendTime, onDoActionEnd -> changeState(state -> Attack_End_Logic(blendTime)));
	}
	...
	protected void Attack_Turn_Left(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
		doAction(3567810684L /*ATTACK_TURN_LEFT*/, blendTime, onDoActionEnd -> changeState(state -> Turn_Logic(blendTime)));
	}
	...
	protected void Attack_Turn_Right(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
		doAction(1597155294L /*ATTACK_TURN_RIGHT*/, blendTime, onDoActionEnd -> changeState(state -> Turn_Logic(blendTime)));
	}
