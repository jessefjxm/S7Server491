...
@IAIName("opin_leg_1")
public class Ai_opin_leg_1 extends CreatureAI {
	public Ai_opin_leg_1(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Before_Die(double blendTime) {
		...
		getObjects(EAIFindTargetType.Parent, object -> true).forEach(consumer -> consumer.getAi().DestroyLeg1(getActor(), null));
