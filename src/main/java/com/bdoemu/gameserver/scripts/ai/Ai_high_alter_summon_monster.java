...
@IAIName("high_alter_summon_monster")
public class Ai_high_alter_summon_monster extends CreatureAI {
	public Ai_high_alter_summon_monster(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Summon_Wave4_C4(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_4STAGE_SUMMON_SKELETON");
