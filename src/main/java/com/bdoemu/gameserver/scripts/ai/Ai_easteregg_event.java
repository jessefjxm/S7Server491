...
@IAIName("easteregg_event")
public class Ai_easteregg_event extends CreatureAI {
	public Ai_easteregg_event(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 3333));
	}
	...
	protected void Chest_open(double blendTime) {
		...
		doAction(639015291L /*OPEN_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Suicide_Die(blendTime), 1000));
	}
