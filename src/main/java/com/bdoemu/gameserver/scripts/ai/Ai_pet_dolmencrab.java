...
@IAIName("pet_dolmencrab")
public class Ai_pet_dolmencrab extends CreatureAI {
	public Ai_pet_dolmencrab(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_Summon(double blendTime) {
		...
		if (getVariable(0xBA414EEEL /*_isChaseMode*/) == 1 && getVariable(0xCBEEF8C7L /*_ownerDistance*/) > 500) {
