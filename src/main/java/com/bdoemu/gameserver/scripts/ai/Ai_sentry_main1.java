...
@IAIName("sentry_main1")
public class Ai_sentry_main1 extends CreatureAI {
	public Ai_sentry_main1(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0xAE01F3A9L /*AI_DetectCreepDistanceMin1*/) && getDistanceToTarget(object, false) <= getVariable(0x11BF935FL /*AI_DetectCreepDistanceMax1*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait1(0.3)))
					return;
			}
		}
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0xEB0EFF8EL /*AI_DetectCreepDistanceMin2*/) && getDistanceToTarget(object, false) <= getVariable(0x26C4481L /*AI_DetectCreepDistanceMax2*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait2(0.3)))
					return;
			}
		}
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0xCC5D1A30L /*AI_DetectCrouchDistanceMin1*/) && getDistanceToTarget(object, false) <= getVariable(0xD7444662L /*AI_DetectCrouchDistanceMax1*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait1(0.3)))
					return;
			}
		}
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0x69B75CB2L /*AI_DetectCrouchDistanceMin2*/) && getDistanceToTarget(object, false) <= getVariable(0xBADA6BCBL /*AI_DetectCrouchDistanceMax2*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait2(0.3)))
					return;
			}
		}
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0x7CD62D49L /*AI_DetectDistanceMin1*/) && getDistanceToTarget(object, false) <= getVariable(0x542FAB19L /*AI_DetectDistanceMax1*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait1(0.3)))
					return;
			}
		}
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0xA91DEBAL /*AI_DetectDistanceMin2*/) && getDistanceToTarget(object, false) <= getVariable(0x5D7565CAL /*AI_DetectDistanceMax2*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait2(0.3)))
					return;
			}
		}
		if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x81B98652L /*AI_DetectAngleMin1*/) && getAngleToTarget(object) <= getVariable(0x6A06081FL /*AI_DetectAngleMax1*/) && isCreatureVisible(object, false) && getDistanceToTarget(object) < getVariable(0x5103FB80L /*AI_EC_Distance*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
	...
	protected void Wait1(double blendTime) {
		...
		if ((getTargetBattleAimedActionType("Crouch")) && (getTargetBattleAimedActionType("Creep"))) {
			if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x6745CC38L /*AI_DetectAngleMin2*/) && getAngleToTarget(object) <= getVariable(0x80C40CD3L /*AI_DetectAngleMax2*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= getVariable(0xEB0EFF8EL /*AI_DetectCreepDistanceMin2*/) && getDistanceToTarget(object, false) <= getVariable(0x26C4481L /*AI_DetectCreepDistanceMax2*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
				if (changeState(state -> Wait2(0.3)))
					return;
			}
		}
		...
		if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getDistanceToTarget(object) > getVariable(0x542FAB19L /*AI_DetectDistanceMax1*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
	...
	protected void Wait2(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getAngleToTarget(object) >= getVariable(0x6745CC38L /*AI_DetectAngleMin2*/) && getAngleToTarget(object) <= getVariable(0x80C40CD3L /*AI_DetectAngleMax2*/) && isCreatureVisible(object, false) && getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x5103FB80L /*AI_EC_Distance*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
			if (changeState(state -> Move_Chaser(0.3)))
				return;
		}
		if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getDistanceToTarget(object) > getVariable(0x542FAB19L /*AI_DetectDistanceMax1*/) && getTargetHp(object) > 0 && isTargetProcessQuest(object, getVariable(0x20D4055CL /*AI_QuestGroupNo*/), getVariable(0x5948BE32L /*AI_QuestNo*/)))) {
	...
	protected void Search_Enemy_Start(double blendTime) {
		...
		doAction(2658402471L /*DETECT_ENEMY*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Chaser(blendTime), 1000));
	}
