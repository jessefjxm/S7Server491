...
@IAIName("rock")
public class Ai_rock extends CreatureAI {
	public Ai_rock(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Explosion(double blendTime) {
		...
		doAction(3912108767L /*EXPLOSION*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon1(blendTime), 3000));
	}
