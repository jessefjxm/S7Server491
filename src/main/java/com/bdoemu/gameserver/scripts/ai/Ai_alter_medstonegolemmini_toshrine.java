...
@IAIName("alter_medstonegolemmini_toshrine")
public class Ai_alter_medstonegolemmini_toshrine extends CreatureAI {
	public Ai_alter_medstonegolemmini_toshrine(Creature actor, Map<Long, Integer> aiVariables) {
