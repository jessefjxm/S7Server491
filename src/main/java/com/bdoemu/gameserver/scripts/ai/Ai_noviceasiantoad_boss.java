...
@IAIName("noviceasiantoad_boss")
public class Ai_noviceasiantoad_boss extends CreatureAI {
	public Ai_noviceasiantoad_boss(Creature actor, Map<Long, Integer> aiVariables) {
