...
@IAIName("treedummer_nornal_f_new")
public class Ai_treedummer_nornal_f_new extends CreatureAI {
	public Ai_treedummer_nornal_f_new(Creature actor, Map<Long, Integer> aiVariables) {
