...
@IAIName("party_leader_ru_impboss")
public class Ai_party_leader_ru_impboss extends CreatureAI {
	public Ai_party_leader_ru_impboss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_SummonPoint1(double blendTime) {
		...
		doTeleportToWaypoint("ru_imp_boss_001", "monster_patrol", 0, 0, 1, 1);
