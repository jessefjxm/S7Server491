...
@IAIName("witch_boss")
public class Ai_witch_boss extends CreatureAI {
	public Ai_witch_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Skill1(double blendTime) {
		...
		doAction(931985982L /*BATTLE_ATTACK3*/, blendTime, onDoActionEnd -> changeState(state -> Logic(blendTime)));
	}
