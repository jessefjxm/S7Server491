...
@IAIName("wildhorse_child")
public class Ai_wildhorse_child extends CreatureAI {
	public Ai_wildhorse_child(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Party_MoveToParent(double blendTime) {
		...
		doAction(2689517725L /*BATTLE_RUN*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerPath, 0, 0, 0, 350, 550, false, ENaviType.ground, () -> {
			return false;
