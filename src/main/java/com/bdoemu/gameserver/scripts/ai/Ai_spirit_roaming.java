...
@IAIName("spirit_roaming")
public class Ai_spirit_roaming extends CreatureAI {
	public Ai_spirit_roaming(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		if (getVariable(0x925166FDL /*_FirstAttack*/) == 0) {
	...
	protected void Search_Wait(double blendTime) {
		...
		if ((((getTargetProtectedRegion()&&getTargetIsCrouchAction())||(getTargetProtectedRegion()&&getTargetActionType("Collect"))))) {
	...
	public EAiHandlerResult HandleTargetInMyArea(Creature sender, Integer[] eventData) {
		...
		if ((getState() == 0x58D0B0D8L /*Search_Wait*/ || getState() == 0x67695F37L /*Lost_Target*/) && (((getTargetProtectedRegion()&&getTargetIsCrouchAction())||(getTargetProtectedRegion()&&getTargetActionType("Collect")))) && target != null && getTargetHp(target) > 0) {
