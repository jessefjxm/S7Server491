...
@IAIName("npc_chest_pearlday")
public class Ai_npc_chest_pearlday extends CreatureAI {
	public Ai_npc_chest_pearlday(Creature actor, Map<Long, Integer> aiVariables) {
