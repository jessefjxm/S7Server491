...
@IAIName("holywall")
public class Ai_holywall extends CreatureAI {
	public Ai_holywall(Creature actor, Map<Long, Integer> aiVariables) {
	...
	@Override
	public EAiHandlerResult HandleSacredBarrier(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		getActor().getAggroList().addCreature(sender.getAggroList().getTarget());
		if (changeState(state -> Teleport_Logic(0.1)))
