...
@IAIName("alter_itemhighranknovicewitch_boss")
public class Ai_alter_itemhighranknovicewitch_boss extends CreatureAI {
	public Ai_alter_itemhighranknovicewitch_boss(Creature actor, Map<Long, Integer> aiVariables) {
