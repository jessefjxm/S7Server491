...
@IAIName("itemhighranknovicewitch_boss")
public class Ai_itemhighranknovicewitch_boss extends CreatureAI {
	public Ai_itemhighranknovicewitch_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Roar(double blendTime) {
		...
		doAction(741286185L /*SKILL_LETS_CRAZY*/, blendTime, onDoActionEnd -> changeState(state -> Logic(blendTime)));
	}
