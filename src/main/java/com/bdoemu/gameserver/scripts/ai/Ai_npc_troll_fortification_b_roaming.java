...
@IAIName("npc_troll_fortification_b_roaming")
public class Ai_npc_troll_fortification_b_roaming extends CreatureAI {
	public Ai_npc_troll_fortification_b_roaming(Creature actor, Map<Long, Integer> aiVariables) {
