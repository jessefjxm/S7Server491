...
@IAIName("w9000_0_0_minion")
public class Ai_w9000_0_0_minion extends CreatureAI {
	public Ai_w9000_0_0_minion(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Line0(double blendTime) {
		...
		doAction(3326922924L /*MOVE_CHASER*/, blendTime, onDoActionEnd -> moveToWaypoint("battlefield", "w10000_team0_route0_8", ENaviType.ground, () -> {
			return false;
	...
	protected void Move_Line2(double blendTime) {
		...
		doAction(633942026L /*MOVE_WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("battlefield", "w10000_team0_route2_7", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait(blendTime), 1000)));
	}
