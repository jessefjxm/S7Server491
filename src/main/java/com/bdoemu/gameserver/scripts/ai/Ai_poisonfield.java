...
@IAIName("poisonfield")
public class Ai_poisonfield extends CreatureAI {
	public Ai_poisonfield(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Temp_Wait(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> UnSummon(blendTime), 1000));
	}
