...
@IAIName("w231collapsingcave")
public class Ai_w231collapsingcave extends CreatureAI {
	public Ai_w231collapsingcave(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Down(double blendTime) {
		...
		doAction(2649688712L /*DOWN*/, blendTime, onDoActionEnd -> scheduleState(state -> Down(blendTime), 1000));
	}
