...
@IAIName("buffalo_party_parent")
public class Ai_buffalo_party_parent extends CreatureAI {
	public Ai_buffalo_party_parent(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Party_MovePoint(double blendTime) {
		...
		doAction(2689517725L /*BATTLE_RUN*/, blendTime, onDoActionEnd -> moveToWaypoint("monster_patrol", "cow_17 cow_35", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Party_Wait(blendTime), 1000)));
	}
