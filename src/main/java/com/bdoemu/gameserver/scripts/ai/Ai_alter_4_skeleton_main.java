...
@IAIName("alter_4_skeleton_main")
public class Ai_alter_4_skeleton_main extends CreatureAI {
	public Ai_alter_4_skeleton_main(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0x47FF1632L /*AI_IsSize*/, 0);
	...
	protected void Rotate_Logic(double blendTime) {
		...
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 5000 && (getTargetCharacterKey(object) == 27134 || getTargetCharacterKey(object) == 27135 || getTargetCharacterKey(object) == 27136 || getTargetCharacterKey(object) == 27137 || getTargetCharacterKey(object) == 27138))) {
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getVariable(0x29313B91L /*_IsSize*/) == 1 && getState() == 0x25115234L /*Battle_Wait_Target_Logic*/) {
			if (changeState(state -> Target_Change(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
