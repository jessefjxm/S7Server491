...
@IAIName("npc_ship_transport_altinova_to_ankadu")
public class Ai_npc_ship_transport_altinova_to_ankadu extends CreatureAI {
	public Ai_npc_ship_transport_altinova_to_ankadu(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void FirstGo(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveToWaypoint("carriage", "TranportShipAltinovatoAncadu_0003 TranportShipAltinovatoAncadu_0095", ENaviType.ground, () -> {
			return false;
