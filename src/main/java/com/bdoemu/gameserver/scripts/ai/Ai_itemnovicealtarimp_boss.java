...
@IAIName("itemnovicealtarimp_boss")
public class Ai_itemnovicealtarimp_boss extends CreatureAI {
	public Ai_itemnovicealtarimp_boss(Creature actor, Map<Long, Integer> aiVariables) {
