...
@IAIName("npc_blackratmerchant_hidel")
public class Ai_npc_blackratmerchant_hidel extends CreatureAI {
	public Ai_npc_blackratmerchant_hidel(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void GoToHomePosition(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_41116_14", ENaviType.ground, () -> {
	...
	protected void GoBackPosition(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_41116_01", ENaviType.ground, () -> {
