...
@IAIName("muscan")
public class Ai_muscan extends CreatureAI {
	public Ai_muscan(Creature actor, Map<Long, Integer> aiVariables) {
	...
	public EAiHandlerResult HandleKnockDown(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (target != null && checkBuff(target, 35) && getState() != 0x866C7489L /*Wait*/ && getState() != 0xEF3EFF55L /*Special_Damage_Stun*/ && getState() != 0xB97BF3E2L /*Special_Damage_Stun_Ing*/ && getState() != 0xC21C1C3DL /*Special_Damage_Stun_End*/) {
