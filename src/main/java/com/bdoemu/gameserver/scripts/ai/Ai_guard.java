...
@IAIName("guard")
public class Ai_guard extends CreatureAI {
	public Ai_guard(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		setVariable(0xFA9DA674L /*_IsBattleMode*/, 0);
		if (findTarget(EAIFindTargetType.Player, EAIFindType.normal, false, object -> getDistanceToTarget(object) < 1200 && getTargetHp(object) > 0 && getTendency(object) < -500 && isCreatureVisible(object, false))) {
