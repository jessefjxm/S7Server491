...
@IAIName("npc_raccoondog_summon")
public class Ai_npc_raccoondog_summon extends CreatureAI {
	public Ai_npc_raccoondog_summon(Creature actor, Map<Long, Integer> aiVariables) {
