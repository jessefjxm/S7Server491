...
@IAIName("treasurechest")
public class Ai_treasurechest extends CreatureAI {
	public Ai_treasurechest(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Chest_open(double blendTime) {
		...
		doAction(1426790432L /*END_DIE*/, blendTime, onDoActionEnd -> scheduleState(state -> Suicide_Die(blendTime), 1000));
	}
