...
@IAIName("npc_blackratmerchant_velia")
public class Ai_npc_blackratmerchant_velia extends CreatureAI {
	public Ai_npc_blackratmerchant_velia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void GoToHomePosition(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_40141_7", ENaviType.ground, () -> {
	...
	protected void GoBackPosition(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_40141_1", ENaviType.ground, () -> {
