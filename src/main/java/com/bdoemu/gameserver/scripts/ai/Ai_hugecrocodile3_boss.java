...
@IAIName("hugecrocodile3_boss")
public class Ai_hugecrocodile3_boss extends CreatureAI {
	public Ai_hugecrocodile3_boss(Creature actor, Map<Long, Integer> aiVariables) {
