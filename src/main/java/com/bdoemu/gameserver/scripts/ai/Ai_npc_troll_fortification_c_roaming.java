...
@IAIName("npc_troll_fortification_c_roaming")
public class Ai_npc_troll_fortification_c_roaming extends CreatureAI {
	public Ai_npc_troll_fortification_c_roaming(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Select_Corpse_Position(blendTime), 10000));
	}
	...
	protected void Move_Position(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.WaypointVariable, getVariableArray(0xACD660AFL /*WaypointValue*/), ENaviType.ground, () -> {
			...
			return false;
		}, onExit -> scheduleState(state -> Wait_for_Find(blendTime), 5000)));
	}

	protected void Wait_for_Find(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x45413D51L /*Wait_for_Find*/);
		doAction(120327582L /*TALK1*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 20000));
	}
