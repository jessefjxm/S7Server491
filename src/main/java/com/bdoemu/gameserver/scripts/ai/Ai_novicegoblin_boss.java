...
@IAIName("novicegoblin_boss")
public class Ai_novicegoblin_boss extends CreatureAI {
	public Ai_novicegoblin_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xEF7AE808L /*_RoarCount*/) >= 1 && getVariable(0x3F487035L /*_HP*/) < 55) {
		...
		if (getVariable(0x3F487035L /*_HP*/) < 55 && getVariable(0xBD142893L /*_Attack_Bomb_Count*/) <= 0 && target != null && (getDistanceToTarget(target, false) >= 300 && getDistanceToTarget(target, false) <= 800)) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> AttackSkill_Bomb(0.3)))
					return;
			}
		}
		if (getVariable(0x3F487035L /*_HP*/) < 55 && getVariable(0xBD142893L /*_Attack_Bomb_Count*/) <= 0 && target != null && (getDistanceToTarget(target, false) >= 800 && getDistanceToTarget(target, false) <= 1600)) {
			if(Rnd.getChance(30)) {
		...
		if (getVariable(0x3F487035L /*_HP*/) < 55 && target != null && getDistanceToTarget(target) > 600 && getVariable(0x7E57A115L /*_Attack_Summon_Count*/) <= 0 && getPartyMembersCount()< 1) {
			if(Rnd.getChance(35)) {
				if (changeState(state -> Attack_Summon(0.3)))
					return;
			}
		}
		if (target != null && (getDistanceToTarget(target, false) >= 200 && getDistanceToTarget(target, false) <= 1000) && target != null && getAngleToTarget(target) > -15 && target != null && getAngleToTarget(target) < 15 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(Rnd.getChance(30)) {
	...
	protected void Attack_Summon(double blendTime) {
		...
		setVariable(0x7E57A115L /*_Attack_Summon_Count*/, 3);
		setVariable(0xBD142893L /*_Attack_Bomb_Count*/, getVariable(0xBD142893L /*_Attack_Bomb_Count*/) - 1);
	...
	protected void Attack_Summon_Roar_Logic(double blendTime) {
		...
		scheduleState(state -> Battle_Wait_Roar(blendTime), 500);
	}
