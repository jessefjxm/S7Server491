...
@IAIName("ancientmanshaum_boss")
public class Ai_ancientmanshaum_boss extends CreatureAI {
	public Ai_ancientmanshaum_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		setVariable(0xC1B232F1L /*_Flood_Count*/, 2);
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x3F487035L /*_HP*/) < 75 && getVariable(0x6315C082L /*_CannonBullet*/) == 2 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Cannon_Logic(blendTime)))
				return;
		}
		if (getVariable(0x3F487035L /*_HP*/) < 25 && getVariable(0x6315C082L /*_CannonBullet*/) == 1 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Cannon_Logic(blendTime)))
				return;
		}
		if (getVariable(0x3F487035L /*_HP*/) <= 50 && getVariable(0xC1B232F1L /*_Flood_Count*/) == 2) {
	...
	protected void Attack_Flood1(double blendTime) {
		...
		setVariable(0xC1B232F1L /*_Flood_Count*/, getVariable(0xC1B232F1L /*_Flood_Count*/) - 2);
	...
	public EAiHandlerResult GuardBreak(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getState() == 0x8F99A186L /*Attack_Flood_ING*/) {
