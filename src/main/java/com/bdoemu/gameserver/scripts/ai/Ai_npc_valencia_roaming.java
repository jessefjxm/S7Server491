...
@IAIName("npc_valencia_roaming")
public class Ai_npc_valencia_roaming extends CreatureAI {
	public Ai_npc_valencia_roaming(Creature actor, Map<Long, Integer> aiVariables) {
