...
@IAIName("npc_blackratmerchant_valencia")
public class Ai_npc_blackratmerchant_valencia extends CreatureAI {
	public Ai_npc_blackratmerchant_valencia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void GoToHomePosition(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_45023_9", ENaviType.ground, () -> {
	...
	protected void GoBackPosition(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_45023_1", ENaviType.ground, () -> {
