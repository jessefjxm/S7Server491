...
@IAIName("itemnovicetreedummer_boss")
public class Ai_itemnovicetreedummer_boss extends CreatureAI {
	public Ai_itemnovicetreedummer_boss(Creature actor, Map<Long, Integer> aiVariables) {
