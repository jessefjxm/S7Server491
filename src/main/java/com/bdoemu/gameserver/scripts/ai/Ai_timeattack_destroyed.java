...
@IAIName("timeattack_destroyed")
public class Ai_timeattack_destroyed extends CreatureAI {
	public Ai_timeattack_destroyed(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0x20784437L /*_Summon_EndTime*/) >= 3300000) {
