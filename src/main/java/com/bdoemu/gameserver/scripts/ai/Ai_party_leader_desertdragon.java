...
@IAIName("party_leader_desertdragon")
public class Ai_party_leader_desertdragon extends CreatureAI {
	public Ai_party_leader_desertdragon(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_SummonPoint1(double blendTime) {
		...
		doTeleportToWaypoint("val_desertdragon_001", "monster_patrol", 0, 0, 1, 1);
	...
	protected void Move_SummonPoint2(double blendTime) {
		...
		doTeleportToWaypoint("val_desertdragon_002", "monster_patrol", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Wait(blendTime), 1000));
	}
	...
	protected void Move_SummonPoint3(double blendTime) {
		...
		doTeleportToWaypoint("val_desertdragon_003", "monster_patrol", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Wait(blendTime), 1000));
	}
