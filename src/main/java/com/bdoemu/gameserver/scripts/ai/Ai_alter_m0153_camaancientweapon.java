...
@IAIName("alter_m0153_camaancientweapon")
public class Ai_alter_m0153_camaancientweapon extends CreatureAI {
	public Ai_alter_m0153_camaancientweapon(Creature actor, Map<Long, Integer> aiVariables) {
