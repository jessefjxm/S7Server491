...
@IAIName("party_guardleader_ghost")
public class Ai_party_guardleader_ghost extends CreatureAI {
	public Ai_party_guardleader_ghost(Creature actor, Map<Long, Integer> aiVariables) {
