...
@IAIName("m0416_camaelephantsmall")
public class Ai_m0416_camaelephantsmall extends CreatureAI {
	public Ai_m0416_camaelephantsmall(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Search_Enemy(double blendTime) {
		...
		getObjects(EAIFindTargetType.Monster, object -> (getTargetCharacterKey(object) == 21521 || getTargetCharacterKey(object) == 21528) && getDistanceToTarget(object) < 2800).forEach(consumer -> consumer.getAi()._helpme(getActor(), null));
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (target != null && getAngleToTarget(target) <= -50) {
		...
		if (target != null && getTargetHp(target) > 0 && target != null && getDistanceToTarget(target) > 800 && target != null && getDistanceToTarget(target) < 1100 && target != null && getAngleToTarget(target) < 35 && target != null && getAngleToTarget(target) > -35) {
		...
		if (target != null && getDistanceToTarget(target) > 170 && target != null && getDistanceToTarget(target) <= 500) {
