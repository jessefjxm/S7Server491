...
@IAIName("novicetrolla_boss")
public class Ai_novicetrolla_boss extends CreatureAI {
	public Ai_novicetrolla_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Return(double blendTime) {
		...
		setVariable(0xEF7AE808L /*_RoarCount*/, 0);
		setVariable(0xBE38FAE6L /*_AttackBoardCountDown*/, 0);
		doAction(3816086168L /*RETURN_WALK*/, blendTime, onDoActionEnd -> recoveryAndReturn(() -> {
			setVariable(0x96CB9F57L /*_Summon_StartTime*/, getTime());
			setVariable(0x444DFF4EL /*_isFindPathCompleted*/, isFindPathCompleted());
			if (getVariable(0x444DFF4EL /*_isFindPathCompleted*/) == 0) {
