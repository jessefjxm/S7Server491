...
@IAIName("pet_kangaroorat_4er")
public class Ai_pet_kangaroorat_4er extends CreatureAI {
	public Ai_pet_kangaroorat_4er(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_Summon7(double blendTime) {
		...
		doAction(2434827333L /*WAIT_CHASE7_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_Ing(blendTime), 500));
	}
	...
	protected void Wait_Summon7_Ing(double blendTime) {
		...
		doAction(1549416995L /*WAIT_CHASE7_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_End(blendTime), 500));
	}
	...
	protected void Wait_Summon7_End(double blendTime) {
		...
		doAction(3012818648L /*WAIT_CHASE7_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_End_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon8(double blendTime) {
		...
		doAction(61986832L /*WAIT_CHASE8_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_Ing(blendTime), 500));
	}
	...
	protected void Wait_Summon8_Ing(double blendTime) {
		...
		doAction(3504235361L /*WAIT_CHASE8_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_End(blendTime), 500));
	}
	...
	protected void Wait_Summon8_End(double blendTime) {
		...
		doAction(798673247L /*WAIT_CHASE8_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_End_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon9_Ing(double blendTime) {
		...
		doAction(3061014360L /*WAIT_CHASE9_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon9_End(blendTime), 500));
	}
