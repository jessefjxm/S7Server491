...
@IAIName("party_leader_typhoon_thunder")
public class Ai_party_leader_typhoon_thunder extends CreatureAI {
	public Ai_party_leader_typhoon_thunder(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Typhoon_SummonPoint1(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_01", "teleport", 0, 0, 1, 1);
	...
	protected void Typhoon_SummonPoint2(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_02", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint3(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_03", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint4(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_04", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint5(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_05", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint6(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_06", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint7(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_07", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint8(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_08", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint9(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_09", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
	...
	protected void Typhoon_SummonPoint10(double blendTime) {
		...
		doTeleportToWaypoint("magoria_typhoon_10", "teleport", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
