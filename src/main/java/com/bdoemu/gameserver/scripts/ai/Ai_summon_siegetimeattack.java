...
@IAIName("summon_siegetimeattack")
public class Ai_summon_siegetimeattack extends CreatureAI {
	public Ai_summon_siegetimeattack(Creature actor, Map<Long, Integer> aiVariables) {
