...
@IAIName("alter_cyclops_boss")
public class Ai_alter_cyclops_boss extends CreatureAI {
	public Ai_alter_cyclops_boss(Creature actor, Map<Long, Integer> aiVariables) {
