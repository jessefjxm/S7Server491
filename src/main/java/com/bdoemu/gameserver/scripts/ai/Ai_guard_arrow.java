...
@IAIName("guard_arrow")
public class Ai_guard_arrow extends CreatureAI {
	public Ai_guard_arrow(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0x9B7E50C0L /*_RandomMove*/) == 1) {
			if(Rnd.getChance(30)) {
