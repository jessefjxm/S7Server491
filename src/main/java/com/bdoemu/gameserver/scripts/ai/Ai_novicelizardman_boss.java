...
@IAIName("novicelizardman_boss")
public class Ai_novicelizardman_boss extends CreatureAI {
	public Ai_novicelizardman_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Twice(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
		doAction(3022671192L /*ATTACK_TWICE*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Stamp(double blendTime) {
		...
		setVariable(0x97043801L /*_RoarAttackCount*/, getVariable(0x97043801L /*_RoarAttackCount*/) + 1);
		doAction(1219749755L /*ATTACK_STAMP*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
