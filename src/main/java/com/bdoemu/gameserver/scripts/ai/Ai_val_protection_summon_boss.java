...
@IAIName("val_protection_summon_boss")
public class Ai_val_protection_summon_boss extends CreatureAI {
	public Ai_val_protection_summon_boss(Creature actor, Map<Long, Integer> aiVariables) {
