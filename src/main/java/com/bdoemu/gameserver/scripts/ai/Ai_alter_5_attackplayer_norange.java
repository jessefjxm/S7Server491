...
@IAIName("alter_5_attackplayer_norange")
public class Ai_alter_5_attackplayer_norange extends CreatureAI {
	public Ai_alter_5_attackplayer_norange(Creature actor, Map<Long, Integer> aiVariables) {
