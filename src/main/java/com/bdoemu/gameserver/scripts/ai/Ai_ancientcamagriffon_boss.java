...
@IAIName("ancientcamagriffon_boss")
public class Ai_ancientcamagriffon_boss extends CreatureAI {
	public Ai_ancientcamagriffon_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Summon_Die(double blendTime) {
		...
		doAction(3304615689L /*SUMMON_DIE*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Die(blendTime), 1000));
	}
