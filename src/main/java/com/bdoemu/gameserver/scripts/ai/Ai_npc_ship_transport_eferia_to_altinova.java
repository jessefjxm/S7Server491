...
@IAIName("npc_ship_transport_eferia_to_altinova")
public class Ai_npc_ship_transport_eferia_to_altinova extends CreatureAI {
	public Ai_npc_ship_transport_eferia_to_altinova(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void FirstGo(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveToWaypoint("carriage", "TranportShipEferiatoAltinova_0001 TranportShipEferiatoAltinova_0031 TranportShipEferiatoAltinova_0136", ENaviType.ground, () -> {
			return false;
	...
	protected void Go_Start(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Go(blendTime), 50000));
	}
	...
	protected void End(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Go_Start(blendTime), 50000));
	}
