...
@IAIName("npc_tribute_carriage_velia")
public class Ai_npc_tribute_carriage_velia extends CreatureAI {
	public Ai_npc_tribute_carriage_velia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Reday_To_Go(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_01");
	...
	protected void Move_Calpheon_Start(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0048", ENaviType.ground, () -> {
			return false;
	...
	protected void Tribute_Message_01(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_02");
	...
	protected void Move_Calpheon_Ing01(double blendTime) {
		...
		deliveryItem(EAIDeliveryType.move);
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0116", ENaviType.ground, () -> {
			return false;
	...
	protected void Tribute_Message_02(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_03");
	...
	protected void Move_Calpheon_Ing02(double blendTime) {
		...
		deliveryItem(EAIDeliveryType.move);
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0227", ENaviType.ground, () -> {
			return false;
	...
	protected void Tribute_Message_03(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_04");
	...
	protected void Move_Calpheon_Ing03(double blendTime) {
		...
		deliveryItem(EAIDeliveryType.move);
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0287", ENaviType.ground, () -> {
			return false;
	...
	protected void Tribute_Message_04(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_05");
	...
	protected void Move_Calpheon_Ing04(double blendTime) {
		...
		deliveryItem(EAIDeliveryType.move);
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0307", ENaviType.ground, () -> {
			return false;
	...
	protected void Tribute_Message_05(double blendTime) {
		...
		worldNotify(EChatNoticeType.OfferingCarrier, "GAME", "LUA_TRIBUTE_CARRIER_MESSAGE_06");
	...
	protected void Prepare(double blendTime) {
		...
		if (getLastDestination() == getVariable(0xD240861L /*TributeCarrierVelia_0307*/)) {
	...
	protected void ReadyToGo_to_Velia(double blendTime) {
		...
		doAction(379504146L /*READY_TO_GO_VELIA*/, blendTime, onDoActionEnd -> scheduleState(state -> GoBack(blendTime), 1000));
	}
	...
	protected void GoBack(double blendTime) {
		...
		deliveryItem(EAIDeliveryType.move);
		doAction(4062859220L /*RUN*/, blendTime, onDoActionEnd -> moveToWaypoint("offering_carrier", "TributeCarrierVelia_0001", ENaviType.ground, () -> {
			return false;
	...
	public EAiHandlerResult HandlerDestinationMove(Creature sender, Integer[] eventData) {
		...
		if (getLastDestination() == getVariable(0x20543898L /*TributeCarrierVelia_0048*/)) {
			if (changeState(state -> Move_Calpheon_Ing01(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getLastDestination() == getVariable(0x49E2C53L /*TributeCarrierVelia_0116*/)) {
			if (changeState(state -> Move_Calpheon_Ing02(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getLastDestination() == getVariable(0xC21CC8D1L /*TributeCarrierVelia_0227*/)) {
			if (changeState(state -> Move_Calpheon_Ing03(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getLastDestination() == getVariable(0x194706D0L /*TributeCarrierVelia_0287*/)) {
