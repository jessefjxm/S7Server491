...
@IAIName("summon_barricade_steel")
public class Ai_summon_barricade_steel extends CreatureAI {
	public Ai_summon_barricade_steel(Creature actor, Map<Long, Integer> aiVariables) {
