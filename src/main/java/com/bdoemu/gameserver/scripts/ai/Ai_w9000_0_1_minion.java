...
@IAIName("w9000_0_1_minion")
public class Ai_w9000_0_1_minion extends CreatureAI {
	public Ai_w9000_0_1_minion(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Line1(double blendTime) {
		...
		doAction(3326922924L /*MOVE_CHASER*/, blendTime, onDoActionEnd -> moveToWaypoint("battlefield", "w10000_team0_route1_6", ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Battle_Wait(blendTime), 1000)));
	}
