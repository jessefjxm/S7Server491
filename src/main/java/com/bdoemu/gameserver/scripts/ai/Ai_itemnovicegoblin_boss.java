...
@IAIName("itemnovicegoblin_boss")
public class Ai_itemnovicegoblin_boss extends CreatureAI {
	public Ai_itemnovicegoblin_boss(Creature actor, Map<Long, Integer> aiVariables) {
