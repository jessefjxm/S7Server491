...
@IAIName("npc_fruitbasket")
public class Ai_npc_fruitbasket extends CreatureAI {
	public Ai_npc_fruitbasket(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 6000));
	}
