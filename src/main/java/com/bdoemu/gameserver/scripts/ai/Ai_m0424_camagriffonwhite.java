...
@IAIName("m0424_camagriffonwhite")
public class Ai_m0424_camagriffonwhite extends CreatureAI {
	public Ai_m0424_camagriffonwhite(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_Logic(double blendTime) {
		...
		if (getVariable(0x3F487035L /*_HP*/) <= 80 && target != null && getTargetHp(target) > 0) {
			if(Rnd.getChance(10)) {
	...
	public EAiHandlerResult HandleTakeTeamDamage(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getState() != 0x71F28994L /*Battle_Wait*/ && getState() != 0x39B3FBC2L /*Move_Chaser*/ && getState() != 0x8739DEAAL /*Attack_OneHand*/ && getState() != 0x6735F109L /*Attack_TwoHand*/ && getState() != 0x51F9BF8FL /*Attack_Position_Ing*/ && getState() != 0x3E9B83EEL /*Attack_Position_End*/ && getState() != 0x9D9470D7L /*Attack_Breath*/ && getState() != 0xC8BC3ABDL /*Attack_Jump*/ && getState() != 0x1239D668L /*Attack_Head*/ && getState() != 0x460B4E3AL /*Attack_Move*/ && getState() != 0x1471881CL /*Move_ReturnToParent*/) {
			if (changeState(state -> Battle_Wait(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		return EAiHandlerResult.BYPASS;
