...
@IAIName("pet_kangaroorat")
public class Ai_pet_kangaroorat extends CreatureAI {
	public Ai_pet_kangaroorat(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Owner_Landing_Chase(double blendTime) {
		...
		doAction(4171429047L /*RUN_FAST*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerRelative, 0, 0, -40, 0, 1, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Owner_Landing_Ing(blendTime), 1500)));
	}
	...
	protected void Owner_Landing_Ing(double blendTime) {
		...
		doAction(2267039204L /*OWNER_LANDING*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Landing_Ing_A(double blendTime) {
		...
		doAction(3673028551L /*OWNER_LANDING_A*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Landing(double blendTime) {
		...
		doAction(917493806L /*OWNER_LANDING_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing(blendTime), 1000));
	}
	...
	protected void Owner_Landing_Chase_PBW(double blendTime) {
		...
		doAction(4171429047L /*RUN_FAST*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerRelative, 0, 0, -40, 0, 1, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Owner_Landing_Ing_PBW(blendTime), 1500)));
	}
	...
	protected void Owner_Landing_Ing_PBW(double blendTime) {
		...
		doAction(554937847L /*OWNER_LANDING_PBW*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing_A_PBW(blendTime), 1000));
	}
	...
	protected void Owner_Landing_Ing_A_PBW(double blendTime) {
		...
		doAction(2100852525L /*OWNER_LANDING_A_PBW*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_Ing_A_PBW(blendTime), 1000));
	}
	...
	protected void Owner_Landing_PBW(double blendTime) {
		...
		doAction(1447360144L /*OWNER_LANDING_END_PBW*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Landing_PBW(blendTime), 1000));
	}
	...
	protected void Take_Off_Fall(double blendTime) {
		...
		doAction(1192372287L /*OWNER_TAKE_OFF_ING*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 0, 1, true, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Take_Off_Fall_End(blendTime), 1000)));
	}
	...
	protected void Wait_Summon7(double blendTime) {
		...
		doAction(2434827333L /*WAIT_CHASE7_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_Ing(blendTime), 1000));
	}

	protected void Wait_Summon7_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xF5FF8D6DL /*Wait_Summon7_Ing*/);
		setVariable(0xCBEEF8C7L /*_ownerDistance*/, getDistanceToOwnerNotFormation());
		setVariable(0x3E491457L /*_Skill0_UsableDistance*/, getPetSkillUsableDistance(0));
		setVariable(0x6AD923A2L /*_Skill1_UsableDistance*/, getPetSkillUsableDistance(1));
		setVariable(0xF4E090DL /*_Skill0_DetectDistance*/, getPetSkillDetectDistance(0));
		...
		if (false && getVariable(0xB4AEEB95L /*_isGetItemMode*/) == 1) {
			if (findTarget(EAIFindTargetType._Skill0_TargetType0, EAIFindType.normal, false, object -> getDistanceToTarget(object) < getVariable(0x3E491457L /*_Skill0_UsableDistance*/))) {
				if (changeState(state -> Wait_Summon7_End(blendTime)))
					return;
			}
		}
		if (false && getVariable(0xB4AEEB95L /*_isGetItemMode*/) == 1) {
		...
		doAction(1549416995L /*WAIT_CHASE7_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_End(blendTime), 1000));
	}

	protected void Wait_Summon7_End(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x801C0955L /*Wait_Summon7_End*/);
		doAction(3012818648L /*WAIT_CHASE7_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon7_End_Logic(blendTime), 1000));
	}

	protected void Wait_Summon7_End_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0xD1DD4287L /*Wait_Summon7_End_Logic*/);
		setVariable(0xCBEEF8C7L /*_ownerDistance*/, getDistanceToOwnerNotFormation());
		setVariable(0x3E491457L /*_Skill0_UsableDistance*/, getPetSkillUsableDistance(0));
		setVariable(0x6AD923A2L /*_Skill1_UsableDistance*/, getPetSkillUsableDistance(1));
		setVariable(0xF4E090DL /*_Skill0_DetectDistance*/, getPetSkillDetectDistance(0));
	...
	protected void Wait_Summon8(double blendTime) {
		...
		doAction(61986832L /*WAIT_CHASE8_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_Ing(blendTime), 1000));
	}

	protected void Wait_Summon8_Ing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x90BA4587L /*Wait_Summon8_Ing*/);
		setVariable(0xCBEEF8C7L /*_ownerDistance*/, getDistanceToOwnerNotFormation());
		setVariable(0x3E491457L /*_Skill0_UsableDistance*/, getPetSkillUsableDistance(0));
		setVariable(0x6AD923A2L /*_Skill1_UsableDistance*/, getPetSkillUsableDistance(1));
		setVariable(0xF4E090DL /*_Skill0_DetectDistance*/, getPetSkillDetectDistance(0));
		...
		if (false && getVariable(0xB4AEEB95L /*_isGetItemMode*/) == 1) {
			if (findTarget(EAIFindTargetType._Skill0_TargetType0, EAIFindType.normal, false, object -> getDistanceToTarget(object) < getVariable(0x3E491457L /*_Skill0_UsableDistance*/))) {
				if (changeState(state -> Wait_Summon8_End(blendTime)))
					return;
			}
		}
		if (false && getVariable(0xB4AEEB95L /*_isGetItemMode*/) == 1) {
		...
		doAction(3504235361L /*WAIT_CHASE8_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_End(blendTime), 1000));
	}

	protected void Wait_Summon8_End(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xD837437L /*Wait_Summon8_End*/);
		doAction(798673247L /*WAIT_CHASE8_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon8_End_Logic(blendTime), 1000));
	}

	protected void Wait_Summon8_End_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x595214CBL /*Wait_Summon8_End_Logic*/);
		setVariable(0xCBEEF8C7L /*_ownerDistance*/, getDistanceToOwnerNotFormation());
		setVariable(0x3E491457L /*_Skill0_UsableDistance*/, getPetSkillUsableDistance(0));
		setVariable(0x6AD923A2L /*_Skill1_UsableDistance*/, getPetSkillUsableDistance(1));
		setVariable(0xF4E090DL /*_Skill0_DetectDistance*/, getPetSkillDetectDistance(0));
	...
	protected void Wait_Summon9(double blendTime) {
		...
		doAction(3451878451L /*WAIT_CHASE9_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon9_Ing(blendTime), 1000));
	}
	...
	protected void Wait_Summon9_Ing(double blendTime) {
		...
		doAction(3061014360L /*WAIT_CHASE9_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon9_End(blendTime), 1000));
	}
	...
	protected void Wait_Summon9_End(double blendTime) {
		...
		doAction(2751282873L /*WAIT_CHASE9_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon9_End_Logic(blendTime), 1000));
	}
	...
	protected void FindDungeon(double blendTime) {
		...
		doAction(907009164L /*FIND_DUNGEON_STR*/, blendTime, onDoActionEnd -> scheduleState(state -> FindDungeon_Ing(blendTime), 1000));
	}
	...
	protected void FindDungeon_Ing(double blendTime) {
		...
		doAction(2065994425L /*FIND_DUNGEON_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> FindDungeon_Ing(blendTime), 1000));
	}
	...
	protected void FindDungeon_End(double blendTime) {
		...
		setVariable(0x6EA9665AL /*_FindDungeon_StartTime*/, getTime());
		doAction(139244320L /*FIND_DUNGEON_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon(blendTime), 1000));
	}
	...
	protected void Owner_Horse_Landing_Chase(double blendTime) {
		...
		doAction(4171429047L /*RUN_FAST*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerRelative, 0, -60, 40, 0, 1, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Owner_Horse_Landing_Ing(blendTime), 1500)));
	}
	...
	protected void Owner_Horse_Landing_Ing(double blendTime) {
		...
		doAction(880765265L /*OWNER_HORSE_LANDING*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Horse_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Horse_Landing_Ing_A(double blendTime) {
		...
		doAction(3726315205L /*OWNER_HORSE_LANDING_A*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Horse_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Horse_Landing(double blendTime) {
		...
		doAction(4219011137L /*OWNER_HORSE_LANDING_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Horse_Landing(blendTime), 1000));
	}
	...
	protected void Horse_Take_Off_Fall(double blendTime) {
		...
		doAction(1192372287L /*OWNER_TAKE_OFF_ING*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 0, 1, true, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Horse_Take_Off_Fall_End(blendTime), 1000)));
	}
	...
	protected void Horse_GetItem(double blendTime) {
		...
		doAction(960059183L /*WAIT_CHASE*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Horse_Landing_Chase(blendTime), 2000));
	}
	...
	protected void Owner_Carriage_Landing_Chase(double blendTime) {
		...
		doAction(4171429047L /*RUN_FAST*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerRelative, 0, -150, -300, 0, 1, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Owner_Carriage_Landing_Ing(blendTime), 1500)));
	}
	...
	protected void Owner_Carriage_Landing_Ing(double blendTime) {
		...
		doAction(3237536004L /*OWNER_CARRIAGE_LANDING*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Carriage_Landing_Ing_A(double blendTime) {
		...
		doAction(2566217585L /*OWNER_CARRIAGE_LANDING_A*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing_Ing_A(blendTime), 1000));
	}
	...
	protected void Owner_Carriage_Landing(double blendTime) {
		...
		doAction(3777041608L /*OWNER_CARRIAGE_LANDING_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing(blendTime), 1000));
	}
	...
	protected void Carriage_Take_Off_Fall(double blendTime) {
		...
		doAction(1192372287L /*OWNER_TAKE_OFF_ING*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 0, 1, true, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Carriage_Take_Off_Fall_End(blendTime), 1000)));
	}
	...
	protected void Carriage_GetItem(double blendTime) {
		...
		doAction(960059183L /*WAIT_CHASE*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing_Chase(blendTime), 2000));
	}
	...
	public EAiHandlerResult HandlePetAttachBoned(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getSummonerClass() == 0 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getSummonerClass() == 4 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getSummonerClass() == 8 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getSummonerClass() == 12 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getSummonerClass() == 20 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getSummonerClass() == 16 && getVariable(0x69C27CA9L /*_Attachable_Type*/) == 2) {
			if (changeState(state -> Owner_Landing_PBW(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getVariable(0x69C27CA9L /*_Attachable_Type*/) == 1) {
			if (changeState(state -> Owner_Horse_Landing(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getVariable(0x69C27CA9L /*_Attachable_Type*/) == 3) {
