...
@IAIName("w130croncastle_crank")
public class Ai_w130croncastle_crank extends CreatureAI {
	public Ai_w130croncastle_crank(Creature actor, Map<Long, Integer> aiVariables) {
