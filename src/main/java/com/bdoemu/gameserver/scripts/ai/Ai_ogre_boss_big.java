...
@IAIName("ogre_boss_big")
public class Ai_ogre_boss_big extends CreatureAI {
	public Ai_ogre_boss_big(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Logic_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0xE08011DBL /*Logic_60*/);
		if (findTargetInAggro(EAIFindTargetType.Enemy, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 5000 && getTargetHp(object) > 0)) {
			if (changeState(state -> Battle_Wait_60(0.3)))
				return;
		}
		changeState(state -> Move_Return(blendTime));
	}

	protected void Logic_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0xFC769604L /*Logic_30*/);
		if (findTargetInAggro(EAIFindTargetType.Enemy, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 5000 && getTargetHp(object) > 0)) {
	...
	protected void LostTarget_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xEAB58909L /*LostTarget_60*/);
		doAction(933998996L /*LOST_TARGET*/, blendTime, onDoActionEnd -> scheduleState(state -> Logic_60(blendTime), 100));
	}

	protected void LostTarget_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x9C230AA9L /*LostTarget_30*/);
		doAction(933998996L /*LOST_TARGET*/, blendTime, onDoActionEnd -> scheduleState(state -> Logic_30(blendTime), 100));
	}
	...
	protected void Move_Return(double blendTime) {
		...
		setVariable(0xFA9DA674L /*_isBattleMode*/, 0);
		clearAggro(true);
		doAction(633942026L /*MOVE_WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 0, 1, false, ENaviType.ground, () -> {
			setVariable(0x444DFF4EL /*_isFindPathCompleted*/, isFindPathCompleted());
			if (getVariable(0x444DFF4EL /*_isFindPathCompleted*/) == 0) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x3F487035L /*_HP*/) < 60 && getVariable(0x3F487035L /*_HP*/) > 30) {
			if (changeState(state -> Battle_Wait_60(0.3)))
				return;
		}
	...
	protected void Battle_Wait_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xFB07D4B8L /*Battle_Wait_60*/);
		setVariable(0xE5BD13F2L /*_Degree*/, getDegreeToTarget());
		setVariable(0x3F487035L /*_Hp*/, getHpRate());
		setVariable(0xFA9DA674L /*_isBattleMode*/, 1);
		if (target != null && getTargetHp(target) == 0) {
			if (changeState(state -> LostTarget_60(0.3)))
				return;
		}
		if (getVariable(0x3F487035L /*_HP*/) < 30) {
			if (changeState(state -> Battle_Wait_30(0.3)))
		...
		if (getVariable(0x3F487035L /*_HP*/) < 50 && getVariable(0x5CE1B16EL /*_GeneralCount*/) >= 15 && getVariable(0x8620C5A4L /*_GeneralLimitCount*/) >= 1) {
			if (changeState(state -> Attack_General_60(0.3)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) > 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Move_Chaser_60(0.3)))
					return;
			}
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Kick_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(55)) {
				if (changeState(state -> Attack_Kick2_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) <= 1500 && target != null && getDistanceToTarget(target) >= 600 && getVariable(0x5749908DL /*_JumpCount*/) >= 25) {
			if(Rnd.getChance(25)) {
				if (changeState(state -> Attack_Jump_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) <= 1500 && target != null && getDistanceToTarget(target) >= 600 && getVariable(0x357581C9L /*_RangeCount*/) >= 15) {
			if(Rnd.getChance(25)) {
				if (changeState(state -> Attack_Range_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 700 && getVariable(0x3F487035L /*_HP*/) < 30 && getVariable(0x5CE1B16EL /*_GeneralCount*/) >= 15) {
		...
		if (getVariable(0xE5BD13F2L /*_Degree*/) <= -35 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Attack_Turn_L_60(0.3)))
					return;
			}
		}
		if (getVariable(0xE5BD13F2L /*_Degree*/) >= 35 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Attack_Turn_R_60(0.3)))
					return;
			}
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Combo_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Stamp_L_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Stamp_R_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(60)) {
				if (changeState(state -> Attack_Swing_L_60(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if (changeState(state -> Attack_Swing_R_60(0.3)))
				return;
		}
		doAction(2694584889L /*BATTLE_WAIT_60*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_60(blendTime), 100));
	}
	...
	protected void Battle_Wait_30(double blendTime) {
		...
		setVariable(0xFA9DA674L /*_isBattleMode*/, 1);
		if (target != null && getTargetHp(target) == 0) {
			if (changeState(state -> LostTarget_30(0.3)))
				return;
		}
		if (getDistanceToSpawn() > 10000) {
			if (changeState(state -> Move_Return(0.3)))
		...
		if (getVariable(0x3F487035L /*_HP*/) < 50 && getVariable(0x5CE1B16EL /*_GeneralCount*/) >= 15 && getVariable(0x8620C5A4L /*_GeneralLimitCount*/) >= 1) {
			if (changeState(state -> Attack_General_30(0.3)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) > 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Move_Chaser_30(0.3)))
					return;
			}
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Kick_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(55)) {
				if (changeState(state -> Attack_Kick2_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) <= 1500 && target != null && getDistanceToTarget(target) >= 600 && getVariable(0x5749908DL /*_JumpCount*/) >= 25) {
			if(Rnd.getChance(25)) {
				if (changeState(state -> Attack_Jump_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) <= 1500 && target != null && getDistanceToTarget(target) >= 600 && getVariable(0x357581C9L /*_RangeCount*/) >= 15) {
			if(Rnd.getChance(25)) {
				if (changeState(state -> Attack_Range_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 700 && getVariable(0x3F487035L /*_HP*/) < 30 && getVariable(0x5CE1B16EL /*_GeneralCount*/) >= 15) {
		...
		if (getVariable(0xE5BD13F2L /*_Degree*/) <= -35 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Attack_Turn_L_30(0.3)))
					return;
			}
		}
		if (getVariable(0xE5BD13F2L /*_Degree*/) >= 35 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Attack_Turn_R_30(0.3)))
					return;
			}
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Combo_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Stamp_L_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Stamp_R_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(60)) {
				if (changeState(state -> Attack_Swing_L_30(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 600) {
			if (changeState(state -> Attack_Swing_R_30(0.3)))
				return;
		}
	...
	protected void Move_Chaser_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.chase);
		setState(0xCDCFDE28L /*Move_Chaser_60*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_60(blendTime)))
				return;
		}
		if (getSelfCombinePoint() == 59) {
			if (changeState(state -> Damage_Stun(0.3)))
		...
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) > 1000) {
			if (changeState(state -> HighSpeed_Chaser_60(0.4)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(40)) {
		...
		if (target != null && getDistanceToTarget(target) < 450) {
			if (changeState(state -> Battle_Wait_60(0.4)))
				return;
		}
		doAction(931779760L /*MOVE_WALK_60*/, blendTime, onDoActionEnd -> chase(getVariable(0xD2BFE684L /*TargetCycle*/), () -> {
			setVariable(0x444DFF4EL /*_isFindPathCompleted*/, isFindPathCompleted());
			if (getVariable(0x444DFF4EL /*_isFindPathCompleted*/) == 0 && getVariable(0xFDC61BCCL /*_FailFindPathCount*/) >= 12) {
				if (changeState(state -> Move_Return(0.3)))
					return true;
			...
			setVariable(0xFDC61BCCL /*_FailFindPathCount*/, 0);
			return false;
		}, onExit -> scheduleState(state -> Move_Chaser_60(blendTime), 100)));
	}

	protected void Move_Chaser_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.chase);
		setState(0x6EF81AE7L /*Move_Chaser_30*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_30(blendTime)))
				return;
		}
		if (getSelfCombinePoint() == 59) {
			if (changeState(state -> Damage_Stun(0.3)))
		...
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) > 1000) {
			if (changeState(state -> HighSpeed_Chaser_30(0.4)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(40)) {
		...
		if (target != null && getDistanceToTarget(target) < 450) {
			if (changeState(state -> Battle_Wait_30(0.4)))
				return;
		}
		doAction(4101496522L /*MOVE_WALK_30*/, blendTime, onDoActionEnd -> chase(getVariable(0xD2BFE684L /*TargetCycle*/), () -> {
			setVariable(0x444DFF4EL /*_isFindPathCompleted*/, isFindPathCompleted());
			if (getVariable(0x444DFF4EL /*_isFindPathCompleted*/) == 0 && getVariable(0xFDC61BCCL /*_FailFindPathCount*/) >= 12) {
				if (changeState(state -> Move_Return(0.3)))
					return true;
			...
			setVariable(0xFDC61BCCL /*_FailFindPathCount*/, 0);
			return false;
		}, onExit -> scheduleState(state -> Move_Chaser_30(blendTime), 100)));
	}
	...
	protected void HighSpeed_Chaser_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.chase);
		setState(0x7CA09A50L /*HighSpeed_Chaser_60*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_60(blendTime)))
				return;
		}
		...
		if (target != null && getDistanceToTarget(target) < 450) {
			if (changeState(state -> HighSpeed_Chaser_Stop_60(0.4)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(40)) {
		...
		if (target != null && getDistanceToTarget(target) <= 1500 && getVariable(0x3F487035L /*_HP*/) <= 50 && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Jump2_60(0.3)))
					return;
			}
		}
		doAction(2689517725L /*BATTLE_RUN*/, blendTime, onDoActionEnd -> chase(getVariable(0xD2BFE684L /*TargetCycle*/), () -> {
			...
			setVariable(0xFDC61BCCL /*_FailFindPathCount*/, 0);
			return false;
		}, onExit -> scheduleState(state -> HighSpeed_Chaser_60(blendTime), 100)));
	}

	protected void HighSpeed_Chaser_Stop_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x7D591F3L /*HighSpeed_Chaser_Stop_60*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_60(blendTime)))
				return;
		}
		doAction(4007323001L /*BATTLE_RUN_STOP_60*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_60(blendTime)));
	}

	protected void HighSpeed_Chaser_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.chase);
		setState(0x30657234L /*HighSpeed_Chaser_30*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_30(blendTime)))
				return;
		}
		...
		if (target != null && getDistanceToTarget(target) < 450) {
			if (changeState(state -> HighSpeed_Chaser_Stop_30(0.4)))
				return;
		}
		if (getSelfCombinePoint() != 13 && target != null && getDistanceToTarget(target) < 600) {
			if(Rnd.getChance(40)) {
		...
		if (target != null && getDistanceToTarget(target) <= 1500 && getVariable(0x3F487035L /*_HP*/) <= 50 && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(30)) {
				if (changeState(state -> Attack_Jump2_30(0.3)))
					return;
			}
		}
		doAction(2689517725L /*BATTLE_RUN*/, blendTime, onDoActionEnd -> chase(getVariable(0xD2BFE684L /*TargetCycle*/), () -> {
			...
			setVariable(0xFDC61BCCL /*_FailFindPathCount*/, 0);
			return false;
		}, onExit -> scheduleState(state -> HighSpeed_Chaser_30(blendTime), 100)));
	}

	protected void HighSpeed_Chaser_Stop_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xACBA974DL /*HighSpeed_Chaser_Stop_30*/);
		if (isTargetLost()) {
			if (changeState(state -> LostTarget_60(blendTime)))
				return;
		}
		doAction(2051043512L /*BATTLE_RUN_STOP_30*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait_30(blendTime)));
	}
	...
	protected void Attack_Turn_L_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x72BD2C35L /*Attack_Turn_L_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(3146122970L /*ATTACK_TURN_L_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Turn_R_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x7A7AA7CFL /*Attack_Turn_R_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(311257954L /*ATTACK_TURN_R_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Swing_L_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xDA04BE0DL /*Attack_Swing_L_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(426602778L /*ATTACK_SWING_L_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Swing_R_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x1F2483D6L /*Attack_Swing_R_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(1677236791L /*ATTACK_SWING_R_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Stamp_L_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x2D4BAEC1L /*Attack_Stamp_L_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(4106051273L /*ATTACK_STAMP_LA_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Stamp_R_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x5D345B59L /*Attack_Stamp_R_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(3303906132L /*ATTACK_STAMP_RA_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Stamp_LK_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x53D15C6AL /*Attack_Stamp_LK_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(2516379701L /*ATTACK_STAMP_LK_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Stamp_RK_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x7409A91AL /*Attack_Stamp_RK_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(1713643585L /*ATTACK_STAMP_RK_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Kick_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x48032BF7L /*Attack_Kick_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(4040106291L /*ATTACK_KICK_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Jump_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x2E542EBBL /*Attack_Jump_60*/);
		doAction(2358416320L /*ATTACK_JUMP_SMASH_60*/, blendTime, onDoActionEnd -> {
			setVariable(0x5749908DL /*_JumpCount*/, 0);
			changeState(state -> Logic_60(blendTime));
		});
	}

	protected void Attack_Jump2_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xAF5C5A92L /*Attack_Jump2_60*/);
		doAction(3462690343L /*ATTACK_RUNNING_JUMP_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Kick2_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x3A7FB952L /*Attack_Kick2_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(2863526384L /*ATTACK_KICK_COMBO_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Combo_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x1F026E0L /*Attack_Combo_60*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(3893670102L /*ATTACK_SWING_COMBO_60*/, blendTime, onDoActionEnd -> changeState(state -> Logic_60(blendTime)));
	}

	protected void Attack_Range_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xD7DD0134L /*Attack_Range_60*/);
		doAction(1304427239L /*ATTACK_STONEWAVE_60*/, blendTime, onDoActionEnd -> {
			setVariable(0x357581C9L /*_RangeCount*/, 0);
			changeState(state -> Logic_60(blendTime));
		});
	}

	protected void Attack_General_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xA1F59FEAL /*Attack_General_60*/);
		if (getSelfCombinePoint() == 14) {
			if (changeState(state -> Attack_General_Cancel(0.3)))
				return;
		}
		doAction(3644242263L /*ATTACK_GENERAL_A_60*/, blendTime, onDoActionEnd -> changeState(state -> Attack_General1_60(blendTime)));
	}

	protected void Attack_General1_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x65C4A603L /*Attack_General1_60*/);
		if (getSelfCombinePoint() == 14) {
			if (changeState(state -> Attack_General_Cancel(0.3)))
				return;
		}
		doAction(484579055L /*ATTACK_GENERAL_B_60*/, blendTime, onDoActionEnd -> changeState(state -> Attack_General2_60(blendTime)));
	}

	protected void Attack_General2_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xCD45CA97L /*Attack_General2_60*/);
		doAction(743319417L /*ATTACK_GENERAL_C_60*/, blendTime, onDoActionEnd -> {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, 0);
			setVariable(0x8620C5A4L /*_GeneralLimitCount*/, getVariable(0x8620C5A4L /*_GeneralLimitCount*/) - 1);
			changeState(state -> Logic_60(blendTime));
		});
	...
	protected void Attack_General_Cancel_60(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x34ABB1BDL /*Attack_General_Cancel_60*/);
		doAction(3152228051L /*DAMAGE_CANCEL*/, blendTime, onDoActionEnd -> scheduleState(state -> Logic_60(blendTime), 1000));
	}

	protected void Attack_Turn_L_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xE734F3EDL /*Attack_Turn_L_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(247434466L /*ATTACK_TURN_L_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Turn_R_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xDBA53184L /*Attack_Turn_R_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(824138999L /*ATTACK_TURN_R_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Swing_L_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x3188D17AL /*Attack_Swing_L_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(158998540L /*ATTACK_SWING_L_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Swing_R_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xBD3F47E8L /*Attack_Swing_R_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(2035055347L /*ATTACK_SWING_R_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Stamp_L_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xFF6C3C4BL /*Attack_Stamp_L_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(1393464413L /*ATTACK_STAMP_LA_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Stamp_R_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xD2D8EEACL /*Attack_Stamp_R_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(301337320L /*ATTACK_STAMP_RA_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Stamp_LK_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xA7687BC8L /*Attack_Stamp_LK_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(2858398939L /*ATTACK_STAMP_LK_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Stamp_RK_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x56D72422L /*Attack_Stamp_RK_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(414518275L /*ATTACK_STAMP_RK_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Kick_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x806F0F5BL /*Attack_Kick_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(1221465507L /*ATTACK_KICK_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Jump_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xE7B4DE0BL /*Attack_Jump_30*/);
		doAction(2002383988L /*ATTACK_JUMP_SMASH_30*/, blendTime, onDoActionEnd -> {
			setVariable(0x5749908DL /*_JumpCount*/, 0);
			changeState(state -> Logic_30(blendTime));
		});
	}

	protected void Attack_Jump2_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xAD17F417L /*Attack_Jump2_30*/);
		doAction(1499921592L /*ATTACK_RUNNING_JUMP_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Kick2_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x6256F305L /*Attack_Kick2_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(2563571505L /*ATTACK_KICK_COMBO_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Combo_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x2D5624E8L /*Attack_Combo_30*/);
		if (getVariable(0x5CE1B16EL /*_GeneralCount*/) < 16) {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, getVariable(0x5CE1B16EL /*_GeneralCount*/) + 1);
		}
		doAction(3266827944L /*ATTACK_SWING_COMBO_30*/, blendTime, onDoActionEnd -> changeState(state -> Logic_30(blendTime)));
	}

	protected void Attack_Range_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x4790CE83L /*Attack_Range_30*/);
		doAction(1615344718L /*ATTACK_STONEWAVE_30*/, blendTime, onDoActionEnd -> {
			setVariable(0x357581C9L /*_RangeCount*/, 0);
			changeState(state -> Logic_30(blendTime));
		});
	}

	protected void Attack_General_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xD6209190L /*Attack_General_30*/);
		if (getSelfCombinePoint() == 14) {
			if (changeState(state -> Attack_General_Cancel(0.3)))
				return;
		}
		doAction(2172577488L /*ATTACK_GENERAL_A_30*/, blendTime, onDoActionEnd -> changeState(state -> Attack_General1_30(blendTime)));
	}

	protected void Attack_General1_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xE2C45939L /*Attack_General1_30*/);
		if (getSelfCombinePoint() == 14) {
			if (changeState(state -> Attack_General_Cancel(0.3)))
				return;
		}
		doAction(4246185069L /*ATTACK_GENERAL_B_30*/, blendTime, onDoActionEnd -> changeState(state -> Attack_General2_30(blendTime)));
	}

	protected void Attack_General2_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x2A58D57CL /*Attack_General2_30*/);
		doAction(483473649L /*ATTACK_GENERAL_C_30*/, blendTime, onDoActionEnd -> {
			setVariable(0x5CE1B16EL /*_GeneralCount*/, 0);
			setVariable(0x8620C5A4L /*_GeneralLimitCount*/, getVariable(0x8620C5A4L /*_GeneralLimitCount*/) - 1);
			changeState(state -> Logic_30(blendTime));
		});
	...
	protected void Attack_General_Cancel_30(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0xD0C70A0L /*Attack_General_Cancel_30*/);
		doAction(3152228051L /*DAMAGE_CANCEL*/, blendTime, onDoActionEnd -> scheduleState(state -> Logic_30(blendTime), 1000));
	}
