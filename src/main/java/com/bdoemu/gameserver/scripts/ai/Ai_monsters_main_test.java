...
@IAIName("monsters_main_test")
public class Ai_monsters_main_test extends CreatureAI {
	public Ai_monsters_main_test(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Start_Action(double blendTime) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Search_Enemy_GoChase(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Search_Enemy(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Move_Chaser(0.5)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait(0.3)))
					return;
			}
		}
		doAction(3910697700L /*START_ACTION*/, blendTime, onDoActionEnd -> scheduleState(state -> Start_Action(blendTime), 5000 + Rnd.get(-500,500)));
	}
	...
	protected void Start_Action_Swim(double blendTime) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Search_Enemy_GoChase_Swim(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Move_Chaser_Swim(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1) {
		...
		doAction(2141126528L /*START_ACTION_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Start_Action_Swim(blendTime), 5000 + Rnd.get(-500,500)));
	}
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0xDEC1C47AL /*AI_CheckLevel_Escape*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> CheckLevel_Escape(0.3)))
					return;
			}
		}
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0x17A7D55AL /*AI_CheckLevel_Runaway*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> CheckLevel_RunAway(0.3)))
					return;
			}
		}
		if (getVariable(0xBE61A9BCL /*AI_Chaser_PreAction*/) == 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Move_Chaser_PreAction(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) >= 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Character, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && (getTargetCharacterKey(object) == getVariable(0x978EF3E4L /*AI_RunRandom_CharacterKey1*/) || getTargetCharacterKey(object) == getVariable(0x698D2DB1L /*AI_RunRandom_CharacterKey2*/) || getTargetCharacterKey(object) == getVariable(0xEB63DE64L /*AI_RunRandom_CharacterKey3*/) || getTargetCharacterKey(object) == getVariable(0xEBD351C7L /*AI_RunRandom_CharacterKey4*/) || getTargetCharacterKey(object) == getVariable(0x9BE10F67L /*AI_RunRandom_CharacterKey5*/)) && isCreatureVisible(object, false))) {
	...
	protected void Wait_Swim(double blendTime) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0xDEC1C47AL /*AI_CheckLevel_Escape*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> CheckLevel_Escape_Swim(0.3)))
					return;
			}
		}
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0x17A7D55AL /*AI_CheckLevel_Runaway*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> CheckLevel_RunAway_Swim(0.3)))
					return;
			}
		}
		if (getVariable(0xA0F8091FL /*AI_Chaser_PreAction_Swim*/) == 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Move_Chaser_PreAction_Swim(0.3)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) >= 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
	...
	protected void Move_Random_PreAction(double blendTime) {
		...
		doAction(573590497L /*MOVE_WALK_PREACTION*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Random(blendTime), 3000));
	}
	...
	protected void Move_Random_PreAction_Swim(double blendTime) {
		...
		doAction(1360300233L /*MOVE_WALK_PREACTION_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Random_Swim(blendTime), 3000));
	}
	...
	protected void Move_Random_EndAction(double blendTime) {
		...
		doAction(580477136L /*MOVE_WALK_ENDACTION*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 3000));
	}
	...
	protected void Move_Random_EndAction_Swim(double blendTime) {
		...
		doAction(3449300020L /*MOVE_WALK_ENDACTION_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Swim(blendTime), 3000));
	}
	...
	protected void Move_Random_End_Swim(double blendTime) {
		...
		if (getVariable(0x4CDC84C7L /*AI_MoveRandom_EndAction_Swim*/) == 1) {
			if (changeState(state -> Move_Random_EndAction(0.3)))
				return;
		}
		doAction(211154798L /*WAIT_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Swim(blendTime), 3000));
	}
	...
	protected void Move_Random(double blendTime) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0xDEC1C47AL /*AI_CheckLevel_Escape*/))) {
				if (changeState(state -> CheckLevel_Escape(0.3)))
					return;
			}
		}
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) >= getVariable(0x17A7D55AL /*AI_CheckLevel_Runaway*/))) {
				if (changeState(state -> CheckLevel_RunAway(0.3)))
					return;
			}
		}
	...
	protected void Move_Chaser(double blendTime) {
		...
		if (getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x468D3572L /*AI_EC_LimitDistance*/) && getVariable(0x7492188CL /*_FailFindPath*/) > 1 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
		...
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xB3A90433L /*AI_BT_DestructAttack_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x45AEF498L /*AI_BT_DestructAttack_HP*/)) {
			if(Rnd.getChance(getVariable(0x7FFDF339L /*AI_BT_DestructAttack*/))) {
				if (changeState(state -> Battle_DestructAttack(0.3)))
					return;
			}
		}
		if (getVariable(0x71087D8L /*AI_MoveWarp_Attack*/) == 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xCE5BB4E3L /*AI_MoveWarp_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x25DEC022L /*AI_MoveWarp_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAB67EBDCL /*AI_MoveWarp_HP*/)) {
			if(Rnd.getChance(getVariable(0x44624429L /*AI_MoveWarp*/))) {
				if (changeState(state -> Move_Warp(blendTime)))
					return;
			}
		}
		if (getVariable(0x71087D8L /*AI_MoveWarp_Attack*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xCE5BB4E3L /*AI_MoveWarp_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x25DEC022L /*AI_MoveWarp_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAB67EBDCL /*AI_MoveWarp_HP*/)) {
			if(Rnd.getChance(getVariable(0x44624429L /*AI_MoveWarp*/))) {
				if (changeState(state -> Move_WarpAttack(blendTime)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x2951F4DAL /*AI_EC_Attack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x9C4927FEL /*AI_EC_Attack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x79C2E1A0L /*AI_EC_Attack1*/))) {
				if (changeState(state -> Chase_Attack1(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x33993721L /*AI_EC_Attack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4FD081E4L /*AI_EC_Attack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x2CE6579BL /*AI_EC_Attack2*/))) {
				if (changeState(state -> Chase_Attack2(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF658D7B4L /*AI_EC_Attack3_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x94A188D1L /*AI_EC_Attack3_HP*/) && target != null && isCreatureVisible(target, false)) {
		...
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xE5BD13F2L /*_Degree*/) > -30 && getVariable(0xE5BD13F2L /*_Degree*/) < 30 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF5FA4070L /*AI_BT_ChargeAttack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xE69565E2L /*AI_BT_ChargeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x69679F4CL /*AI_BT_ChargeAttack2*/))) {
				if (changeState(state -> Battle_ChargeAttack2(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xE5BD13F2L /*_Degree*/) > -30 && getVariable(0xE5BD13F2L /*_Degree*/) < 30 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC983C8CCL /*AI_BT_ChargeAttack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xE29339A7L /*AI_BT_ChargeAttack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xE468D9D1L /*AI_BT_ChargeAttack1*/))) {
				if (changeState(state -> Battle_ChargeAttack1(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC944200L /*AI_BT_Attack3_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4D2683ABL /*AI_BT_Attack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBDC07D4BL /*AI_BT_Attack3*/))) {
				if (changeState(state -> Battle_Attack3(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x714E207L /*AI_BT_Attack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4DA023BCL /*AI_BT_Attack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x23576610L /*AI_BT_Attack2*/))) {
				if (changeState(state -> Battle_Attack2(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x22CF02DCL /*AI_BT_Attack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x88498267L /*AI_BT_Attack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xAC1AF8EAL /*AI_BT_Attack1*/))) {
				if (changeState(state -> Battle_Attack1(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3(0.3)))
					return;
			}
		}
		if (getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
		...
		if (getVariable(0xF630F33AL /*_Distance*/) < getVariable(0x5103FB80L /*AI_EC_Distance*/) && target != null && isCreatureVisible(target, false)) {
			if (changeState(state -> Battle_Wait(0.3)))
				return;
		}
	...
	protected void Move_Chaser_Swim(double blendTime) {
		...
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 0) {
			if (changeState(state -> Move_Chaser(0.5)))
				return;
		}
		if (target != null && getTargetHp(target) == 0) {
		...
		doAction(1141561384L /*MOVE_CHASER_SWIM*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> Move_Chaser_Swim(blendTime), 500)));
	}
	...
	protected void Move_Defence_Chaser(double blendTime) {
		...
		doAction(825954671L /*MOVE_DEFENCE_CHASER*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> Move_Defence_Chaser(blendTime), 500)));
	}
	...
	protected void HighSpeed_Chaser_Swim(double blendTime) {
		...
		doAction(3208508703L /*CHASER_RUN*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> HighSpeed_Chaser_Swim(blendTime), 500)));
	}
	...
	protected void HighSpeed_Defence_Chaser(double blendTime) {
		...
		doAction(3178629899L /*CHASER_DEFENCE_RUN*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> HighSpeed_Defence_Chaser(blendTime), 500)));
	}
	...
	protected void FailFindPath(double blendTime) {
		...
		setVariable(0x7492188CL /*_FailFindPath*/, getVariable(0x7492188CL /*_FailFindPath*/) + 1);
		if (getVariable(0x7492188CL /*_FailFindPath*/) > 3 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> FailFindPath_Return(0.3)))
				return;
		}
		if (getVariable(0x7492188CL /*_FailFindPath*/) > 3 && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Chaser(blendTime), 1500));
	}

	protected void FailFindPath_Return(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.idle);
		setState(0x6F62B50BL /*FailFindPath_Return*/);
		setVariable(0x46A5E1BAL /*_HelpMe_Count*/, getVariable(0xB667AD0BL /*AI_HelpMe_Count*/));
		doTeleport(EAIMoveDestType.Random, 0, 0, 1, 1);
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 2000));
	}
	...
	protected void CheckLevel_Escape(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, getBitFlag_NaviType(getCurrentPos_NaviType(getBodyHeight()),getNaviTypeStringToEnum("water")));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 1) {
			if (changeState(state -> CheckLevel_Escape_Swim(blendTime)))
				return;
		}
	...
	protected void CheckLevel_Escape_Swim(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, (getCurrentPos_NaviType()==getNaviTypeStringToEnum("water") ? 1 : 0));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 0) {
			if (changeState(state -> CheckLevel_Escape(blendTime)))
				return;
		}
	...
	protected void Run_Random(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, getBitFlag_NaviType(getCurrentPos_NaviType(getBodyHeight()),getNaviTypeStringToEnum("water")));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 1) {
			if (changeState(state -> Run_Random_Swim(blendTime)))
				return;
		}
	...
	protected void Move_RunAway_Swim(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, (getCurrentPos_NaviType()==getNaviTypeStringToEnum("water") ? 1 : 0));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 0) {
			if (changeState(state -> Move_RunAway(blendTime)))
				return;
		}
	...
	protected void CheckLevel_RunAway(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, getBitFlag_NaviType(getCurrentPos_NaviType(getBodyHeight()),getNaviTypeStringToEnum("water")));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 1) {
			if (changeState(state -> CheckLevel_RunAway_Swim(blendTime)))
				return;
		}
	...
	protected void CheckLevel_RunAway_Swim(double blendTime) {
		...
		setVariable(0x21C76BFFL /*_isWater*/, (getCurrentPos_NaviType()==getNaviTypeStringToEnum("water") ? 1 : 0));
		if (getVariable(0x34A2F995L /*_IsAmphibious*/) == 1 && getVariable(0x21C76BFFL /*_isWater*/) == 0) {
			if (changeState(state -> CheckLevel_RunAway(blendTime)))
				return;
		}
		doAction(2319605744L /*CHECKLEVEL_RUNAWAY*/, blendTime, onDoActionEnd -> escape(2000, () -> {
			return false;
	...
	protected void Move_ReturnToParent(double blendTime) {
		...
		doAction(3326922924L /*MOVE_CHASER*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerPosition, 0, 0, 0, 350, 550, false, ENaviType.ground, () -> {
			return false;
		}, onExit -> scheduleState(state -> Move_ReturnToParent_Complete(blendTime), 1000)));
	}
	...
	protected void Revive_Complete(double blendTime) {
		...
		doAction(3232930915L /*REVIVE*/, blendTime, onDoActionEnd -> revive(10, () -> {
			return false;
	...
	protected void Move_Around(double blendTime) {
		...
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x11830C8FL /*AI_Ba_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xCE756C6FL /*AI_Ba_HP*/)) {
		...
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9F40743BL /*AI_ES_MinDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x61AC0DF1L /*AI_ES_HP*/)) {
			if(Rnd.getChance(getVariable(0x36D3C519L /*AI_Escape*/))) {
				if (changeState(state -> Move_Escape(0.1)))
					return;
			}
		}
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF79690FDL /*AI_RA_MinDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xA789A0D9L /*AI_RA_HP*/)) {
			if(Rnd.getChance(getVariable(0xE1EDA4F4L /*AI_RunAway*/))) {
				if (changeState(state -> Move_RunAway(0.1)))
					return;
			}
		}
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xDD508B3EL /*AI_MA_Attack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x9FFBA0E7L /*AI_MA_Attack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xF10B5B6EL /*AI_MA_Attack1*/))) {
				if (changeState(state -> Around_Attack1(0.3)))
					return;
			}
		}
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x59CC58FEL /*AI_MA_Attack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xD58F9AA4L /*AI_MA_Attack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x13B166ECL /*AI_MA_Attack2*/))) {
				if (changeState(state -> Around_Attack2(0.3)))
					return;
			}
		}
		if (getVariable(0x406D6B1DL /*AI_MA_RangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x6A74CA4CL /*AI_MA_RangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF4D6D97FL /*AI_MA_RangeAttack1_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x9E31AF78L /*AI_MA_RangeAttack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xF8792205L /*AI_MA_RangeAttack1*/))) {
				if (changeState(state -> Around_RangeAttack1(0.3)))
					return;
			}
		}
		if (getVariable(0xF7EE9472L /*AI_MA_RangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xDCD50718L /*AI_MA_RangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC040C1A8L /*AI_MA_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x46F50990L /*AI_MA_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x6BB56182L /*AI_MA_RangeAttack2*/))) {
				if (changeState(state -> Around_RangeAttack2(0.3)))
					return;
			}
		}
		if (getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) >= 300 && getVariable(0x3F487035L /*_HP*/) > 0) {
			if (changeState(state -> Move_Chaser(0.5)))
				return;
		}
	...
	protected void Move_BackStep(double blendTime) {
		...
		doAction(243762293L /*MOVE_BACKSTEP*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait(blendTime), 2000));
	}
	...
	protected void Move_Warp(double blendTime) {
		...
		doAction(1001169626L /*MOVE_WARP_A*/, blendTime, onDoActionEnd -> changeState(state -> Move_Warp_b(blendTime)));
	}
	...
	protected void Move_Warp_b(double blendTime) {
		...
		doAction(4265546893L /*MOVE_WARP_B*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> Move_Warp_b(blendTime), 500)));
	}
	...
	protected void Move_Warp_c(double blendTime) {
		...
		doAction(159963012L /*MOVE_WARP_C*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Move_WarpAttack(double blendTime) {
		...
		doAction(1001169626L /*MOVE_WARP_A*/, blendTime, onDoActionEnd -> changeState(state -> Move_WarpAttack_b(blendTime)));
	}
	...
	protected void Move_WarpAttack_b(double blendTime) {
		...
		doAction(4265546893L /*MOVE_WARP_B*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> Move_WarpAttack_b(blendTime), 500)));
	}
	...
	protected void Move_WarpAttack_c(double blendTime) {
		...
		doAction(159963012L /*MOVE_WARP_C*/, blendTime, onDoActionEnd -> changeState(state -> Move_WarpAttack_d(blendTime)));
	}
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (target != null && getTargetHp(target) > 0 && getVariable(0x184F868DL /*AI_Special_Chase*/) == 1 && getVariable(0x4DA2BAB9L /*AI_Special_Action*/) == 1 && getVariable(0x4A50EDF7L /*AI_Check_BuffIndex*/) != 0 && target != null && checkBuff(target, getVariable(0x4A50EDF7L /*AI_Check_BuffIndex*/)) && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x42FDA76EL /*AI_Special_Action_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4ABAABF5L /*AI_Special_Action_HP*/)) {
		...
		if (getPartyMembersCount()<= getVariable(0x2577BBB2L /*AI_BT_Summon1_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x82A6D61AL /*_SummonCount1*/) >= 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF5CF1EE5L /*AI_BT_Summon1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x26D1B2E6L /*AI_BT_Summon1_HP*/)) {
			if(Rnd.getChance(getVariable(0x7DFA4FFDL /*AI_BT_Summon1*/))) {
				if (changeState(state -> Battle_Summon1(0.3)))
					return;
			}
		}
		if (getPartyMembersCount()<= getVariable(0xB6A7EA69L /*AI_BT_Summon2_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xEE6747DL /*_SummonCount2*/) >= 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x1D38150EL /*AI_BT_Summon2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xBC8E6618L /*AI_BT_Summon2_HP*/)) {
			if(Rnd.getChance(getVariable(0x2CCF3240L /*AI_BT_Summon2*/))) {
				if (changeState(state -> Battle_Summon2(0.3)))
					return;
			}
		}
		if (getPartyMembersCount()<= getVariable(0x920F2D8DL /*AI_BT_Summon3_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xB9D9DDBAL /*_SummonCount3*/) >= 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x6930A994L /*AI_BT_Summon3_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xC7E8981DL /*AI_BT_Summon3_HP*/)) {
			if(Rnd.getChance(getVariable(0xA71DD0EFL /*AI_BT_Summon3*/))) {
				if (changeState(state -> Battle_Summon3(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x71087D8L /*AI_MoveWarp_Attack*/) == 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xCE5BB4E3L /*AI_MoveWarp_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x25DEC022L /*AI_MoveWarp_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAB67EBDCL /*AI_MoveWarp_HP*/)) {
			if(Rnd.getChance(getVariable(0x44624429L /*AI_MoveWarp*/))) {
				if (changeState(state -> Move_Warp(blendTime)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x71087D8L /*AI_MoveWarp_Attack*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xCE5BB4E3L /*AI_MoveWarp_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x25DEC022L /*AI_MoveWarp_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAB67EBDCL /*AI_MoveWarp_HP*/)) {
			if(Rnd.getChance(getVariable(0x44624429L /*AI_MoveWarp*/))) {
				if (changeState(state -> Move_WarpAttack(blendTime)))
					return;
			}
		}
		if (target != null && getTargetHp(target) > 0 && getVariable(0xE5BD13F2L /*_Degree*/) >= 155) {
		...
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9F40743BL /*AI_ES_MinDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x61AC0DF1L /*AI_ES_HP*/)) {
			if(Rnd.getChance(getVariable(0x36D3C519L /*AI_Escape*/))) {
				if (changeState(state -> Move_Escape(0.1)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF79690FDL /*AI_RA_MinDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xA789A0D9L /*AI_RA_HP*/)) {
			if(Rnd.getChance(getVariable(0xE1EDA4F4L /*AI_RunAway*/))) {
				if (changeState(state -> Move_RunAway(0.1)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x11830C8FL /*AI_Ba_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xCE756C6FL /*AI_Ba_HP*/)) {
			if(Rnd.getChance(getVariable(0x3D6C82A2L /*AI_Backstep*/))) {
				if (changeState(state -> Move_BackStep(0.1)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x6B061951L /*AI_MA_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC3FD8E9L /*AI_MA_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x3A82EEFCL /*AI_MA_HP*/) && getVariable(0x81898428L /*AI_MoveAround_PreAction*/) == 1) {
			if(Rnd.getChance(getVariable(0x60A54E45L /*AI_MoveAround*/))) {
				if (changeState(state -> Move_Around_PreAction(0.5)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x6B061951L /*AI_MA_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC3FD8E9L /*AI_MA_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x3A82EEFCL /*AI_MA_HP*/)) {
			if(Rnd.getChance(getVariable(0x60A54E45L /*AI_MoveAround*/))) {
				if (changeState(state -> Move_Around(0.5)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xB3A90433L /*AI_BT_DestructAttack_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x45AEF498L /*AI_BT_DestructAttack_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x7FFDF339L /*AI_BT_DestructAttack*/))) {
				if (changeState(state -> Battle_DestructAttack(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC944200L /*AI_BT_Attack3_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4D2683ABL /*AI_BT_Attack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBDC07D4BL /*AI_BT_Attack3*/))) {
				if (changeState(state -> Battle_Attack3(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x714E207L /*AI_BT_Attack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4DA023BCL /*AI_BT_Attack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x23576610L /*AI_BT_Attack2*/))) {
				if (changeState(state -> Battle_Attack2(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x22CF02DCL /*AI_BT_Attack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x88498267L /*AI_BT_Attack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xAC1AF8EAL /*AI_BT_Attack1*/))) {
				if (changeState(state -> Battle_Attack1(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xE5BD13F2L /*_Degree*/) >= -30 && getVariable(0xE5BD13F2L /*_Degree*/) <= 30 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xF5FA4070L /*AI_BT_ChargeAttack2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xE69565E2L /*AI_BT_ChargeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0x69679F4CL /*AI_BT_ChargeAttack2*/))) {
				if (changeState(state -> Battle_ChargeAttack2(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xE5BD13F2L /*_Degree*/) >= -30 && getVariable(0xE5BD13F2L /*_Degree*/) <= 30 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xC983C8CCL /*AI_BT_ChargeAttack1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xE29339A7L /*AI_BT_ChargeAttack1_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xE468D9D1L /*AI_BT_ChargeAttack1*/))) {
				if (changeState(state -> Battle_ChargeAttack1(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x95DD3572L /*AI_BT_RangeAttack3_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0xB913E239L /*AI_BT_RangeAttack3_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xAFB4C799L /*AI_BT_RangeAttack3_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xBAEE337BL /*AI_BT_RangeAttack3*/))) {
				if (changeState(state -> Battle_RangeAttack3(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xC4CCD61BL /*AI_BT_RangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x1DD7BDC8L /*AI_BT_RangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x8C75F6C5L /*AI_BT_RangeAttack2_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x4F73DC38L /*AI_BT_RangeAttack2_HP*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xA03B8B01L /*AI_BT_RangeAttack2*/))) {
				if (changeState(state -> Battle_RangeAttack2(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2D200EA6L /*AI_BT_RangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xC928C29FL /*AI_BT_RangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9354A910L /*AI_BT_RangeAttack1_MaxDistance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xD947DBACL /*AI_BT_RangeAttack1_HP*/) && getVariable(0xE5BD13F2L /*_Degree*/) >= getVariable(0xBACBD4B0L /*AI_BT_RangeAttack1_MinDegree*/) && getVariable(0xE5BD13F2L /*_Degree*/) <= getVariable(0x424127F0L /*AI_BT_RangeAttack1_MaxDegree*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(getVariable(0xDAB0B4A8L /*AI_BT_RangeAttack1*/))) {
				if (changeState(state -> Battle_RangeAttack1(0.3)))
					return;
			}
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0x101CB71DL /*AI_EC_HighSpeedChase*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x101CB71DL /*AI_EC_HighSpeedChase*/)) {
			if (changeState(state -> HighSpeed_Chaser(0.1)))
				return;
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xBE61A9BCL /*AI_Chaser_PreAction*/) == 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x5103FB80L /*AI_EC_Distance*/)) {
			if (changeState(state -> Move_Chaser_PreAction(0.1)))
				return;
		}
		if (target != null && target != null && getTargetHp(target) > 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x5103FB80L /*AI_EC_Distance*/)) {
			if (changeState(state -> Move_Chaser(0.5)))
				return;
		}
	...
	protected void Battle_Wait_Swim(double blendTime) {
		...
		doAction(2820327238L /*BATTLE_WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Battle_Wait_Swim(blendTime), 200));
	}
	...
	protected void Lost_Target_Swim(double blendTime) {
		...
		doAction(902766309L /*BATTLE_WAIT_SWIM*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Return(blendTime), 500));
	}
	...
	protected void Special_Chase(double blendTime) {
		...
		if (getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x42FDA76EL /*AI_Special_Action_Distance*/)) {
			if (changeState(state -> Special_Action(0.3)))
				return;
		}
		if (getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0x468D3572L /*AI_EC_LimitDistance*/) && getVariable(0x7492188CL /*_FailFindPath*/) > 1 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
		...
		doAction(1471226122L /*SPECIAL_CHASER*/, blendTime, onDoActionEnd -> chase(10, () -> {
			return false;
		}, onExit -> scheduleState(state -> Special_Chase(blendTime), 500)));
	}
	...
	protected void Battle_RangeAttack3(double blendTime) {
		...
		setState(0x395B66CCL /*Battle_RangeAttack3*/);
							if (getVariable(0x4EA7E3D1L /*AI_BT_RangeAttack3_RotateOff*/) == 1) {
	...
	protected void Battle_RangeAttack3_Rotate(double blendTime) {
		...
		doAction(4032514383L /*BATTLE_RANGEATTACK3*/, blendTime, onDoActionEnd -> {
			if (getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) != 999) {
				setVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/, getVariable(0x8E6F3126L /*AI_BT_RangeAttack3_ShotBullet*/) - 1);
			}
			changeState(state -> Battle_Wait(blendTime));
		});
	}
	...
	protected void Damage_RangeAttack1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x2F2E4D90L /*Damage_RangeAttack1*/);
		if (isTargetLost()) {
			if (changeState(state -> Lost_Target(blendTime)))
				return;
		}
		if (getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) != 999) {
			setVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/, getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) - 1);
		}
		doAction(827804183L /*DAMAGE_RANGEATTACK1*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}

	protected void Damage_RangeAttack2(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x6BBC2F80L /*Damage_RangeAttack2*/);
		if (isTargetLost()) {
			if (changeState(state -> Lost_Target(blendTime)))
				return;
		}
		if (getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) != 999) {
			setVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/, getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) - 1);
		}
		doAction(1058790415L /*DAMAGE_RANGEATTACK2*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Battle_Death(double blendTime) {
		...
		doAction(2544805566L /*DIE*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 2000));
	}
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 0 && (getState() == 0xCF465EDCL /*Search_Enemy*/ || getState() == 0xB3CBD2A4L /*Search_Enemy_GoChase*/)) {
			if (changeState(state -> Battle_Wait(0.5)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x71F28994L /*Battle_Wait*/ || getState() == 0x39B3FBC2L /*Move_Chaser*/ || getState() == 0x4C327D19L /*HighSpeed_Chaser*/ || getState() == 0x55F437ADL /*Move_Around*/ || getState() == 0xCF465EDCL /*Search_Enemy*/ || getState() == 0xB3CBD2A4L /*Search_Enemy_GoChase*/ || getState() == 0x67695F37L /*Lost_Target*/ || getState() == 0xB5FDC949L /*Battle_Attack1*/ || getState() == 0xC349CD1FL /*Battle_RangeAttack1*/ || getState() == 0xC0FB5440L /*Damage_Normal*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0xBE9509ECL /*AI_Damage_Normal*/) == 1 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> Damage_Normal(0.1)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x881B0A76L /*Start_Action*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0x3BC297BEL /*AI_Run_Random_Set*/) >= 1 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> Run_Random(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x838FBB02L /*Move_ParentPath*/ || getState() == 0xBCCBD2E0L /*Move_ChaseToParent*/ || getState() == 0x455AE195L /*Move_Random_End*/ || getState() == 0x8D36275BL /*Move_Random_EndAction*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x881B0A76L /*Start_Action*/ || getState() == 0xA2EDFBF7L /*CheckLevel_RunAway*/ || getState() == 0xF44A9B48L /*CheckLevel_Escape*/ || getState() == 0xA664004CL /*Wait_CheckLevel*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0x60A05FC4L /*AI_FA_SufferAction_Set*/) >= 1 && getVariable(0x8816D447L /*_Weapon_Out*/) == 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> Search_Enemy(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x838FBB02L /*Move_ParentPath*/ || getState() == 0xBCCBD2E0L /*Move_ChaseToParent*/ || getState() == 0x455AE195L /*Move_Random_End*/ || getState() == 0x8D36275BL /*Move_Random_EndAction*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x881B0A76L /*Start_Action*/ || getState() == 0xA2EDFBF7L /*CheckLevel_RunAway*/ || getState() == 0xF44A9B48L /*CheckLevel_Escape*/ || getState() == 0xA664004CL /*Wait_CheckLevel*/ || getState() == 0xCF465EDCL /*Search_Enemy*/ || getState() == 0xB3CBD2A4L /*Search_Enemy_GoChase*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0x8816D447L /*_Weapon_Out*/) == 1 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> Weapon_Out(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((getState() == 0x866C7489L /*Wait*/ || getState() == 0x838FBB02L /*Move_ParentPath*/ || getState() == 0xBCCBD2E0L /*Move_ChaseToParent*/ || getState() == 0x455AE195L /*Move_Random_End*/ || getState() == 0x8D36275BL /*Move_Random_EndAction*/ || getState() == 0x8377635AL /*Move_Random*/ || getState() == 0x881B0A76L /*Start_Action*/ || getState() == 0xA2EDFBF7L /*CheckLevel_RunAway*/ || getState() == 0xF44A9B48L /*CheckLevel_Escape*/ || getState() == 0xA664004CL /*Wait_CheckLevel*/ || getState() == 0xCF465EDCL /*Search_Enemy*/ || getState() == 0xB3CBD2A4L /*Search_Enemy_GoChase*/ || getState() == 0xFA1508C0L /*Movepoint_End*/ || getState() == 0x244DE952L /*Movepoint_Logic*/ || getState() == 0x8F2D3B47L /*Move_WayPoint*/ || getState() == 0x9554FCBFL /*Move_WayPoint2*/ || getState() == 0x782710B0L /*Move_WayPoint3*/ || getState() == 0x750B7E6EL /*Move_WayPoint4*/ || getState() == 0x7897BB6FL /*Move_WayPoint5*/) && getVariable(0x60A05FC4L /*AI_FA_SufferAction_Set*/) == 0 && getVariable(0x8816D447L /*_Weapon_Out*/) == 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) != 0 && getVariable(0x870CD143L /*_IsPartyMember*/) == 0) {
			if (changeState(state -> Battle_Wait(0.5)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		return EAiHandlerResult.BYPASS;
	...
	public EAiHandlerResult HandleStop(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if ((getState() != 0xBF725BC4L /*Damage_KnockBack*/ || getState() != 0x3FB3341CL /*Damage_Stun*/ || getState() != 0x69E1FC3AL /*Damage_KnockDown*/ || getState() != 0x119675D3L /*Damage_Bound*/ || getState() != 0x5374AB60L /*Damage_Capture*/ || getState() != 0x6A4B0B1DL /*Damage_Rigid*/ || getState() != 0x82D0AC8EL /*Damage_Release*/ || getState() != 0x4E1B659L /*Damage_Die*/) && target != null && (getTargetCharacterKey(target) == getVariable(0x4E36E74L /*AI_Stop_CharacterKey1*/) || getTargetCharacterKey(target) == getVariable(0x5FE07E6L /*AI_Stop_CharacterKey2*/) || getTargetCharacterKey(target) == getVariable(0xBE8B8DBBL /*AI_Stop_CharacterKey3*/) || getTargetCharacterKey(target) == getVariable(0x54D4B658L /*AI_Stop_CharacterKey4*/) || getTargetCharacterKey(target) == getVariable(0xC996B53L /*AI_Stop_CharacterKey5*/))) {
	...
	public EAiHandlerResult HandleTakeTeamDamage(Creature sender, Integer[] eventData) {
		...
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x1C36219AL /*AI_FA_SufferRangeAttack1_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBDFADB2BL /*AI_FA_SufferRangeAttack1_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x15FA9EFFL /*AI_FA_SufferRangeAttack1_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x2CC412D5L /*AI_FA_SufferRangeAttack1*/))) {
				if (changeState(state -> Damage_RangeAttack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x866C7489L /*Wait*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		...
		if (getState() == 0x8377635AL /*Move_Random*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9AE09B3DL /*AI_FA_SufferAttack1_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0xE507A51FL /*AI_FA_SufferAttack1*/))) {
				if (changeState(state -> Damage_Attack1(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		}
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x616E53A8L /*AI_FA_SufferAttack2_Distance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x11BFED07L /*AI_FA_SufferAttack2*/))) {
				if (changeState(state -> Damage_Attack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
		...
		if (getState() == 0x881B0A76L /*Start_Action*/ && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x2EF68FB1L /*AI_FA_SufferRangeAttack2_ShotBullet*/) > 0 && getVariable(0xF630F33AL /*_Distance*/) >= getVariable(0xBFB12608L /*AI_FA_SufferRangeAttack2_MinDistance*/) && getVariable(0xF630F33AL /*_Distance*/) <= getVariable(0x9BF46731L /*AI_FA_SufferRangeAttack2_MaxDistance*/) && getVariable(0x870CD143L /*_IsPartyMember*/) == 1) {
			if(Rnd.getChance(getVariable(0x94035B9BL /*AI_FA_SufferRangeAttack2*/))) {
				if (changeState(state -> Damage_RangeAttack2(0.3)))
					return EAiHandlerResult.CHANGE_STATE;
			}
