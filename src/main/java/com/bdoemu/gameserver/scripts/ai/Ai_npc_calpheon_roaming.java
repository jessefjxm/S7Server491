...
@IAIName("npc_calpheon_roaming")
public class Ai_npc_calpheon_roaming extends CreatureAI {
	public Ai_npc_calpheon_roaming(Creature actor, Map<Long, Integer> aiVariables) {
