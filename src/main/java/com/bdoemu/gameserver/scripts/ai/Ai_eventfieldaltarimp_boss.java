...
@IAIName("eventfieldaltarimp_boss")
public class Ai_eventfieldaltarimp_boss extends CreatureAI {
	public Ai_eventfieldaltarimp_boss(Creature actor, Map<Long, Integer> aiVariables) {
