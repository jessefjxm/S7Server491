...
@IAIName("ancientredorcelder_boss")
public class Ai_ancientredorcelder_boss extends CreatureAI {
	public Ai_ancientredorcelder_boss(Creature actor, Map<Long, Integer> aiVariables) {
