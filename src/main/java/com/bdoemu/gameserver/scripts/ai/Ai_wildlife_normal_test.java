...
@IAIName("wildlife_normal_test")
public class Ai_wildlife_normal_test extends CreatureAI {
	public Ai_wildlife_normal_test(Creature actor, Map<Long, Integer> aiVariables) {
