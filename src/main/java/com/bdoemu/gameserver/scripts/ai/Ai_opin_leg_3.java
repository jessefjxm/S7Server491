...
@IAIName("opin_leg_3")
public class Ai_opin_leg_3 extends CreatureAI {
	public Ai_opin_leg_3(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Before_Die(double blendTime) {
		...
		getObjects(EAIFindTargetType.Parent, object -> true).forEach(consumer -> consumer.getAi().DestroyLeg3(getActor(), null));
