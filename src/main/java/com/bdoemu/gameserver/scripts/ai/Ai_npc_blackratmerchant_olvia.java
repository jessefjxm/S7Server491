...
@IAIName("npc_blackratmerchant_olvia")
public class Ai_npc_blackratmerchant_olvia extends CreatureAI {
	public Ai_npc_blackratmerchant_olvia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void GoToHomePosition(double blendTime) {
		...
		doAction(2731866410L /*GOHOME_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_40719_10", ENaviType.ground, () -> {
	...
	protected void GoBackPosition(double blendTime) {
		...
		doAction(1339848291L /*GOBACK_2*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRatMerchant_40719_1", ENaviType.ground, () -> {
