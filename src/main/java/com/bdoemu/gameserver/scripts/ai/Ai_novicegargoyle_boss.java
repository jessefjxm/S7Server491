...
@IAIName("novicegargoyle_boss")
public class Ai_novicegargoyle_boss extends CreatureAI {
	public Ai_novicegargoyle_boss(Creature actor, Map<Long, Integer> aiVariables) {
