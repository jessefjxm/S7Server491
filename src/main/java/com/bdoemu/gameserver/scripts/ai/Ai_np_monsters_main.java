...
@IAIName("np_monsters_main")
public class Ai_np_monsters_main extends CreatureAI {
	public Ai_np_monsters_main(Creature actor, Map<Long, Integer> aiVariables) {
	...
	public EAiHandlerResult HandleTargetInMyArea(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xD110DC99L /*_IsWaterType*/) == 0 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && target != null && getTargetHp(target) > 0 && target != null && getTargetLevel(target) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && target != null && isTargetDeliver(target) && target != null && isCreatureVisible(target, false)) {
			getActor().getAggroList().addCreature(sender.getAggroList().getTarget());
			if (changeState(state -> Search_Enemy(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xD110DC99L /*_IsWaterType*/) == 1 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && target != null && getTargetHp(target) > 0 && target != null && getTargetLevel(target) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && target != null && isCreatureVisible(target, false)) {
			getActor().getAggroList().addCreature(sender.getAggroList().getTarget());
			if (changeState(state -> Search_Enemy_Swim(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xD110DC99L /*_IsWaterType*/) == 0 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && target != null && getTargetHp(target) > 0 && target != null && getTargetLevel(target) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && target != null && getAngleToTarget(target) >= getVariable(0x8FFEA5EBL /*AI_SearchEnemy_MinDegree*/) && target != null && getAngleToTarget(target) <= getVariable(0xB8902B20L /*AI_SearchEnemy_MaxDegree*/) && target != null && isTargetDeliver(target) && target != null && isCreatureVisible(target, false)) {
			getActor().getAggroList().addCreature(sender.getAggroList().getTarget());
			if (changeState(state -> Battle_Wait(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		if ((!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect)))) && getVariable(0xD110DC99L /*_IsWaterType*/) == 1 && getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && target != null && getTargetHp(target) > 0 && target != null && getTargetLevel(target) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && target != null && getAngleToTarget(target) >= getVariable(0x8FFEA5EBL /*AI_SearchEnemy_MinDegree*/) && target != null && getAngleToTarget(target) <= getVariable(0xB8902B20L /*AI_SearchEnemy_MaxDegree*/) && target != null && isCreatureVisible(target, false)) {
			getActor().getAggroList().addCreature(sender.getAggroList().getTarget());
			if (changeState(state -> Battle_Wait_Swim(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
