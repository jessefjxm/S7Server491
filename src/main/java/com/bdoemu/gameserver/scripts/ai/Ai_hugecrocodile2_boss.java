...
@IAIName("hugecrocodile2_boss")
public class Ai_hugecrocodile2_boss extends CreatureAI {
	public Ai_hugecrocodile2_boss(Creature actor, Map<Long, Integer> aiVariables) {
