...
@IAIName("hugecrocodile1_boss")
public class Ai_hugecrocodile1_boss extends CreatureAI {
	public Ai_hugecrocodile1_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Random(double blendTime) {
		...
		doAction(633942026L /*MOVE_WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.Random, 0, 0, 0, 3750, 4500, false, ENaviType.ground, () -> {
