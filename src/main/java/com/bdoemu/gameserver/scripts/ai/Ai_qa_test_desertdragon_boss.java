...
@IAIName("qa_test_desertdragon_boss")
public class Ai_qa_test_desertdragon_boss extends CreatureAI {
	public Ai_qa_test_desertdragon_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x6E0E85B9L /*_AttackCount*/) > 15 && getPartyMembersCount()<= 0) {
			if(Rnd.getChance(10)) {
