...
@IAIName("itemhighranknovicemuscan")
public class Ai_itemhighranknovicemuscan extends CreatureAI {
	public Ai_itemhighranknovicemuscan(Creature actor, Map<Long, Integer> aiVariables) {
