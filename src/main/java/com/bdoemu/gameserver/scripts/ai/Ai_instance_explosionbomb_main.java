...
@IAIName("instance_explosionbomb_main")
public class Ai_instance_explosionbomb_main extends CreatureAI {
	public Ai_instance_explosionbomb_main(Creature actor, Map<Long, Integer> aiVariables) {
