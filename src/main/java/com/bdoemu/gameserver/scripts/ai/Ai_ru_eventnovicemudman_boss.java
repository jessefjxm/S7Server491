...
@IAIName("ru_eventnovicemudman_boss")
public class Ai_ru_eventnovicemudman_boss extends CreatureAI {
	public Ai_ru_eventnovicemudman_boss(Creature actor, Map<Long, Integer> aiVariables) {
