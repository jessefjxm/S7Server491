...
@IAIName("partytype_arrow_guard")
public class Ai_partytype_arrow_guard extends CreatureAI {
	public Ai_partytype_arrow_guard(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 1 && getVariable(0xCBEEF8C7L /*_OwnerDistance*/) > 3500) {
			if (changeState(state -> Move_ReturnToParent_Clear(0.3)))
				return;
		}
		if (target == null) {
		...
		if (target != null && getDistanceToTarget(target) > 2200 && target != null && getTargetHp(target) > 0) {
		...
		if (target != null && getDistanceToTarget(target) >= 0 && target != null && getDistanceToTarget(target) <= 2000 && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(50)) {
				if (changeState(state -> Around_RangeAttack1(0.3)))
					return;
			}
		}
		if (target != null && (getDistanceToTarget(target, false) >= 0 && getDistanceToTarget(target, false) <= 2400) && target != null && getTargetHp(target) > 0) {
	...
	protected void Move_Chaser(double blendTime) {
		...
		if (getVariable(0x870CD143L /*_IsPartyMember*/) == 1 && getVariable(0xCBEEF8C7L /*_OwnerDistance*/) > 4500) {
			if(getCallCount() == 40) {
				if (changeState(state -> Move_ReturnToParent_Clear(0.3)))
					return;
			}
	...
	protected void Move_ParentPath(double blendTime) {
		...
		doAction(3453972949L /*CHASER_WALK*/, blendTime, onDoActionEnd -> move(EAIMoveDestType.OwnerPosition, 0, 0, 0, 0, 1, false, ENaviType.ground, () -> {
			setVariable(0x444DFF4EL /*_isFindPathCompleted*/, isFindPathCompleted());
			if (getVariable(0x444DFF4EL /*_isFindPathCompleted*/) == 0) {
				if (changeState(state -> FailFindPath_Logic(0.3)))
					return true;
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getState() != 0x71F28994L /*Battle_Wait*/ && getState() != 0x39B3FBC2L /*Move_Chaser*/ && getState() != 0xEECD0FB6L /*Battle_Attack*/ && getState() != 0xCB4271F4L /*Battle_Attack_2*/ && getState() != 0x92CAF548L /*Battle_Attack_3*/ && getState() != 0x4C99FC96L /*Around_RangeAttack1*/) {
			if (changeState(state -> Battle_Wait(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		return EAiHandlerResult.BYPASS;
	...
	public EAiHandlerResult HandleTakeTeamDamage(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (getState() != 0x71F28994L /*Battle_Wait*/ && getState() != 0x39B3FBC2L /*Move_Chaser*/ && getState() != 0xEECD0FB6L /*Battle_Attack*/ && getState() != 0xCB4271F4L /*Battle_Attack_2*/ && getState() != 0x92CAF548L /*Battle_Attack_3*/ && getState() != 0x4C99FC96L /*Around_RangeAttack1*/ && getState() != 0x1471881CL /*Move_ReturnToParent*/) {
			if (changeState(state -> Battle_Wait(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
		return EAiHandlerResult.BYPASS;
