...
@IAIName("alter_4_attackplayer_norange")
public class Ai_alter_4_attackplayer_norange extends CreatureAI {
	public Ai_alter_4_attackplayer_norange(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Target_Change(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Player, EAIFindType.nearest, false, object -> getDistanceToTarget(object) < 1200)) {
