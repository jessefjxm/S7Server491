...
@IAIName("npc_ship_transport_altinova_to_eferia")
public class Ai_npc_ship_transport_altinova_to_eferia extends CreatureAI {
	public Ai_npc_ship_transport_altinova_to_eferia(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void FirstGo(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveToWaypoint("carriage", "TranportShipEferiatoAltinova_0001 TranportShipEferiatoAltinova_0031", ENaviType.ground, () -> {
			return false;
