...
@IAIName("party_leader_wanderergargoyle_ghost")
public class Ai_party_leader_wanderergargoyle_ghost extends CreatureAI {
	public Ai_party_leader_wanderergargoyle_ghost(Creature actor, Map<Long, Integer> aiVariables) {
