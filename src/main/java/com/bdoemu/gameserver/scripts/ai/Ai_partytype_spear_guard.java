...
@IAIName("partytype_spear_guard")
public class Ai_partytype_spear_guard extends CreatureAI {
	public Ai_partytype_spear_guard(Creature actor, Map<Long, Integer> aiVariables) {
