...
@IAIName("alter_shrine")
public class Ai_alter_shrine extends CreatureAI {
	public Ai_alter_shrine(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_80_Logic(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_DAMAGE_1STAGE_80");
	...
	protected void Wait_60_Logic(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_DAMAGE_1STAGE_60");
	...
	protected void Wait_40_Logic(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_DAMAGE_1STAGE_40");
	...
	protected void Wait_20_Logic(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_DAMAGE_1STAGE_20");
	...
	protected void Die_Logic(double blendTime) {
		...
		instanceNotify(EChatNoticeType.Defence, "GAME", "LUA_DEFENCE_ALTER_DAMAGE_1STAGE_0");
