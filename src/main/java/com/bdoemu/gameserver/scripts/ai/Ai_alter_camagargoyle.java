...
@IAIName("alter_camagargoyle")
public class Ai_alter_camagargoyle extends CreatureAI {
	public Ai_alter_camagargoyle(Creature actor, Map<Long, Integer> aiVariables) {
