...
@IAIName("opin_leg_4")
public class Ai_opin_leg_4 extends CreatureAI {
	public Ai_opin_leg_4(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Before_Die(double blendTime) {
		...
		getObjects(EAIFindTargetType.Parent, object -> true).forEach(consumer -> consumer.getAi().DestroyLeg4(getActor(), null));
