...
@IAIName("w232croncastle_gate")
public class Ai_w232croncastle_gate extends CreatureAI {
	public Ai_w232croncastle_gate(Creature actor, Map<Long, Integer> aiVariables) {
