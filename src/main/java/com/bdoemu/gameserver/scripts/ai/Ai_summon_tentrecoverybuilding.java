...
@IAIName("summon_tentrecoverybuilding")
public class Ai_summon_tentrecoverybuilding extends CreatureAI {
	public Ai_summon_tentrecoverybuilding(Creature actor, Map<Long, Integer> aiVariables) {
