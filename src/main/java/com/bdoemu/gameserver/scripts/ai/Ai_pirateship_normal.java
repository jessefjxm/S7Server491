...
@IAIName("pirateship_normal")
public class Ai_pirateship_normal extends CreatureAI {
	public Ai_pirateship_normal(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Attack_End_Logic(double blendTime) {
		...
		if (getVariable(0x6E0E85B9L /*_AttackCount*/) > 18 && target != null && getDistanceToTarget(target) < 2000) {
			if (changeState(state -> Escape(0.3)))
				return;
		}
		if (getVariable(0x6E0E85B9L /*_AttackCount*/) >= 18) {
	...
	protected void Move_Random(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Enemy, EAIFindType.normal, false, object -> getTargetHp(object) > 0 && getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= 8000 && isCreatureVisible(object, false))) {
	...
	protected void Chaser_Run_At(double blendTime) {
		...
		if (target != null && getAngleToTarget(target) >= 48 && target != null && getAngleToTarget(target) < 113 && target != null && getDistanceToTarget(target) <= 2500 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(getCallCount() == 12) {
				if (changeState(state -> Move_Attack_R(1.5)))
					return;
			}
		}
		if (target != null && getAngleToTarget(target) <= -48 && target != null && getAngleToTarget(target) > -113 && target != null && getDistanceToTarget(target) <= 2500 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(getCallCount() == 12) {
				if (changeState(state -> Move_Attack_L(1.5)))
					return;
			}
		}
