...
@IAIName("alter_highfieldstonegolem_boss")
public class Ai_alter_highfieldstonegolem_boss extends CreatureAI {
	public Ai_alter_highfieldstonegolem_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xC19EE3CDL /*_StompCount*/) >= 4) {
			if (changeState(state -> Attack_General2(0.3)))
				return;
		}
