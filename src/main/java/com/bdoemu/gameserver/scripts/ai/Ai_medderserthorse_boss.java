...
@IAIName("medderserthorse_boss")
public class Ai_medderserthorse_boss extends CreatureAI {
	public Ai_medderserthorse_boss(Creature actor, Map<Long, Integer> aiVariables) {
