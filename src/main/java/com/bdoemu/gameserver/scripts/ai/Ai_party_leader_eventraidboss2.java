...
@IAIName("party_leader_eventraidboss2")
public class Ai_party_leader_eventraidboss2 extends CreatureAI {
	public Ai_party_leader_eventraidboss2(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Teleport1(double blendTime) {
		...
		setVariableArray(0x68C5BE96L /*WaypointValue1*/, new Integer[] { 4, 39571 });
	...
	protected void Teleport2(double blendTime) {
		...
		setVariableArray(0xF99872EDL /*WaypointValue2*/, new Integer[] { 4, 39569 });
