...
@IAIName("alter_monsters_main_norange")
public class Ai_alter_monsters_main_norange extends CreatureAI {
	public Ai_alter_monsters_main_norange(Creature actor, Map<Long, Integer> aiVariables) {
