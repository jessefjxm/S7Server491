...
@IAIName("npc_ship_transport_tarif_calpheon")
public class Ai_npc_ship_transport_tarif_calpheon extends CreatureAI {
	public Ai_npc_ship_transport_tarif_calpheon(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void FirstGo(double blendTime) {
		...
		doAction(2337397317L /*MOVE*/, blendTime, onDoActionEnd -> moveToWaypoint("carriage", "transport_ship_loop_0002 transport_ship_loop_0076 transport_ship_loop_0276", ENaviType.ground, () -> {
			return false;
