...
@IAIName("m0156_camatwinheadent")
public class Ai_m0156_camatwinheadent extends CreatureAI {
	public Ai_m0156_camatwinheadent(Creature actor, Map<Long, Integer> aiVariables) {
