...
@IAIName("npc_spidertown_roaming")
public class Ai_npc_spidertown_roaming extends CreatureAI {
	public Ai_npc_spidertown_roaming(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Select_Position(double blendTime) {
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 10 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 11) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 32663 });
		}
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 11 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 12) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 27380 });
		}
