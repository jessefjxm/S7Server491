...
@IAIName("summer_hammer")
public class Ai_summer_hammer extends CreatureAI {
	public Ai_summer_hammer(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Ready(double blendTime) {
		...
		doAction(2752325056L /*JUMP*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait(blendTime), 1000));
	}
