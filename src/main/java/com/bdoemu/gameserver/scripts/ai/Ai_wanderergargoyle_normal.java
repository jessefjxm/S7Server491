...
@IAIName("wanderergargoyle_normal")
public class Ai_wanderergargoyle_normal extends CreatureAI {
	public Ai_wanderergargoyle_normal(Creature actor, Map<Long, Integer> aiVariables) {
