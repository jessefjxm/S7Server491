...
@IAIName("pet_longtailedtit_4er")
public class Ai_pet_longtailedtit_4er extends CreatureAI {
	public Ai_pet_longtailedtit_4er(Creature actor, Map<Long, Integer> aiVariables) {
