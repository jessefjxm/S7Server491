...
@IAIName("w102_notmove_c")
public class Ai_w102_notmove_c extends CreatureAI {
	public Ai_w102_notmove_c(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Die_Wait(double blendTime) {
		...
		doAction(1569894142L /*WAIT_1*/, blendTime, onDoActionEnd -> scheduleState(state -> Suicide_Die(blendTime), 3000));
	}
