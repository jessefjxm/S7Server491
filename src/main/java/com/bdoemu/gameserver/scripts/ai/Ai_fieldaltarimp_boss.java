...
@IAIName("fieldaltarimp_boss")
public class Ai_fieldaltarimp_boss extends CreatureAI {
	public Ai_fieldaltarimp_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> CheckSpawn_Logic(blendTime), 500));
	}
	...
	protected void CheckSpawn_Logic(double blendTime) {
		...
		if (findTarget(EAIFindTargetType.Monster, EAIFindType.normal, true, object -> getDistanceToTarget(object) < 4000 && getTargetCharacterKey(object) == 23069)) {
	...
	protected void Notifier_Logic(double blendTime) {
		...
		worldNotify(EChatNoticeType.Nuberu, "GAME", "LUA_ALTERIMPBOSS_SPAWN");
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0xA20D0C7BL /*_AttackNormalCount*/) >= 3 && target != null && getDistanceToTarget(target) < 1200 && target != null && getAngleToTarget(target) > -25 && target != null && getAngleToTarget(target) < 25 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if (changeState(state -> Attack_Hook_Normal_1(0.3)))
				return;
		}
		...
		if (target != null && getDistanceToTarget(target) < 600 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(Rnd.getChance(60)) {
				if (changeState(state -> Attack_Swing_Normal_1(0.3)))
					return;
			}
		}
		if (target != null && getDistanceToTarget(target) < 1200 && target != null && getAngleToTarget(target) > -25 && target != null && getAngleToTarget(target) < 25 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/)) {
			if(Rnd.getChance(40)) {
				if (changeState(state -> Attack_HookRunSwing(0.3)))
					return;
			}
		}
	...
	protected void Back_Walk(double blendTime) {
		...
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(919797391L /*BACK_WALK*/, blendTime, onDoActionEnd -> changeState(state -> Attack_Hook_Normal_1(blendTime)));
	}
	...
	protected void Attack_Hook_Normal_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x5DA386C9L /*Attack_Hook_Normal_Logic*/);
		if(Rnd.getChance(70)) {
			if (changeState(state -> Attack_Hook_Normal_2(blendTime)))
				return;
		}
		if(Rnd.getChance(50)) {
			if (changeState(state -> Attack_Hook_Normal_1(blendTime)))
				return;
		}
		changeState(state -> Attack_Hook_Normal(blendTime));
	}
	...
	protected void Attack_Hook_Normal_1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x84A20F18L /*Attack_Hook_Normal_1*/);
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 1);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, 0);
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(939911744L /*ATTACK_HOOK1_1*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}

	protected void Attack_Hook_Normal_2(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x13528748L /*Attack_Hook_Normal_2*/);
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 1);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, 0);
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(543725736L /*ATTACK_HOOK1_2*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Swing_Normal_Logic(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.none);
		setState(0x9758FBEDL /*Attack_Swing_Normal_Logic*/);
		if(Rnd.getChance(70)) {
			if (changeState(state -> Attack_Swing_Normal_2(blendTime)))
				return;
		}
		if(Rnd.getChance(50)) {
			if (changeState(state -> Attack_Swing_Normal_1(blendTime)))
				return;
		}
		changeState(state -> Attack_Swing_Normal(blendTime));
	}
	...
	protected void Attack_Swing_Normal_1(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0xCBF053A2L /*Attack_Swing_Normal_1*/);
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 1);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, getVariable(0xA20D0C7BL /*_AttackNormalCount*/) + 1);
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(2101682868L /*ATTACK_HOOKSWING1_1*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}

	protected void Attack_Swing_Normal_2(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x56DF689FL /*Attack_Swing_Normal_2*/);
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 1);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, getVariable(0xA20D0C7BL /*_AttackNormalCount*/) + 1);
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(2482848672L /*ATTACK_HOOKSWING1_2*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_HookRunSwing(double blendTime) {
		Creature target = getTarget();
		setBehavior(EAIBehavior.action);
		setState(0x12418E1L /*Attack_HookRunSwing*/);
		setVariable(0x3826DD12L /*_CrazySwingAttCount*/, getVariable(0x3826DD12L /*_CrazySwingAttCount*/) + 1);
		setVariable(0xA20D0C7BL /*_AttackNormalCount*/, 0);
		setVariable(0xD69E34BBL /*_StunDelay_IngTime*/, getTime());
		setVariable(0x8AC22F24L /*_StunDelay_EndTime*/, getVariable(0xD69E34BBL /*_StunDelay_IngTime*/) - getVariable(0x1E2360D6L /*_StunDelay_StartTime*/));
		doAction(3576471314L /*ATTACK_HOOKRUNSWING*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Delete_Die_Logic(double blendTime) {
		...
		worldNotify(EChatNoticeType.Nuberu, "GAME", "LUA_ALTERIMPBOSS_TIMEOUT");
