...
@IAIName("monsters_main_range")
public class Ai_monsters_main_range extends CreatureAI {
	public Ai_monsters_main_range(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Start_Action(double blendTime) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x7DFA4FFDL /*AI_BT_Summon1*/) > 0 && getPartyMembersCount()<= getVariable(0x2577BBB2L /*AI_BT_Summon1_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0x82A6D61AL /*_SummonCount1*/) >= 1 && target != null && getDistanceToTarget(target) <= getVariable(0xF5CF1EE5L /*AI_BT_Summon1_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0x26D1B2E6L /*AI_BT_Summon1_HP*/)) {
			if(Rnd.getChance(getVariable(0x7DFA4FFDL /*AI_BT_Summon1*/))) {
				if (changeState(state -> Battle_Summon1(0.3)))
					return;
			}
		}
		if (getVariable(0x2CCF3240L /*AI_BT_Summon2*/) > 0 && getPartyMembersCount()<= getVariable(0xB6A7EA69L /*AI_BT_Summon2_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xEE6747DL /*_SummonCount2*/) >= 1 && target != null && getDistanceToTarget(target) <= getVariable(0x1D38150EL /*AI_BT_Summon2_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xBC8E6618L /*AI_BT_Summon2_HP*/)) {
			if(Rnd.getChance(getVariable(0x2CCF3240L /*AI_BT_Summon2*/))) {
				if (changeState(state -> Battle_Summon2(0.3)))
					return;
			}
		}
		if (getVariable(0xA71DD0EFL /*AI_BT_Summon3*/) > 0 && getPartyMembersCount()<= getVariable(0x920F2D8DL /*AI_BT_Summon3_MemberCount*/) && target != null && target != null && getTargetHp(target) > 0 && getVariable(0x2D70D5BBL /*AI_AttackerType*/) == 1 && getVariable(0xB9D9DDBAL /*_SummonCount3*/) >= 1 && target != null && getDistanceToTarget(target) <= getVariable(0x6930A994L /*AI_BT_Summon3_Distance*/) && getVariable(0x3F487035L /*_HP*/) <= getVariable(0xC7E8981DL /*AI_BT_Summon3_HP*/)) {
	...
	protected void Lost_Target_Swim(double blendTime) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) >= 1 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTargetInAggro(EAIFindTargetType.Player, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Search_Enemy_Swim(0.1)))
					return;
			}
		}
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 1 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTargetInAggro(EAIFindTargetType.Player, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
		...
		if (getVariable(0xE6D1989CL /*AI_FA_DetectAction_Set*/) <= 0 && getVariable(0xE97DEBF8L /*AI_EnemyChase*/) == 0 && getVariable(0x4EAF441FL /*AI_FirstAttack*/) == 1 && (!((getTargetCollectorEquipmentGrade(target) > 2 && getTargetBattleAimedActionType(target, EBattleAimedActionType.Creep)) || (getTargetCollectorEquipmentGrade(target) > 2 && getTargetActionType(target, EActionType.Collect))))) {
			if (findTargetInAggro(EAIFindTargetType.Player, EAIFindType.normal, object -> getDistanceToTarget(object, false) >= 0 && getDistanceToTarget(object, false) <= getVariable(0x385C5340L /*AI_FA_DetectDistance*/) && getTargetHp(object) > 0 && getTargetLevel(object) <= getVariable(0x233F196EL /*AI_CheckLevel*/) && isCreatureVisible(object, false))) {
				if (changeState(state -> Battle_Wait_Swim(0.3)))
					return;
			}
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		...
		if (getVariable(0xF4CC376DL /*_AlertAction*/) == 1 && getVariable(0xFA9DA674L /*_IsBattleMode*/) == 0 && getVariable(0x1408C89EL /*_IsAlert*/) == 0) {
