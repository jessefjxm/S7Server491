...
@IAIName("alter_5_attackplayer")
public class Ai_alter_5_attackplayer extends CreatureAI {
	public Ai_alter_5_attackplayer(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Return(double blendTime) {
		...
		if (checkParentInstanceTeamNo()) {
			if (findTarget(EAIFindTargetType.Monster, EAIFindType.nearest, true, object -> getDistanceToTarget(object) < 10000 && getTargetCharacterKey(object) == 27138)) {
				if (changeState(state -> Return_Shrine(blendTime)))
					return;
			}
		}
