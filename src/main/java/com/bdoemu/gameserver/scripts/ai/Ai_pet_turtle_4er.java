...
@IAIName("pet_turtle_4er")
public class Ai_pet_turtle_4er extends CreatureAI {
	public Ai_pet_turtle_4er(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_Summon0(double blendTime) {
		...
		doAction(1838314136L /*WAIT_CHASE0*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon1(double blendTime) {
		...
		doAction(3907794696L /*WAIT_CHASE1*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon2(double blendTime) {
		...
		doAction(3615267321L /*WAIT_CHASE2*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon3(double blendTime) {
		...
		doAction(1992840723L /*WAIT_CHASE3*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon4(double blendTime) {
		...
		doAction(2660320149L /*WAIT_CHASE4*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon5(double blendTime) {
		...
		doAction(6925940L /*WAIT_CHASE5*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon6(double blendTime) {
		...
		doAction(1001580925L /*WAIT_CHASE6*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon7(double blendTime) {
		...
		doAction(1543026602L /*WAIT_CHASE7*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon8(double blendTime) {
		...
		doAction(664553885L /*WAIT_CHASE8*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
	...
	protected void Wait_Summon9(double blendTime) {
		...
		doAction(711309503L /*WAIT_CHASE9*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon_Logic(blendTime), 500));
	}
