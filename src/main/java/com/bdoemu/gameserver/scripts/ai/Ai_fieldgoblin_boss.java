...
@IAIName("fieldgoblin_boss")
public class Ai_fieldgoblin_boss extends CreatureAI {
	public Ai_fieldgoblin_boss(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_Return(double blendTime) {
		...
		doAction(1562868502L /*MOVE_RETURN*/, blendTime, onDoActionEnd -> recoveryAndReturn(() -> {
			...
			return false;
		}, onExit -> scheduleState(state -> Sit_Down_Turn(blendTime), 1000)));
	}
