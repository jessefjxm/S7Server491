...
@IAIName("itemnovicevalmuscan")
public class Ai_itemnovicevalmuscan extends CreatureAI {
	public Ai_itemnovicevalmuscan(Creature actor, Map<Long, Integer> aiVariables) {
	...
	public EAiHandlerResult HandleKnockDown(Creature sender, Integer[] eventData) {
		...
		if (target != null && checkBuff(target, 13) && getVariable(0xE8587A5L /*_Special_Stun_EndTime*/) >= 15000 && getState() != 0x866C7489L /*Wait*/ && getState() != 0xEF3EFF55L /*Special_Damage_Stun*/ && getState() != 0xB97BF3E2L /*Special_Damage_Stun_Ing*/ && getState() != 0xC21C1C3DL /*Special_Damage_Stun_End*/) {
	...
	public EAiHandlerResult HandleTakeDamage(Creature sender, Integer[] eventData) {
		_sender = sender;
		Creature target = sender;
		if (setVariable(0x8807FEFBL /*_Special_Stun_IngTime*/, getTime()) && setVariable(0xE8587A5L /*_Special_Stun_EndTime*/, getVariable(0x8807FEFBL /*_Special_Stun_IngTime*/) - getVariable(0x795FB552L /*_Special_Stun_StartTime*/)) && target != null && checkBuff(target, 13) && getVariable(0xE8587A5L /*_Special_Stun_EndTime*/) >= 15000 && getState() != 0x866C7489L /*Wait*/ && getState() != 0xEF3EFF55L /*Special_Damage_Stun*/ && getState() != 0xB97BF3E2L /*Special_Damage_Stun_Ing*/ && getState() != 0xC21C1C3DL /*Special_Damage_Stun_End*/) {
			if (changeState(state -> Special_Damage_Stun(0.3)))
				return EAiHandlerResult.CHANGE_STATE;
		}
