...
@IAIName("novicemuscan")
public class Ai_novicemuscan extends CreatureAI {
	public Ai_novicemuscan(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void InitialState(double blendTime) {
		...
		doAction(3910697700L /*START_ACTION*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Start(blendTime), 1000));
	}
	...
	protected void Battle_Wait(double blendTime) {
		...
		if (getVariable(0x169EAF09L /*_Anger*/) == 1 && target != null && getDistanceToTarget(target) >= 500 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(20)) {
		...
		if (target != null && getDistanceToTarget(target) > 300 && target != null && getDistanceToTarget(target) <= 1000 && target != null && getAngleToTarget(target) >= -30 && target != null && getAngleToTarget(target) <= 30 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(25)) {
	...
	protected void Battle_Walk(double blendTime) {
		...
		if (target != null && getDistanceToTarget(target) > 300 && target != null && getDistanceToTarget(target) <= 700 && target != null && getTargetHeightdiff(target) > getVariable(0x27274876L /*_TargetBodyHeight*/) && target != null && getTargetHeightdiff(target) < getVariable(0x3715AB9DL /*_MyBodyHeight*/) && target != null && isCreatureVisible(target, false)) {
			if(Rnd.getChance(15)) {
				if (changeState(state -> Attack_Jump(0.3)))
					return;
			}
	...
	protected void Attack_Swing_LR(double blendTime) {
		...
		doAction(3510121346L /*ATTACK_SWING_LR_START*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Swing_RL(double blendTime) {
		...
		doAction(1694651615L /*ATTACK_SWING_RL_START*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Upper_RL(double blendTime) {
		...
		doAction(2830023489L /*ATTACK_UPPER_RL_START*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Jump(double blendTime) {
		...
		doAction(3645155103L /*ATTACK_JUMP_GROUND_SMASH_READY*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
	...
	protected void Attack_Whirlwind_Chase(double blendTime) {
		...
		doAction(3338205409L /*SKILL_WHIRLWIND_CHASE_END*/, blendTime, onDoActionEnd -> changeState(state -> Battle_Wait(blendTime)));
	}
