...
@IAIName("pet_fennecfox")
public class Ai_pet_fennecfox extends CreatureAI {
	public Ai_pet_fennecfox(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait_Summon9_Ing(double blendTime) {
		...
		doAction(3061014360L /*WAIT_CHASE9_ING*/, blendTime, onDoActionEnd -> scheduleState(state -> Wait_Summon9_Ing(blendTime), 1000));
	}
	...
	protected void Owner_Horse_Landing_Hide(double blendTime) {
		...
		doAction(2533348341L /*OWNER_HORSE_LANDING_HIDE_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Horse_Landing_Hide(blendTime), 1000));
	}
	...
	protected void Owner_Carriage_Landing_Position1(double blendTime) {
		...
		doAction(3876020822L /*OWNER_CARRIAGE_LANDING_POSITION1_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing_Position1(blendTime), 1000));
	}
	...
	protected void Owner_Carriage_Landing_Position2(double blendTime) {
		...
		doAction(167783634L /*OWNER_CARRIAGE_LANDING_POSITION2_END*/, blendTime, onDoActionEnd -> scheduleState(state -> Owner_Carriage_Landing_Position2(blendTime), 1000));
	}
