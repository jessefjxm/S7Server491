...
@IAIName("npc_tarif_roaming")
public class Ai_npc_tarif_roaming extends CreatureAI {
	public Ai_npc_tarif_roaming(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Wait(double blendTime) {
		...
		if (getVariable(0x15D7B726L /*WaypointRouteValue*/) == 411) {
			if (changeState(state -> Type1_Go(blendTime)))
				return;
		}
		if (getVariable(0x15D7B726L /*WaypointRouteValue*/) == 412) {
	...
	protected void Type1_Go(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRoaming_1_01", ENaviType.ground, () -> {
			return false;
	...
	protected void Type1_Go1(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRoaming_1_20", ENaviType.ground, () -> {
			return false;
	...
	protected void Type2_Go(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRoaming_2_01", ENaviType.ground, () -> {
			return false;
	...
	protected void Type2_Go1(double blendTime) {
		...
		doAction(847017389L /*WALK*/, blendTime, onDoActionEnd -> moveToWaypoint("npc", "BlackRoaming_2_20", ENaviType.ground, () -> {
			return false;
	...
	protected void Select_Position(double blendTime) {
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 1 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 2) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 29012 });
		}
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 3 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 4) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 28814 });
		}
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 8 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 9) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 28960 });
		}
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 11 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 12) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 28904 });
		}
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 12 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 13) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 28974 });
		}
		...
		if (getVariable(0x2377F21EL /*_Waypointpositoin*/) > 15 && getVariable(0x2377F21EL /*_Waypointpositoin*/) <= 16) {
			setVariableArray(0xACD660AFL /*WaypointValue*/, new Integer[] { 1, 28912 });
		}
	...
	protected void Wait_for_Talk(double blendTime) {
		...
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Move_Position(blendTime), 100000));
	}
