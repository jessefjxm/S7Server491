...
@IAIName("itemnovicelizardman_boss")
public class Ai_itemnovicelizardman_boss extends CreatureAI {
	public Ai_itemnovicelizardman_boss(Creature actor, Map<Long, Integer> aiVariables) {
