...
@IAIName("wanderergargoylebaby")
public class Ai_wanderergargoylebaby extends CreatureAI {
	public Ai_wanderergargoylebaby(Creature actor, Map<Long, Integer> aiVariables) {
