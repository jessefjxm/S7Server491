...
@IAIName("pet_dolmencrab_4er")
public class Ai_pet_dolmencrab_4er extends CreatureAI {
	public Ai_pet_dolmencrab_4er(Creature actor, Map<Long, Integer> aiVariables) {
