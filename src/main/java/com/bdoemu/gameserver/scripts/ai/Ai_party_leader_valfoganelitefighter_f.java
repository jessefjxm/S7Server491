...
@IAIName("party_leader_valfoganelitefighter_f")
public class Ai_party_leader_valfoganelitefighter_f extends CreatureAI {
	public Ai_party_leader_valfoganelitefighter_f(Creature actor, Map<Long, Integer> aiVariables) {
	...
	protected void Move_SummonPoint1(double blendTime) {
		...
		doTeleportToWaypoint("valfoganelite_0001", "monster_patrol", 0, 0, 1, 1);
	...
	protected void Move_SummonPoint2(double blendTime) {
		...
		doTeleportToWaypoint("valfoganelite_0002", "monster_patrol", 0, 0, 1, 1);
		doAction(2514775444L /*WAIT*/, blendTime, onDoActionEnd -> scheduleState(state -> Summon_Wait(blendTime), 1000));
	}
