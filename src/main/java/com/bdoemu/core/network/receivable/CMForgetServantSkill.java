...
import com.bdoemu.gameserver.model.creature.player.itemPack.events.ForgetServantSkillItemEvent;
import com.bdoemu.gameserver.model.creature.servant.Servant;
import com.bdoemu.gameserver.model.items.enums.EItemStorageLocation;

public class CMForgetServantSkill extends ReceivablePacket<GameClient> {
    ...
    public CMForgetServantSkill(final short opcode) {
        super(opcode);
    }
    ...
    public void runImpl() {
        ...
        if (player != null) {
            ...
            if (servant != null && servant.getServantState().isStable()) {
                player.getPlayerBag().onEvent(new ForgetServantSkillItemEvent(player, servant, this.storageLocation, this.slotIndex, this.skillId));
            }
        }
    }
}
