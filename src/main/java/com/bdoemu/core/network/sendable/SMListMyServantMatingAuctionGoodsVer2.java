...
public class SMListMyServantMatingAuctionGoodsVer2 extends SendablePacket<GameClient> {
    private Collection<ServantItemMarket> servants;
    private EPacketTaskType packetTaskType;
    private int auctionKey;

    public SMListMyServantMatingAuctionGoodsVer2(final EPacketTaskType packetTaskType, final Collection<ServantItemMarket> servants, final int auctionKey) {
