...
; (function ($, document, window) {
	...
	function initializeToggleSwitch(obj, settings) {
		if ($(obj).is(':checkbox')) {
			...
			changeChecked($insertedObj, $(obj).is(':checked'), false)
		}

		trigger(getSettings($insertedObj).onReady, $(obj).is(':checked'), obj);
	}
	...
	//        initializeToggleSwitch($(data), publicMethod.getSettings($(data)));
	//    });
	//}
